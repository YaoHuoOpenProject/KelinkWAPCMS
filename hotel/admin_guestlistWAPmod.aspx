<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="admin_guestlistWAPmod.aspx.cs" Inherits="KeLin.WebSite.hotel.admin_guestlistWAPmod" %><%@ Import namespace="KeLin.ClassManager.Tool" %><%
...
if (ver == "1")
{
    ...
    if (this.INFO == "OK")
    {
        ...
        Response.Write("</b><br/>");
        Response.Write("<a href=\"" + this.http_start + "hotel/admin_guestlistWAP.aspx?siteid=" + this.siteid + "&amp;classid=" + this.classid + "&amp;page=" + this.page + "\">" + this.GetLang("返回列表|返回列表|Back to list") + "</a><br/>");
    }
    ...
    Response.Write("<anchor><go href=\""+http_start+"hotel/admin_guestlistWAPmod.aspx\" method=\"post\" accept-charset=\"utf-8\">");
    ...
    Response.Write("<br/><a href=\"" + this.http_start + "hotel/admin_guestlistWAP.aspx?siteid=" + this.siteid + "&amp;classid=" + this.classid + "&amp;page=" + this.page + "\">" + this.GetLang("返回列表|返回列表|Back to list") + "</a>");
...
else //2.0界面
{
    ...
    Response.Write("<form name=\"go\" action=\"" + this.http_start + "hotel/admin_guestlistWAPmod.aspx\" method=\"post\">");
    Response.Write("订单号:" + this.id + "<br/>");
    ...
    Response.Write("<a href=\"" + this.http_start + "hotel/admin_guestlistWAP.aspx?siteid=" + this.siteid + "&amp;classid=" + this.classid + "&amp;page=" + this.page + "\">" + this.GetLang("返回列表|返回列表|Back to list") + "</a>");
