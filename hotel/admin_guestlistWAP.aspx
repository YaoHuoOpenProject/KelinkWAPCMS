<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="admin_guestlistWAP.aspx.cs" Inherits="KeLin.WebSite.hotel.admin_guestlistWAP" %><%@ Import namespace="KeLin.ClassManager.Tool" %><%
...
if (ver == "1")
{
    ...
    strhtml.Append("<anchor><go href=\"" + http_start + "hotel/admin_guestlistwap.aspx\" method=\"get\" accept-charset=\"utf-8\">");
    ...
    //strhtml.Append("<a href=\""+http_start+"hotel/admin_guestlistwap.aspx?id="+id+"&amp;classid="+classid+"&amp;siteid="+siteid+"&amp;lpage="+lpage+"&amp;rnd="+r+"&amp;sid="+sid+"\">刷新</a> ");
    ...
    for (int i = 0; (listVo != null && i < listVo.Count); i++)
    {
        ...
        strhtml.Append("[<a href=\"" + this.http_start + "hotel/admin_guestlistWAPmod.aspx?action=go&amp;id=" + listVo[i].id + "&amp;siteid=" + this.siteid + "&amp;classid=" + this.classid + "&amp;page=" + this.CurrentPage + "\">处理</a>]");
    ...
    strhtml.Append("<a href=\"" + this.http_start + "hotel/admin_userlistWAP.aspx?action=class&amp;siteid=" + siteid + "&amp;classid=" + classid + "&amp;page="+lpage+"" + "\">返回列表</a> ");
...
else //2.0界面
{
    ...
    strhtml.Append("<form name=\"f\" aciont=\"" + http_start + "hotel/admin_guestlistwap.aspx\" method=\"get\">");
