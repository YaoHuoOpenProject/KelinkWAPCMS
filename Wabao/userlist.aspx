<%@ Page Language="C#" AutoEventWireup="true" Codebehind="userlist.aspx.cs" Inherits="KeLin.WebSite.wabao.userlist" %>

<%@ Register Assembly="AspNetPager" Namespace="Wuqi.Webdiyer" TagPrefix="webdiyer" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>wabao代码资源</title>
...
<link href="/NetCSS/style.css" rel="stylesheet" type="text/css">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function DoEdit() {
            ...
            window.open('/wabao/admin_wapadd.aspx?action=go&id=' + edtHangBiaoShis + '&siteid=<%=base.SiteId %>&classid=' + toclassid + '&page=1&sid=<%=base.SID %>');
         ...
         **/
            window.location.href = "/admin/modifyAD.aspx?systype=wabao";
        }
        function DoContent() {
        ...
        function DoSmall() {
            window.location.href="../admin/systemclass.aspx?systype=wabao&classid="+document.getElementById("TextBox4").value;  
        }
        function DoMyItem() {
            var delHangBiaoShis = GetOnChecked();
            if (delHangBiaoShis == null || delHangBiaoShis == "") {
...
window.location.href="upload_bath.aspx?systype=wabao&classid="+ItemID;
//window.open ("upload_bath.aspx?systype=wabao&classid=<%=classid%>", "addsystemwindow", "height=450, width=550, toolbar= no, menubar=no, scrollbars=no, resizable=no, location=no, status=no");
}
function daoru() { 
                                                ...
                                                <table id="tblManageRanks" class="tableBorder" cellspacing="1" cellpadding="3" border="0"
                                                    ...
                                                    <tr>
                                                        <td class="fh" colspan="4">
                                                            ...
                                                            关键字：<asp:TextBox ID="TextBox5" runat="server" Columns="20" MaxLength="8" Width="80px"></asp:TextBox>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <input id="Button8" name="" type="button" value=" 审 核 " onclick="DoCheck()" class="bt"/>                                                       
                                                            ...
                                                            &nbsp;<!--
                                                            <input id="Button2" name="" type="button" value="一对一批量上传" onclick="window.open('/wabao/admin_WAPadd2.aspx?num=2&action=go&classid=<%=this.classid %>&siteid=<%=base.SiteId %>&page=1&sid=<%=base.SID %>');" class="bt"/>
                                                            &nbsp;-->
                                                            <input id="Button11" name="" type="button" value="新增" onclick="window.open('/wabao/admin_WAPadd.aspx?num=2&action=go&classid=<%=this.classid %>&siteid=<%=base.SiteId %>&page=1&sid=<%=base.SID %>');" Class="bt" />
                                                            &nbsp;
                                            ...
                                            <td colspan="4" valign="top" align="left">
                                                <asp:DataGrid ID="DataGrid1" runat="server" DataKeyField="id" AllowSorting="True"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateColumn HeaderText=" " SortExpression="book_classid" ItemStyle-Width="80px"
                                                            HeaderStyle-CssClass="column">
                                                            <ItemTemplate>
                                                                <%#DataBinder.Eval(Container.DataItem, "book_classid")%>
                                                            </ItemTemplate>
                                                         ...
                                                         <asp:TemplateColumn HeaderText="标题" HeaderStyle-CssClass="column" ItemStyle-Width="200px">
                                                            <ItemTemplate>
                                                                <a href="book_view.aspx?siteid=<%#DataBinder.Eval(Container.DataItem,"siteid") %>&classid=<%#DataBinder.Eval(Container.DataItem,"book_classid") %>&id=<%#DataBinder.Eval(Container.DataItem,"id") %>&sid=<%=base.SID %>" target=_blank
                                                                    target="_self" title=".">
                                                        ...
                                                        <asp:TemplateColumn HeaderText="简介" SortExpression="book_content" HeaderStyle-CssClass="column" >
                                                            <ItemTemplate>
                                                        ...
                                                        <asp:TemplateColumn HeaderText="点击" SortExpression="book_click" ItemStyle-Width="40px"
                                                         ...
                                                         <asp:TemplateColumn HeaderText="进度" SortExpression="countall" ItemStyle-Width="200px"
                                                            HeaderStyle-CssClass="column">
                                                            <ItemTemplate>
                                                               总礼数: <%#DataBinder.Eval(Container.DataItem, "countall")%> [<a href="/wabao/admin_guestlistwap.aspx?action=go&bookid=<%#DataBinder.Eval(Container.DataItem, "id")%>&siteid=<%=base.SiteId %>&classid=<%=classid%>&page=1&sid=<%=base.SID %>" target="_blank">查看</a>]<br />
                                                               已发送: <%#DataBinder.Eval(Container.DataItem, "counthasget")%><br />
                                                               百分比：<%#GetPer(DataBinder.Eval(Container.DataItem, "countall").ToString(), DataBinder.Eval(Container.DataItem, "counthasget").ToString())%> %
                                                            </ItemTemplate>
                                                        </asp:TemplateColumn>
