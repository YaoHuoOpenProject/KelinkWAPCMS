<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Book_Search.aspx.cs" Inherits="KeLin.WebSite.wabao.Book_Search" %><%@ Import namespace="KeLin.ClassManager.Tool" %><%
Response.Write(WapTool.showTop(this.GetLang("挖宝搜索|挖宝搜索|Search"), wmlVo));//显示头 
if(ver=="1"){
%>
<p>请输入关键字：<br/>
...
<anchor><go href="<%=http_start%>wabao/book_list.aspx" method="get" accept-charset="utf-8">
...
<form id="form1" action="<%=http_start%>wabao/book_list.aspx" method="get">
<div class="subtitle">挖宝搜索</div>
<div class="content">
请输入关键字：<br/>
<input type="text" name="key" value=""/><br/>
选择搜索项：<br/>
<select name="type">
<option value="title">挖宝标题</option>
<option value="content">挖宝内容</option>
