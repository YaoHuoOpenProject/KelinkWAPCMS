<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="admin_WAPadvertise.aspx.cs" Inherits="KeLin.WebSite.wabao.admin_WAPadvertise" %><%@ Import namespace="KeLin.ClassManager.Tool" %><%
...
if (ver == "1")
{
    ...
    if (this.INFO == "OK")
    {
        ...
        Response.Write("</b><br/>");
        Response.Write("<a href=\"" + this.http_start + "wabao/admin_userlistWAP.aspx?siteid=" + this.siteid + "&amp;classid=" + this.classid + "&amp;page=" + this.page + "\">" + this.GetLang("返回列表|返回列表|Back to list") + "</a><br/>");
    }
    ...
    Response.Write("<anchor><go href=\""+http_start+"wabao/admin_WAPadvertise.aspx\" method=\"post\" accept-charset=\"utf-8\">");
...
else //2.0界面
{
    ...
    Response.Write("<form name=\"go\" action=\""+this.http_start+"wabao/admin_WAPadvertise.aspx\" method=\"post\">");
    Response.Write(this.GetLang("二级列表顶部|二級列表頂部|Two top of the list") + "*:<br/>");
