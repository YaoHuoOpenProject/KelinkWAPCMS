<%@ Page Language="C#" AutoEventWireup="true" Codebehind="admin_userlist.aspx.cs"
    Inherits="KeLin.WebSite.wabao.admin_userlist" %>

<%@ Register Assembly="AspNetPager" Namespace="Wuqi.Webdiyer" TagPrefix="webdiyer" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>内容审核--挖宝内容</title>
                                          ...
                                          <table id="tblManageRanks" class="tableBorder" cellspacing="1" cellpadding="3" border="0"
                                                ...
                                                <tr>
                                                    <td class="fh" colspan="2" style="width: 100%">
                                                        ...
                                                        栏目ID：<asp:TextBox ID="TextBox1" runat="server" Columns="20" MaxLength="8" Width="50px"></asp:TextBox>
                                        ...
                                        <td colspan="4" valign="top" align="left">
                                            <asp:DataGrid ID="DataGrid1" runat="server" DataKeyField="id" AllowSorting="True"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateColumn HeaderText="标题" SortExpression="" ItemStyle-Width="150px" HeaderStyle-CssClass="column">
                                                        
                                                        <ItemTemplate>
                                                            <a href="book_view.aspx?siteid=<%#DataBinder.Eval(Container.DataItem,"siteid") %>&classid=<%#DataBinder.Eval(Container.DataItem,"book_classid") %>&id=<%#DataBinder.Eval(Container.DataItem,"id") %>" target=_blank
                                                                    target="_self" title=".">
                                                        ...
                                                        <asp:TemplateColumn HeaderText="简介" SortExpression="book_content" HeaderStyle-CssClass="column" ItemStyle-Width="200px">
                                                            <ItemTemplate>
                                                        ...
                                                        <asp:TemplateColumn HeaderText="点击" SortExpression="book_click" ItemStyle-Width="40px"
                                                         ...
                                                         <asp:TemplateColumn HeaderText="进度" SortExpression="countall" ItemStyle-Width="200px"
                                                            HeaderStyle-CssClass="column">
                                                            <ItemTemplate>
                                                               总礼数: <%#DataBinder.Eval(Container.DataItem, "countall")%><br />
