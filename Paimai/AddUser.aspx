<%@ Page Language="C#" AutoEventWireup="true" Codebehind="addUser.aspx.cs" Inherits="KeLin.WebSite.paimai.addUser" %>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td colspan="3" class="fh3">
                                        ...
                                        <img id="imgdate" style="cursor: hand;" src="../admin/images/vbeditor.gif" onclick="setday(this,document.all.tb_time)"
                                            title="选择日期" />
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td colspan="3" class="fh3">
                                        <FTB:FreeTextBox ID="FreeTextBox1" runat="server" ButtonPath="../images/ftb/office2003/" ImageGalleryPath="paimai/upload">
                                        </FTB:FreeTextBox>
                                    </td>
                                </tr>
                                <tr>
