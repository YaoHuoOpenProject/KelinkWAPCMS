<%@ Page Language="C#" AutoEventWireup="true" Codebehind="orderlist.aspx.cs" Inherits="KeLin.WebSite.paimai.orderlist" %>
...
<link href="/NetCSS/style.css" rel="stylesheet" type="text/css">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function DoSmall() {
            window.location.href="../admin/systemclass.aspx?systype=paimai&classid="+document.getElementById("TextBox1").value;  
        }
                                            ...
                                            <table id="tblManageRanks" class="tableBorder" cellspacing="1" cellpadding="3" border="0"
                                                ...
                                                <tr>
                                                    <td class="column" colspan="4">
                                                        ...
                                                        <a style="cursor: hand" onclick="DoReBack()">投标记录管理</a>&nbsp;&nbsp; 
                                                        <!--<a style="cursor: hand"
                                                ...
                                                <tr>
                                                    <td class="fh" colspan="4" >
                                                        ...
                                                        ID：<asp:TextBox ID="TextBox4" runat="server" Width="64px"></asp:TextBox>标题/内容关键字：<asp:TextBox
                                        ...
                                        <td colspan="4" valign="top" align="left">
                                            <asp:DataGrid ID="DataGrid1" runat="server" DataKeyField="id" AllowSorting="True"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateColumn HeaderText="状态" SortExpression="state" ItemStyle-Width="50px" HeaderStyle-CssClass="column">
                                                        <ItemTemplate>
                                                            <img src="/NetImages/f<%#DataBinder.Eval(Container.DataItem, "state")%>.gif" alt="..." />
                                                        </ItemTemplate>
                                                    </asp:TemplateColumn>
                                                    <asp:TemplateColumn HeaderText="拍卖ID" SortExpression="paimaiid" ItemStyle-Width="60px" HeaderStyle-CssClass="column">
                                                        <ItemTemplate>
                                                            <a href="viewuser.aspx?bookid=<%#DataBinder.Eval(Container.DataItem,"productid") %>"
                                                                target="_blank" title="快速进入此栏目">
                                                                <%#DataBinder.Eval(Container.DataItem, "ID")%>
                                                            </a>
                                                        </ItemTemplate>
                                                    </asp:TemplateColumn>
                                                    <asp:TemplateColumn HeaderText="虚拟币" SortExpression="productmoney" ItemStyle-Width="100px" HeaderStyle-CssClass="column">
                                                        <ItemTemplate>
                                                            <%#DataBinder.Eval(Container.DataItem, "productmoney")%>
                                                        </ItemTemplate>
                                                    </asp:TemplateColumn>
                                                    ...
                                                    <asp:TemplateColumn HeaderText="是否中标" SortExpression="iswinner" ItemStyle-Width="100px" HeaderStyle-CssClass="column">
                                                        <ItemTemplate>
                                                            <img src="/NetImages/f<%#DataBinder.Eval(Container.DataItem, "iswinner")%>.gif" alt="..." />
                                                        </ItemTemplate>
                                                    </asp:TemplateColumn>
                                                    
                                                   <asp:TemplateColumn HeaderText="中标时间" SortExpression="wintime" ItemStyle-Width="120px" HeaderStyle-CssClass="column">
                                                        <ItemTemplate>
                                                            <%#DataBinder.Eval(Container.DataItem, "wintime")%>
                                                        </ItemTemplate>
                                                    </asp:TemplateColumn>
                                                   
                                                    <asp:TemplateColumn HeaderText="备注" SortExpression="remark" ItemStyle-Width="200px" HeaderStyle-CssClass="column">
                                                        <ItemTemplate>
                                                            <%#DataBinder.Eval(Container.DataItem, "remark")%>
                                                        </ItemTemplate>
                                                    </asp:TemplateColumn>
                                                   
                                                    <asp:TemplateColumn HeaderText="投标时间" SortExpression="orderdate" ItemStyle-Width="130px" HeaderStyle-CssClass="column">
                                                        <ItemTemplate>
