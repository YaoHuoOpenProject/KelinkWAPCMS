<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Book_View_topall.aspx.cs" Inherits="KeLin.WebSite.bbs.Book_View_topall" %><%@ Import namespace="KeLin.ClassManager.Tool" %>
<%
...
if (ver == "1")
{
    ...
    if (this.INFO == "")
    {
        strhtml.Append("<a href=\"" + this.http_start + "bbs/Book_View_topall.aspx?action=gomod&amp;tops=" + this.tops + "&amp;id=" + this.id + "&amp;siteid=" + this.siteid + "&amp;classid=" + this.classid + "&amp;lpage=" + this.lpage + "\">" + this.GetLang("确定要" + lang1 + "置顶此贴吗？是！|確定要" + lang2 + "置頂此贴嗎？是！|Are you sure? YES") + "</a><br/>");
