<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="myFav_admin_mod.aspx.cs" Inherits="KeLin.WebSite.bbs.myFav_admin_mod" %><%@ Import namespace="KeLin.ClassManager.Tool" %><%
...
if (ver == "1")
{
    ...
    if (this.INFO != "MODOK")
    {
        ...
        strhtml.Append("<anchor><go href=\"" + http_start + "bbs/myfav_admin_mod.aspx\" method=\"post\" accept-charset=\"utf-8\">");
    ...
    strhtml.Append("----------<br/>");
    strhtml.Append("<a href=\"" + this.http_start + "bbs/myfav_admin.aspx?siteid="+this.siteid+"&amp;classid=0" + "\">返回上级</a> ");
...
else //2.0界面
{
    ...
    if (this.INFO != "MODOK")
    {
        strhtml.Append("<form name=\"f\" action=\"" + http_start + "bbs/myfav_admin_mod.aspx\" method=\"post\">");
        strhtml.Append("分类名称:<br/>");
