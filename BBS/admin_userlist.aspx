<%@ Page Language="C#" AutoEventWireup="true" Codebehind="admin_userlist.aspx.cs"
    Inherits="KeLin.WebSite.bbs.admin_userlist" %>
                                        ...
                                        <td colspan="4" valign="top" align="left">
                                            <asp:DataGrid ID="DataGrid1" runat="server" DataKeyField="id" AllowSorting="True"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateColumn HeaderText="网站ID" SortExpression="userid" HeaderStyle-CssClass="column">
                                                        <ItemTemplate>
                                                    ...
                                                    <asp:TemplateColumn HeaderText="栏目ID" SortExpression="book_classid" HeaderStyle-CssClass="column">
                                                        <ItemTemplate>
                                                    ...
                                                    <asp:TemplateColumn HeaderText="栏目名称" SortExpression="classname" HeaderStyle-CssClass="column">
                                                        <ItemTemplate>
                                                            <%#DataBinder.Eval(Container.DataItem, "classname")%>
                                                        </ItemTemplate>
                                                    </asp:TemplateColumn>
                                                    <asp:TemplateColumn HeaderText="标题" SortExpression="" HeaderStyle-CssClass="column">
                                                        <ItemTemplate>
                                                    ...
                                                    <asp:TemplateColumn HeaderText="点击" SortExpression="book_click" HeaderStyle-CssClass="column">
                                                        <ItemTemplate>
                                                            <%#DataBinder.Eval(Container.DataItem, "book_click")%>
                                                        </ItemTemplate>
                                                    </asp:TemplateColumn>
                                                    <asp:TemplateColumn HeaderText="添加时间" SortExpression="book_date" HeaderStyle-CssClass="column">
                                                        <ItemTemplate>
