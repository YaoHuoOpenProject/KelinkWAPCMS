<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="admin_userlistWAP00.aspx.cs" Inherits="KeLin.WebSite.bbs.admin_userlistWAP00" %><%@ Import namespace="KeLin.ClassManager.Tool" %><%
Response.Write(WapTool.showTop(this.GetLang("论坛内容审核|论坛內容审核|Check Content of the bbs"), wmlVo));//显示头                                                                                                                                                                       
if (ver == "1")
{
    strhtml.Append("<p align=\"left\">");
    strhtml.Append("内容审核.<a href=\"" + this.http_start + "bbs/admin_guestlistWAP00.aspx?siteid=" + this.siteid + "&amp;classid=" + this.classid + "&amp;tositeid=" + this.tositeid + "\">回复审核</a><br/>");
    ...
    strhtml.Append("<anchor><go href=\"" + http_start + "bbs/admin_userlistWAP00.aspx\" method=\"get\" accept-charset=\"utf-8\">");
