...
else //2.0界面
{
    ...
    strhtml.Append("<a class=\"btSelect\" href=\"" + this.http_start + "bbs/book_view_addURL.aspx?action=class&amp;siteid=" + this.siteid + "&amp;classid=" + this.classid + "&amp;page=" + this.page + "\">发外站资源帖</a> ");   
    ...
    if (this.INFO != "OK")
    {
        ...
        strhtml.Append("<textarea name=\"book_content\" minlength=\"15\" required=\"required\" rows=\"3\" class=\"KL_bbs_textarea\" style=\"width:99%;height:180px;\">" + book_content + "</textarea><br/>");
        if (isadmin == true)
        {
            //strhtml.Append("签到送币 <input type=\"text\" format=\"*N\" name=\"reshow\" value=\"" + reshow + "\" size=\"20\"/><br/>");
        }
        strhtml.Append("悬赏妖晶 <input type=\"number\" min=\"2000\" format=\"*N\" name=\"sendmoney\" value=\"" + sendmoney + "\" size=\"20\" /><br/>");
        for (int i = 0; i < this.num; i++)
        {
            strhtml.Append("----- 资源文件" + (i + 1) + " -----<br/>");
            strhtml.Append("资源名称 <input type=\"text\" placeholder=\" 必填项 \" name=\"file_title\" size=\"40\" value=\"\"/><br/>");
            strhtml.Append("链接地址 <input type=\"text\" placeholder=\" http:// 开头的链接 \" name=\"file_url\" size=\"40\" value=\"\"/><br/>");
            strhtml.Append("文件大小 <input type=\"text\" placeholder=\" 例如：8M \" name=\"file_size\" value=\"\" size=\"20\"/><br/>");
            strhtml.Append("文件后缀 <input type=\"text\" placeholder=\" 例如：txt \" name=\"file_ext\" value=\"\" size=\"20\"/><br/>");
            strhtml.Append(this.GetLang("说明|说明|Source") + ":<br/>");
            strhtml.Append("<textarea name=\"file_info\" placeholder=\" 填写附件备注信息，比如网盘提取密码 \" rows=\"3\" style=\"width:99%\"></textarea><br/>");            
        }
    ...
    strhtml.Append("</div>");
    strhtml.Append("<div class=\"tip\">");
    strhtml.Append("提示：严禁上传色情文件、病毒文件和恶意软件；<b>资源链接开头若为 https 请改为 http</b>");
    strhtml.Append("</div>");
    strhtml.Append("<div class=\"bt2\">");
