<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="book_user_win.aspx.cs" Inherits="KeLin.WebSite.bbs.marksix.book_user_win" %><%@ Import namespace="KeLin.ClassManager.Tool" %><%
...
if (ver == "1")
{
    ...
    if (this.INFO == "OK")
    {
        ...
        strhtml.Append("</b> ");
        strhtml.Append("<a href=\"" + this.http_start + "bbs/book_list.aspx?siteid=" + siteid + "&amp;classid=" + classid + "&amp;nid=" + id + "&amp;lpage=" + lpage + "&amp;sid=" + sid + "\">返回</a><br/>");
    ...
    strhtml.Append("<a href=\"" + this.http_start + "bbs/marksix/book_list_bet.aspx?touserid=" + this.userid + "&amp;siteid=" + this.siteid + "&amp;classid=" + this.classid + "&amp;sid=" + this.sid + "\">我的投注</a>|我要兑奖<br/>");
    ...
    //显示导航分页
    strhtml.Append("----------<br/>");
    strhtml.Append("【共赢:" + allmoney.ToString("f2") + "个" + siteVo.sitemoneyname + " <a href=\"" + this.http_start + "bbs/marksix/book_user_win.aspx?action=add&amp;siteid=" + this.siteid + "&amp;classid=" + this.classid + "&amp;sid=" + this.sid + "\">确定兑奖</a>】");
...
else //2.0界面
{
    ...
    strhtml.Append("<a href=\"" + this.http_start + "bbs/marksix/book_list_bet.aspx?touserid="+this.userid+"&amp;siteid="+this.siteid+"&amp;classid="+this.classid+"&amp;sid="+this.sid+"\">我的投注</a>|");
    
    strhtml.Append( showtitle + "</div>");
    ...
    if (this.INFO == "")
    {
        ...
        if (listVo == null)
        {
            strhtml.Append("<div class=\"tip\">暂无我的兑奖记录！</div>");
        }
    }
