<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Book_re_addfileShow.aspx.cs" Inherits="KeLin.WebSite.bbs.Book_re_addfileShow" %><%@ Import namespace="KeLin.ClassManager.Tool" %><%
...
else //2.0界面
{
    ...
    Response.Write("<div class=\"subtitle\">" + this.GetLang("查看回复上传文件|查看回复上传文件|see upfile") + "</div>");
    Response.Write(this.ERROR);
