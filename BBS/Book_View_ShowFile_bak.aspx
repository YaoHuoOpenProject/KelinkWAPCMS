<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Book_View_ShowFile_bak.aspx.cs" Inherits="KeLin.WebSite.bbs.Book_View_ShowFile_bak" %><%@ Import namespace="KeLin.ClassManager.Tool" %><%
...
if (ver == "1")
{
   ...
   strhtml.Append(linkURL);
    ...
    {
        strhtml.Append("<a href=\"" + this.http_start + "bbs/book_view_bak.aspx?siteid=" + siteid + "&amp;classid=" + classid + "&amp;id="+this.id+"&amp;page=" + this.lpage + this.stypelink + "" + "\">返回主题</a> ");
