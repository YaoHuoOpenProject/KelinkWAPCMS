<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Book_Search_bak.aspx.cs" Inherits="KeLin.WebSite.bbs.Book_Search_bak" %><%@ Import namespace="KeLin.ClassManager.Tool" %><%
Response.Write(WapTool.showTop("历史数据."+this.GetLang("贴子搜索|貼子搜索|Search"), wmlVo));//显示头 
...
strhtml.Append("<anchor><go href=\""+this.http_start +"bbs/book_list_bak.aspx\" method=\"get\" accept-charset=\"utf-8\">");
...
strhtml.Append("</go>历史数据搜索</anchor><br/>");
...
strhtml.Append("<form id=\"form1\" action=\""+this.http_start +"bbs/book_list_bak.aspx\" method=\"get\">");
...
strhtml.Append("</select><br/>");
strhtml.Append("<input type=\"submit\" value=\"历史数据搜索\" class=\"btn\"/>");
