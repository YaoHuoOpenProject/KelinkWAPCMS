<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Book_List_back_del.aspx.cs" Inherits="KeLin.WebSite.bbs.Book_List_back_del" %><%@ Import namespace="KeLin.ClassManager.Tool" %><%
...
if (ver == "1")
{
    ...
    if (this.INFO == "")
    {
            ...
            strhtml.Append("<a href=\"" + this.http_start + "bbs/book_list_back_del.aspx?action=godel&amp;id=" + this.id + "&amp;siteid=" + this.siteid + "&amp;classid=" + this.classid + "&amp;sub=0&amp;lpage=" + this.lpage + "\">" + this.GetLang("确定删除！|确定删除！|submit") + "</a><br/>");
    ...
    strhtml.Append("<br/>说明:如有附件一并删除。<br/>");
