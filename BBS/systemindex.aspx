<%@ Page Language="C#" AutoEventWireup="true" Codebehind="systemindex.aspx.cs" Inherits="KeLin.WebSite.bbs.systemindex" %>
                                                                ...
                                                                <table id="tblManageRanks" class="tableBorder" cellspacing="1" cellpadding="3" border="0"
                                                                    ...
                                                                    <tr>
                                                                        <td class="fh" align="left">
                                                                            ...
                                                                            <input name="" type="button" value="转移联盟内容" onclick="DoTranfer()" id="Button3" runat="server" Class="bt" />
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>
                                                                            <asp:DataGrid ID="DataGrid1" runat="server" DataKeyField="id" AllowSorting="True"
                                                                                ...
                                                                                <Columns>
                                                                                    ...
                                                                                    <asp:TemplateColumn HeaderText="作者" SortExpression="book_author" HeaderStyle-CssClass="column">
                                                                                        <ItemTemplate>
                                                                                            <%#DataBinder.Eval(Container.DataItem, "book_author")%>
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateColumn>
                                                                                    <asp:TemplateColumn HeaderText="录入人" SortExpression="username" ItemStyle-Width="40px" HeaderStyle-CssClass="column">
                                                                                        <ItemTemplate>
