<%@ Page Language="C#" AutoEventWireup="true" Codebehind="admin_guestlist.aspx.cs"
    Inherits="KeLin.WebSite.bbs.admin_guestlist" %>
                                            ...
                                            <table id="tblManageRanks" class="tableBorder" cellspacing="1" cellpadding="3" border="0"
                                                ...
                                                <tr>
                                                    ...
                                                    审核状态：
                                                        ...
                                                        内容ID：<asp:TextBox ID="TextBox4" runat="server" Width="64px"></asp:TextBox> 关键字：<asp:TextBox
                                        ...
                                        <td colspan="4" valign="top" align="left">
                                            <asp:DataGrid ID="DataGrid1" runat="server" DataKeyField="id" AllowSorting="True"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateColumn HeaderText="回复内容" ItemStyle-Width="300px" HeaderStyle-CssClass="column">
                                                        <ItemTemplate>
                                                            <%#DataBinder.Eval(Container.DataItem, "content")%>
                                                        </ItemTemplate>
                                                    </asp:TemplateColumn>
                                                    <asp:TemplateColumn HeaderText="回复人" SortExpression="nickname" ItemStyle-Width="130px" HeaderStyle-CssClass="column">
                                                        <ItemTemplate>
