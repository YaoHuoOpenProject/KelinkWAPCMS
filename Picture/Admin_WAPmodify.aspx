<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="admin_WAPmodify.aspx.cs" Inherits="KeLin.WebSite.picture.admin_WAPmodify" %><%@ Import namespace="KeLin.ClassManager.Tool" %><%
...
if (ver == "1")
{
    ...
    Response.Write("<a href=\"" + this.http_start + "picture/admin_wapmodifyadd.aspx?action=class&amp;siteid=" + this.siteid + "&amp;classid=" + this.classid + "&amp;id=" + this.id + "&amp;sid=" + this.sid1 + "-2-" + this.cs + "-" + this.lang + "-" + this.myua + "-" + this.width + "\">" + this.GetLang("进入WAP2.0界面续传|进入WAP2.0界面续传|wap2.0 add upfile") + "</a><br/>");
    ...
    Response.Write(this.GetLang("原图地址|原图地址|ori img url") + ":<br/>");
    Response.Write("<input type=\"text\" name=\"book_fileOri" + r + "\" value=\"" + bookVo.book_fileOri + "\"/><br/>");
    ...
    Response.Write(this.GetLang("图片介绍|图片介绍|img info") + ":<br/>");
    ...
    Response.Write("<input type=\"text\" name=\"nextPage" + r + "\" value=\"" + bookVo.nextPage + "\" size=\"3\"/>(0显示所有)<br/>");
    ...
    Response.Write("<anchor><go href=\""+http_start+"picture/admin_WAPmodify.aspx\" method=\"post\" accept-charset=\"utf-8\">");
    ...
    Response.Write("<postfield name=\"book_fileOri\" value=\"$(book_fileOri" + r + ")\"/>");
...
else //2.0界面
{
    ...
    Response.Write("<a href=\""+this.http_start+"picture/admin_wapmodifyadd.aspx?siteid="+this.siteid+"&classid="+this.classid+"&id="+this.id+"&sid="+this.sid+"\">续传图片</a>");
    Response.Write("</div>");
    Response.Write("<div class=\"content\">");
    Response.Write("<form name=\"go\" action=\"" + this.http_start + "picture/admin_WAPmodify.aspx\" method=\"post\">");
    Response.Write(this.GetLang("标题|標題|Title") + "*:<br/>");
    ...
    Response.Write(this.GetLang("原图地址|原图地址|ori img url") + ":<br/>");
    Response.Write("<input type=\"text\" name=\"book_fileOri\" value=\"" + bookVo.book_fileOri + "\"/><br/>");
    Response.Write(this.GetLang("图片地址|图片地址|img url") + ":<br/>");
    ...
    Response.Write(this.GetLang("每页显示多少张图|每页显示多少张图|pic") + "*:<br/>");
    Response.Write("<input type=\"text\" name=\"nextPage\" value=\"" + bookVo.nextPage + "\" size=\"3\"/>(0显示所有)<br/>");
    Response.Write(this.GetLang("内容|內容|Content") + ":<br/>");
