<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="user_WAPadd.aspx.cs" Inherits="KeLin.WebSite.picture.user_WAPadd" %>
...
if (ver == "1")
{
    ...
    Response.Write("<a href=\"" + this.http_start + "picture/user_wapadd.aspx?action=class&amp;siteid=" + this.siteid + "&amp;classid=" + this.classid + "&amp;smalltypeid=" + this.smalltypeid + "&amp;sid=" + this.sid1 + "-2-" + this.cs + "-" + this.lang + "-" + this.myua + "-" + this.width + "\">" + this.GetLang("进入WAP2.0界面上传|进入WAP2.0界面上传|wap2.0 add upfile") + "</a><br/>");
    Response.Write("<a href=\"" + this.http_start + "picture/book_list.aspx?siteid=" + this.siteid + "&amp;classid=" + this.classid + "&amp;smalltypeid=" + this.smalltypeid + "\">" + this.GetLang("返回列表|返回列表|Back to list") + "</a><br/>");
...
else //2.0界面
{
    ...
    if (this.INFO == "OK")
    {
        ...
        //}
        Response.Write(" <a href=\"" + this.http_start + "picture/book_list.aspx?siteid=" + this.siteid + "&amp;classid=" + this.classid + "&amp;smalltypeid=" + this.smalltypeid + "\">" + this.GetLang("返回|返回|Back to list") + "</a>");
    }
    ...
    Response.Write("<form name=\"g1\" action=\"" + http_start + "picture/user_WAPadd.aspx\" method=\"get\">");
    ...
    //选择栏目
    Response.Write("<form name=\"gt\" action=\"" + http_start + "picture/user_WAPadd.aspx\" enctype=\"multipart/form-data\" method=\"post\">");
    ...
    Response.Write("<a href=\"" + this.http_start + "picture/book_list.aspx?siteid=" + this.siteid + "&amp;classid=" + this.classid + "&amp;smalltypeid=" + this.smalltypeid + "\">" + this.GetLang("返回列表|返回列表|Back to list") + "</a>");
