<%@ Page Language="C#" AutoEventWireup="true" Codebehind="viewUser.aspx.cs" Inherits="KeLin.WebSite.picture.viewUser" %>
                                    ...
                                    <tr>
                                        <td colspan="4">
                                                ...
                                                <ItemTemplate>
                                                        ...
                                                        <tr>
                                                            <td class="f" colspan="2">
                                                                <span class="forumThread" id="_ct">上传者: <b>
                                            ...
                                            <asp:DataList ID="DataList1" runat="server" Height="100%" Width="100%" 
                                                ...
                                                <ItemTemplate>
                                                    <img src="<%# DataBinder.Eval(Container.DataItem, "bookfile")%>" alt="..."
                                                        border="0" /><br />
