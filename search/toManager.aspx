...
if (ver == "1")
{
    ...
    if (this.INFO != "OK")
    {
        Response.Write("用户名ID:<a href=\"" + http_start + "bbs/userinfomore.aspx?siteid=" + this.siteid + "&amp;classid=" + this.classid + "&amp;touserid=" + touserid + "\">" + touserVo.userid + "</a><br/>");
...
else //2.0界面
{
    ...
    if (this.INFO != "OK")
    {
        ...
        Response.Write(this.GetLang("重置他的密码|重置他的密码|change his password") + ":<br/>");
        Response.Write("<input type=\"text\" name=\"topassword\" value=\"\"/><br/>");
        Response.Write("(不重置密码留空)<br/>");

       
        Response.Write(this.GetLang("重置他的银行存款|重置他的银行存款|change his bank money") + ":<br/>");
        Response.Write("<input type=\"text\" name=\"tobankmoney\" value=\"" + tobankmoney + "\"/><br/>");

        Response.Write(this.GetLang("重置他的经验|重置他的经验|change his expR") + ":<br/>");
        Response.Write("<input type=\"text\" name=\"toexpR\" value=\"" + toexpR + "\"/><br/>");
        ...
        Response.Write(this.GetLang("会员身份级别|会员身份级别|his ID") + "(<a href=\"" + this.http_start + "bbs/smalltypelist.aspx?siteid="+this.siteid +"&amp;systype=card&amp;sid="+this.sid+"\">管理</a>):<br/>");
        ...
        Response.Write(WapTool.showIDEndTime(touserVo.siteid, touserVo.userid, touserVo.endTime, this.lang) + "<br/>");
        Response.Write(this.GetLang("更改时间|更改时间|change date") + ":<br/>");
        Response.Write("<input type=\"text\" name=\"tochangedate\" value=\"" + tochangedate + "\"/><br/>(时间隔:2012-01-08 正站长永久无期限)<br/>");
