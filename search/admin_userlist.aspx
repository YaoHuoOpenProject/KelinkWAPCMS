<%@ Page Language="C#" AutoEventWireup="true" Codebehind="admin_userlist.aspx.cs" Inherits="KeLin.WebSite.search.admin_userlist" %>
                                            ...
                                            <table id="tblManageRanks" class="tableBorder" cellspacing="1" cellpadding="3" border="0"
                                                ...
                                                <tr>
                                                    <td class="fh" colspan="2" >
                                                        ...
                                                        发件人ID：<asp:TextBox ID="TextBox1" runat="server" Columns="20" MaxLength="8" Width="64px"></asp:TextBox>
                                                        收件人ID：<asp:TextBox ID="TextBox4" runat="server" Columns="20" MaxLength="8" Width="64px"></asp:TextBox>标题/内容关键字：<asp:TextBox
                                        ...
                                        <td colspan="4" valign="top" align="left">
                                            <asp:DataGrid ID="DataGrid1" runat="server" DataKeyField="id" AllowSorting="True"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateColumn HeaderText="类别" SortExpression="isnew" ItemStyle-Width="50px"
                                                        HeaderStyle-CssClass="column">
                                                        <ItemTemplate>
                                                            <%#this.GetTypeName(DataBinder.Eval(Container.DataItem, "isnew").ToString())%>
                                                        </ItemTemplate>
                                                    </asp:TemplateColumn>
                                                    <asp:TemplateColumn HeaderText="发件人ID" SortExpression="userid" ItemStyle-Width="50px"
                                                        HeaderStyle-CssClass="column">
                                                        <ItemTemplate>
                                                            <%#DataBinder.Eval(Container.DataItem, "userid")%>
                                                        </ItemTemplate>
                                                    </asp:TemplateColumn>
                                                    <asp:TemplateColumn HeaderText="昵称" SortExpression="nickname" ItemStyle-Width="120px"
                                                        HeaderStyle-CssClass="column">
                                                        <ItemTemplate>
                                                            <%#DataBinder.Eval(Container.DataItem, "nickname")%>
                                                        </ItemTemplate>
                                                    </asp:TemplateColumn>
                                                    <asp:TemplateColumn HeaderText="标题" SortExpression="title" ItemStyle-HorizontalAlign="Center"
                                                        ItemStyle-Width="120px" HeaderStyle-CssClass="column">
                                                        <ItemTemplate>
                                                    ...
                                                    <asp:TemplateColumn HeaderText="收件人ID" SortExpression="touserid" ItemStyle-Width="50px"
                                                        HeaderStyle-CssClass="column">
                                                        <ItemTemplate>
                                                            <%#DataBinder.Eval(Container.DataItem, "touserid")%>
                                                        </ItemTemplate>
                                                    </asp:TemplateColumn>
                                            ...
                                            <br />
                                            (另外在【系统管理】-->【数据库备份】中删除时间大于30天的站内短信)
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
