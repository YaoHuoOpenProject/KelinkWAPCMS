...
if (ver == "1")
{
   ...
   if (this.INFO == "OK")
   {
       strhtml.Append("<b>设置头像成功，请等待同步大图..</b><br/>");
   } 
   ...
   strhtml.Append("[<a href=\"" + this.http_start + "album/myalbum.aspx?siteid="+this.siteid+"&amp;classid=0&amp;touserid=" + bookVo.makerid + "&amp;backurl="+HttpUtility.UrlEncode("album/book_view.aspx?siteid="+this.siteid+"&classid="+this.classid+"&amp;id="+this.id+"")+"\">TA的相册</a>] "); 
    ...
    if (this.INFO == "OK")
    {
        strhtml.Append("<div class=\"tip\">设置头像成功，稍后会自动设为大图，请勿重复上传..</div>");
    }
   ...
   // strhtml.Append("<br/>");
    ...
    if (this.userid == bookVo.makerid.ToString())
    {
        ...
        strhtml.Append("<a href=\"" + this.http_start + "album/albumlist.aspx?siteid="+this.siteid+"&amp;classid=0&amp;touserid="+this.userid+"&amp;smalltypeid=" + bookVo.smalltype + "" + "\">列表管理</a>");
        strhtml.Append("<a href=\"" + this.http_start + "bbs/userinfo.aspx?siteid=" + this.siteid + "&amp;touserid="+this.userid+"\">我的空间</a>");
        strhtml.Append("</div></div>");
    }
    strhtml.Append("<div class=\"btBox\"><div class=\"bt2\">");
