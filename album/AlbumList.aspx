...
else //2.0界面
{
    ...
    if (this.touserid == this.userid)
    {
        strhtml.Append("<div class=\"bt1\"><a href=\"" + this.http_start + "album/admin_WAPadd.aspx?siteid=" + this.siteid + "&amp;classid=0&amp;smalltypeid=" + this.smalltypeid + "" + "\">上传本分类相片</a></div><br/>");
    }
    ...
    for (int i = 0; (listVo != null && i < listVo.Count); i++)
    {
        ...
        if (this.touserid == this.userid)
        {
            strhtml.Append("<a class=\"urlbtn\" href=\"" + http_start + "album/albumlist_change.aspx?action=del&amp;siteid=" + this.siteid + "&amp;classid=0&amp;smalltypeid=" + listVo[i].smalltype + "&amp;id=" + listVo[i].id + "&amp;toclassid=" + listVo[i].book_classid + "&amp;page=" + this.CurrentPage + "&amp;backurl=" + HttpUtility.UrlEncode(backurl) + "" + "\">转移</a>.<a class=\"urlbtn\" href=\"" + http_start + "album/albumlist_mod.aspx?action=del&amp;siteid=" + this.siteid + "&amp;classid=0&amp;smalltypeid=" + this.smalltypeid + "&amp;id=" + listVo[i].id + "&amp;backurl=&amp;page=" + this.CurrentPage + "" + "\">修改</a>.<a class=\"urlbtn\" href=\"" + http_start + "album/albumlist_del.aspx?action=del&amp;siteid=" + this.siteid + "&amp;classid=0&amp;smalltypeid=" + this.smalltypeid + "&amp;id=" + listVo[i].id + "&amp;backurl=" + HttpUtility.UrlEncode(backurl) + "&amp;page=" + this.CurrentPage + "" + "\">删除</a> ");
