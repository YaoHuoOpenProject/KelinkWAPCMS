<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="admin_userlistWAP00.aspx.cs" Inherits="KeLin.WebSite.album.admin_userlistWAP00" %>

<%@ Import namespace="KeLin.ClassManager.Tool" %><%
Response.Write(WapTool.showTop(this.GetLang("相册内容审核|相册內容审核|Check Content of the album"), wmlVo));//显示头                                                                                                                                                                       
if (ver == "1")
{
    strhtml.Append("<p align=\"left\">");
    strhtml.Append("内容审核.<a href=\"" + this.http_start + "album/admin_guestlistWAP00.aspx?siteid=" + this.siteid + "&amp;classid=" + this.classid + "&amp;tositeid=" + this.tositeid + "\">评论审核</a><br/>");
    ...
    strhtml.Append("<anchor><go href=\"" + http_start + "album/admin_userlistWAP00.aspx\" method=\"get\" accept-charset=\"utf-8\">");
    ...
    for (int i = 0; (listVo != null && i < listVo.Count); i++)
    {
        ...
        {
            YesOrNo = "×";
            CheckStr = "[<a href=\"" + this.http_start + "album/admin_userlistWAP00.aspx?action=gocheck&amp;id=" + listVo[i].id + "&amp;state=0&amp;siteid=" + this.siteid + "&amp;classid=" + this.classid + "&amp;tositeid="+this.tositeid+"&amp;page=" + this.CurrentPage + "\">审核</a>]";
        }
        else
        {
            YesOrNo = "√";
            CheckStr = "[<a href=\"" + this.http_start + "album/admin_userlistWAP00.aspx?action=gocheck&amp;id=" + listVo[i].id + "&amp;state=1&amp;siteid=" + this.siteid + "&amp;classid=" + this.classid + "&amp;tositeid="+this.tositeid+"&amp;page=" + this.CurrentPage + "\">取审</a>]";
        }
        strhtml.Append(index + "." + YesOrNo + "[" + this.tositeid + "]" + CheckStr + "[<a href=\"" + this.http_start + "album/admin_WAPdel00.aspx?action=go&amp;id=" + listVo[i].id + "&amp;siteid=" + this.siteid + "&amp;classid=" + this.classid + "&amp;tositeid=" + this.tositeid + "&amp;page=" + this.CurrentPage + "\">删</a>][<a href=\"" + this.http_start + "album/admin_userlistWAP00.aspx?action=class&amp;siteid=" + siteid + "&amp;tositeid=" + this.tositeid + "&amp;classid=" + listVo[i].book_classid + "" + "\">" + listVo[i].classname + "</a>]<a href=\"" + http_start + "album/book_view.aspx?siteid=" + siteid + "&amp;classid=" + listVo[i].book_classid + "&amp;id=" + listVo[i].id + "\">" + listVo[i].book_title + "(" + listVo[i].book_click.ToString() + ")</a><br/>");
    }
    if (listVo == null)
    {
...
else //2.0界面
{
    ...
    strhtml.Append("<form name=\"f\" aciont=\"" + http_start + "album/admin_userlistWAP00.aspx\" method=\"post\">");
    ...
    strhtml.Append("<div class=\"tip\"><a href=\"" + this.http_start + "album/admin_userlistWAP00.aspx?action=gocheckall&amp;state=0&amp;siteid=" + this.siteid + "&amp;classid=" + this.classid + "&amp;tositeid=" + this.tositeid + "&amp;page=" + this.CurrentPage + "\">审核所有</a>.<a href=\"" + this.http_start + "album/admin_userlistWAP00.aspx?action=gocheckall&amp;state=1&amp;siteid=" + this.siteid + "&amp;classid=" + this.classid + "&amp;tositeid=" + this.tositeid + "&amp;page=" + this.CurrentPage + "\">取消所有审核</a></div>");
    //显示列表
    strhtml.Append(this.linkTOP);
    string YesOrNo = "";
    string CheckStr = "";
