<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="admin_WAPadd2.aspx.cs" Inherits="KeLin.WebSite.picture.admin_WAPadd2" %>
...
if (ver == "1")
{
    ...
    Response.Write("<a href=\"" + this.http_start + "picture/admin_WAPadd2.aspx?action=class&amp;siteid=" + this.siteid + "&amp;classid=" + this.classid + "&amp;smalltypeid=" + this.smalltypeid + "&amp;sid=" + this.sid1 + "-2-" + this.cs + "-" + this.lang + "-" + this.myua + "-" + this.width + "\">" + this.GetLang("进入WAP2.0界面上传|进入WAP2.0界面上传|wap2.0 add upfile") + "</a><br/>");
...
else //2.0界面
{
    ...
    Response.Write("(是指一个标题对应一张图片)<br/>");
    Response.Write("</div>");
    ...
    Response.Write("<form name=\"g1\" action=\"" + http_start + "picture/admin_WAPadd2.aspx\" method=\"get\">");
    ...
    //选择栏目
    Response.Write("<form name=\"gt\" action=\"" + http_start + "picture/admin_WAPadd2.aspx\" enctype=\"multipart/form-data\" method=\"post\">");
