<%@ Page Language="C#" AutoEventWireup="true" Codebehind="userlist.aspx.cs" Inherits="KeLin.WebSite.picture.userlist" %>
...
<link href="/NetCSS/style.css" rel="stylesheet" type="text/css">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function DoEdit() {
            ...
            window.open('/picture/admin_WAPmodify.aspx?action=go&id=' + edtHangBiaoShis + '&siteid=<%=base.SiteId %>&classid=' + toclassid + '&page=1&sid=<%=base.SID %>');
         ...
         **/
            window.location.href = "/admin/modifyAD.aspx?systype=picture";
        }
        function DoContent() {
        ...
        function DoSmall() {
            window.location.href="../admin/systemclass.aspx?systype=picture&classid="+document.getElementById("TextBox4").value;  
        }
        function DoMyItem() {
            var delHangBiaoShis = GetOnChecked();
            if (delHangBiaoShis == null || delHangBiaoShis == "") {
...
window.location.href="upload_bath.aspx?systype=picture&classid="+ItemID;
//window.open ("upload_bath.aspx?systype=picture&classid=<%=classid%>", "addsystemwindow", "height=450, width=550, toolbar= no, menubar=no, scrollbars=no, resizable=no, location=no, status=no");
}
function daoru() { 
                                                    ...
                                                    <tr>
                                                        <td class="fh" colspan="4">
                                                         <input id="Button3" name="" type="button" value=" 审 核 " onclick="DoCheck()" class="bt"/>                                                       
                                                            ...
                                                            <input id="Button1" name="" type="button" value="栏目配置" onclick="window.open('/picture/ClassConfigAll.aspx?action=go&classid=<%=this.classid %>&siteid=<%=base.SiteId %>&page=1&sid=<%=base.SID %>');" class="bt"/>
                                                           
                                                            <input id="Button2" name="" type="button" value="一对一批量上传" onclick="window.open('/picture/admin_WAPadd2.aspx?num=2&action=go&classid=<%=this.classid %>&siteid=<%=base.SiteId %>&page=1&sid=<%=base.SID %>');" class="bt"/>
                                                           
                                                            <input id="Button11" name="" type="button" value="一对多批量上传" onclick="window.open('/picture/admin_WAPadd.aspx?num=2&action=go&classid=<%=this.classid %>&siteid=<%=base.SiteId %>&page=1&sid=<%=base.SID %>');" Class="bt" />
                                                            
                                                            <input id="Button7" name="" type="button" value="采集接口" onclick="window.open('/picture/admin_WAPaddText.aspx?num=2&action=go&classid=<%=this.classid %>&siteid=<%=base.SiteId %>&page=1&sid=<%=base.SID %>');" class="bt"/>
