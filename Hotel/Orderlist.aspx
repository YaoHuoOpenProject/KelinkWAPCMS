<%@ Page Language="C#" AutoEventWireup="true" Codebehind="orderlist.aspx.cs" Inherits="KeLin.WebSite.hotel.orderlist" %>
...
<link href="/NetCSS/style.css" rel="stylesheet" type="text/css">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function DoSmall() {
            window.location.href="../admin/systemclass.aspx?systype=hotel&classid="+document.getElementById("TextBox1").value;  
        }
                                        ...
                                        <td colspan="4" valign="top" align="left">
                                            <asp:DataGrid ID="DataGrid1" runat="server" DataKeyField="id" AllowSorting="True"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateColumn HeaderText="订酒店" SortExpression="hotelid" ItemStyle-Width="50px" HeaderStyle-CssClass="column">
                                                        <ItemTemplate>
                                                            <a href="viewuser.aspx?bookid=<%#DataBinder.Eval(Container.DataItem,"hotelid") %>"
                                                    ...
                                                    <asp:TemplateColumn HeaderText="天数" SortExpression="days" ItemStyle-Width="60px" HeaderStyle-CssClass="column">
                                                        <ItemTemplate>
