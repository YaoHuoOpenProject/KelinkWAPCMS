<%@ Page Language="C#" AutoEventWireup="true" Codebehind="userlist.aspx.cs" Inherits="KeLin.WebSite.hotel.userlist" %>
...
<link href="/NetCSS/style.css" rel="stylesheet" type="text/css">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function DoEdit() {
            ...
            window.open('/hotel/admin_WAPmodify.aspx?action=go&id=' + edtHangBiaoShis + '&siteid=<%=base.SiteId %>&classid=' + toclassid + '&page=1&sid=<%=base.SID %>');         
        }
        function DoDel() {
        ...
        function DoNew() {
            ...
            window.open('/hotel/admin_WAPadd.aspx?siteid=<%=base.SiteId %>&classid=<%=this.classid %>&page=1&sid=<%=base.SID %>');         
        }
        function DoAd() {        
            window.location.href="../admin/modifyAD.aspx?systype=hotel";
        }
        function DoTop() {
            var delHangBiaoShis = GetOnChecked();
            if (delHangBiaoShis == null || delHangBiaoShis == "") {
        ...
        function DoSmall() {
            window.location.href="../admin/systemclass.aspx?systype=hotel&classid="+document.getElementById("TextBox4").value;  
        }
        function DoMyItem() {
            var delHangBiaoShis = GetOnChecked();
            if (delHangBiaoShis == null || delHangBiaoShis == "") {
                                            ...
                                            <td colspan="4" valign="top" align="left">
                                                <asp:DataGrid ID="DataGrid1" runat="server" DataKeyField="id" AllowSorting="True"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateColumn HeaderText="酒店名称" ItemStyle-Width="150px" HeaderStyle-CssClass="column">
                                                            <ItemTemplate>
                                                        ...
                                                        <asp:TemplateColumn HeaderText="星级" SortExpression="lvl" ItemStyle-Width="100px" HeaderStyle-CssClass="column">
                                                            <ItemTemplate>
                                                                <%#DataBinder.Eval(Container.DataItem, "lvl")%>
                                                            </ItemTemplate>
                                                        </asp:TemplateColumn>
                                                        <asp:TemplateColumn HeaderText="城市" SortExpression="city" ItemStyle-Width="60px" HeaderStyle-CssClass="column">
                                                            <ItemTemplate>
                                                        ...
                                                        <asp:TemplateColumn HeaderText="价格" SortExpression="showmoney" ItemStyle-Width="80px" HeaderStyle-CssClass="column">
                                                            <ItemTemplate>
                                                                <%#DataBinder.Eval(Container.DataItem, "showmoney")%>
                                                            </ItemTemplate>
                                                        </asp:TemplateColumn>
