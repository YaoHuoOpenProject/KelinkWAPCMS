...
<%
    ...
    Sub Page_Load()
        ...
        Call WML_Head("物品商店","left")
            ...
            Response.Write("类型:<a href="""&Server.HTMLEncode(ChuLiDiZhi("ShangDian.asp?RID="&RID,sid))&""">作物</a>.化肥.<a href="""&Server.HTMLEncode(ChuLiDiZhi("ShangDian_XianJing.asp",sid))&""">陷阱</a><br/>")
            ...
            Rs.AbsolutePage=Page
                ...
                For i=1 To Rs.PageSize
                    ...
                    Response.Write("化肥单价:"&Rs("HuaFeiDanJia")&"金币<br/>")
                    Response.Write("使用等级:"&Rs("GouMaiDenJi")&"级")
                    Response.Write("<a href="""&Server.HTMLEncode(ChuLiDiZhi("HuaFei_GouMai.asp?ID="&Rs("ID")&"&rurl="&Server.URLEncode(ChuLiDiZhi("ShangDian_HuaFei.asp?ID="&RID&"&page="&Page,sid)),sid))&""">购买</a>")
                    Response.Write("<br/>")
            ...
            If Rs.PageCount>1 Then
                    ...
                    If Page<Rs.PageCount Then
                        Response.Write("<a href="""&Server.HTMLEncode(ChuLiDiZhi("ShangDian_HuaFei.asp?ID="&RID&"&page="&(Page+1),sid))&""">[下页]</a>")
                    End If
                    If Page>1 Then
                        Response.Write("<a href="""&Server.HTMLEncode(ChuLiDiZhi("ShangDian_HuaFei.asp?ID="&RID&"&page="&(Page-1),sid))&""">[上页]</a>")
                    End If
                    
                    Response.Write("<input type=""text"" name=""page"" format=""*N"" value=""2"" size=""2""/>")
                    Response.Write("<anchor><go href=""ShangDian_HuaFei.asp"" method=""get"">")
