<%@ Page Language="C#" AutoEventWireup="true" Codebehind="userlist.aspx.cs" Inherits="KeLin.WebSite.chat.userlist" %>
...
<link href="/NetCSS/style.css" rel="stylesheet" type="text/css">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function DoEdit() {
            ...
            window.location.href="modifyUser.aspx?classid=<%=classid %>&chatid="+edtHangBiaoShis;
                                                ...
                                                <table id="tblManageRanks" class="tableBorder" cellspacing="1" cellpadding="3" border="0"
                                                    ...
                                                    <tr>
                                                        <td class="fh" colspan="4">
                                                            栏目ID：<asp:TextBox ID="TextBox4" runat="server" Columns="20" MaxLength="8" Width="64px"></asp:TextBox>内容关键字：<asp:TextBox
                                                                ID="TextBox5" runat="server" Columns="20" MaxLength="8" Width="156px"></asp:TextBox>
                                                        ...
                                                        <td class="fh" colspan="4" >                                                            
                                                            ...
                                                            <input id="Button4" name="" type="button" value="删 除" onclick="DoDel()"  class="bt"/>&nbsp;&nbsp;
                                                             ...
                                                             <input id="Button1" name="" type="button" value="清空本栏目" onclick="window.open('/chat/admin_WAPdel.aspx?action=delall&classid=<%=this.classid %>&siteid=<%=base.SiteId %>&page=1&sid=<%=base.SID %>');" class="bt"/>
                                                         
                                                           
                                                            
                                                            <input id="Button12" name="" type="button" value="更多栏目属性设置" onclick="window.open('/chat/classconfigall.aspx?classid=<%=this.classid %>&siteid=<%=base.SiteId %>&page=1&sid=<%=base.SID %>');" class="bt"/>
                                                ...
                                                <asp:DataGrid ID="DataGrid1" runat="server" DataKeyField="id" AllowSorting="True"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateColumn HeaderText="栏目ID" SortExpression="classid" ItemStyle-Width="50px" HeaderStyle-CssClass="column">
                                                            <ItemTemplate>
                                                                <a href="userlist.aspx?classid=<%=classid %>"
                                                                    target="_self" title="快速进入修改">
                                                                    <%#DataBinder.Eval(Container.DataItem, "classid")%>
                                                                </a>
                                                            </ItemTemplate>
                                                        </asp:TemplateColumn>
                                                        <asp:TemplateColumn HeaderText="发言者" SortExpression="nickname" ItemStyle-Width="120px" HeaderStyle-CssClass="column">
                                                            <ItemTemplate>
                                                                <%#DataBinder.Eval(Container.DataItem, "nickname")%>
                                                            </ItemTemplate>
                                                        </asp:TemplateColumn>
                                                        <asp:TemplateColumn HeaderText="对谁说" SortExpression="tonickname" ItemStyle-Width="120px" HeaderStyle-CssClass="column">
                                                            <ItemTemplate>
                                                                <%#DataBinder.Eval(Container.DataItem, "tonickname")%>
                                                            </ItemTemplate>
                                                        </asp:TemplateColumn>
                                                        <asp:TemplateColumn HeaderText="内容" HeaderStyle-CssClass="column">
                                                            <ItemTemplate>
                                                                <%#DataBinder.Eval(Container.DataItem, "content")%>
                                                            </ItemTemplate>
                                                        </asp:TemplateColumn>
                                                        <asp:TemplateColumn HeaderText="聊天时间" SortExpression="times" ItemStyle-Width="120px" HeaderStyle-CssClass="column">
                                                            <ItemTemplate>
