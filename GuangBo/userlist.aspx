<%@ Page Language="C#" AutoEventWireup="true" Codebehind="userlist.aspx.cs" Inherits="KeLin.WebSite.guangbo.userlist" %>

<%@ Register Assembly="AspNetPager" Namespace="Wuqi.Webdiyer" TagPrefix="webdiyer" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>guangbo代码资源</title>
...
<link href="/NetCSS/style.css" rel="stylesheet" type="text/css">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function DoEdit() {
            ...
            window.open('/guangbo/admin_WAPmodify.aspx?action=go&id=' + edtHangBiaoShis + '&siteid=<%=base.SiteId %>&classid=' + toclassid + '&page=1&sid=<%=base.SID %>');
         ...
         **/
            window.location.href = "/admin/modifyAD.aspx?systype=guangbo";
        }
        function DoContent() {
        ...
        function DoSmall() {
            window.location.href="../admin/systemclass.aspx?systype=guangbo&classid="+document.getElementById("TextBox4").value;  
        }
        function DoMyItem() {
            var delHangBiaoShis = GetOnChecked();
            if (delHangBiaoShis == null || delHangBiaoShis == "") {
...
window.location.href="upload_bath.aspx?systype=guangbo&classid="+ItemID;
//window.open ("upload_bath.aspx?systype=guangbo&classid=<%=classid%>", "addsystemwindow", "height=450, width=550, toolbar= no, menubar=no, scrollbars=no, resizable=no, location=no, status=no");
}
function daoru() { 
                                                ...
                                                <table id="tblManageRanks" class="tableBorder" cellspacing="1" cellpadding="3" border="0"
                                                    ...
                                                    <tr>
                                                        <td class="fh" colspan="4">
                                                            ...
                                                            <asp:DropDownList ID="DropDownList3" runat="server">
                                                                <asp:ListItem Value="">所有投放状态</asp:ListItem>
                                                                <asp:ListItem Value="0">正在投放</asp:ListItem>
                                                                <asp:ListItem Value="1">已经过期</asp:ListItem>
                                                            </asp:DropDownList>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <input id="Button8" name="" type="button" value=" 审 核 " onclick="DoCheck()" class="bt"/>                                                       
                                                            ...
                                                            &nbsp;<!--
                                                            <input id="Button2" name="" type="button" value="一对一批量上传" onclick="window.open('/guangbo/admin_WAPadd2.aspx?num=2&action=go&classid=<%=this.classid %>&siteid=<%=base.SiteId %>&page=1&sid=<%=base.SID %>');" class="bt"/>
                                                            &nbsp;-->
                                                            <input id="Button11" name="" type="button" value="新增" onclick="window.open('/guangbo/admin_WAPadd.aspx?num=2&action=go&classid=<%=this.classid %>&siteid=<%=base.SiteId %>&page=1&sid=<%=base.SID %>');" Class="bt" />
                                                            &nbsp;
                                            ...
                                            <td colspan="4" valign="top" align="left">
                                                <asp:DataGrid ID="DataGrid1" runat="server" DataKeyField="id" AllowSorting="True"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateColumn HeaderText="标题ID" SortExpression="id" HeaderStyle-CssClass="column" ItemStyle-Width="60px">
                                                            <ItemTemplate>
                                                        ...
                                                        <asp:TemplateColumn HeaderText="过期时间" SortExpression="endtime" ItemStyle-Width="120px"
                                                            HeaderStyle-CssClass="column">
                                                            <ItemTemplate>
