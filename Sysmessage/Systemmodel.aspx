                                            ...
                                            <table id="tblManageRanks" class="tableBorder" cellspacing="1" cellpadding="3" border="0"
                                                ...
                                                <tr align="center">
                                                    <td class="fh" colspan="2">
                                                        ...
                                                        &nbsp;&nbsp; &nbsp;
                                                        <asp:Button ID="bt_return" Width="60" Text='返 回' runat="server" OnClick="bt_return_Click"  CssClass="bt"></asp:Button>
                                                ...
                                                <ItemTemplate>
                                                    <tr>
                                                        ...
                                                        <td class="f">
                                                            ...
                                                            <asp:Button ID="bt_Del" CommandName="Delete" runat="server" Width="60" Text='删除'  CssClass="bt"></asp:Button>
                                                        </td>
                                                    </tr>
                                                </ItemTemplate>
