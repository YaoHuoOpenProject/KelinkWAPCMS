<%@ Page Language="C#" AutoEventWireup="true" Codebehind="systemindex.aspx.cs" Inherits="KeLin.WebSite.WEB.ModelPagetion.systemindex" %>

<%@ Register Assembly="AspNetPager" Namespace="Wuqi.Webdiyer" TagPrefix="webdiyer" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>系统网页模板管理</title>
...
function DaoRu(str) {
    ...
    //处理将地址加入到父窗口中
    try {
        window.parent.opener.DaoRuSysPageTohtml(str);
    } catch (e) {
    window.parent.DaoRuSysPageTohtml(str);
    }
                                                                    ...
                                                                    <tbody>
                                                                        ...
                                                                        <tr>
                                                                            <td class="column" align="center">
                                                                                请选择 <%if (base.ManagerLvl == "00")
                                                                                      { %> <a href="systemmodel.aspx">分类管理</a><%} %>
                                                                                </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td class="f">
...
d = new dTree('d');
d.add(0,-1,'<a href="systemindex.aspx?typeid=&seq=<%=seq %>">查看所有分类</a>','');
  	                                      
  <%=strJavascript %>                                     

document.write(d);
                                                                                </script>
<br /><br /><font color=red>【系统网页模板】指一个HTML页面的完整代码，主要给站长演示及共享调用使用！更多模板等下次升级或自己到baidu.com或g.cn一下就很多了。模板放在/WebModel/目录下！</font>
                                                        ...
                                                        <td>
                                                            <asp:DataGrid ID="DataGrid1" runat="server" DataKeyField="id" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateColumn HeaderText="名称" ItemStyle-Width="200px" HeaderStyle-CssClass="column">
                                                                        <ItemTemplate>
                                                                            <a href="/web/editpage/editsysPage.aspx?id=<%#DataBinder.Eval(Container.DataItem,"id") %>"
                                                                    ...
                                                                    <asp:TemplateColumn HeaderText="操作"  ItemStyle-Width="40px"
                                                                        HeaderStyle-CssClass="column">
                                                                        <ItemTemplate>
                                                                                 &nbsp;&nbsp; &nbsp;&nbsp;<input type="button" name="view" value=" 预  览  效  果 " onclick="window.open('/web/editpage/editsysPage.aspx?id=<%#DataBinder.Eval(Container.DataItem,"id") %>');" class="bt" />
                                                                                
                                                                                 <%if (seq == "1")
                                                                                   { %>
                                                                                <br /> <br />
                                                                                &nbsp;&nbsp; &nbsp;&nbsp;<input type="button" name="cha" value="替换导入当前页面" onclick="DaoRu(code<%#DataBinder.Eval(Container.DataItem,"id") %>.value);" class="bt" />
                                                                                <%} %>
                                                                    ...
                                                                    <asp:TemplateColumn HeaderText="添加时间" SortExpression="addtime" ItemStyle-Width="120px"
                                                                        ...
                                                                        <ItemTemplate>
                                                                            ...
                                                                            <br /><br />创建人:<%#DataBinder.Eval(Container.DataItem, "makerid")%>
                                                                        </ItemTemplate>
                                                                    </asp:TemplateColumn>
                                                                </Columns>
                                                            </asp:DataGrid>
