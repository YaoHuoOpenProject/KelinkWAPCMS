<%@ Page Language="C#" AutoEventWireup="true" validateRequest="false" CodeBehind="add.aspx.cs" Inherits="KeLin.WebSite.WEB.Style.add" %>
<html>
<head>
            ...
            <tr>
              ...
              <td width="98%" background="/NetImages/main_title_02.gif"><table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                  ...
                  <td width="98%" height="24" valign="middle">页面综合排版 &gt;&gt; CSS样式管理 &gt;&gt; 新增CSS样式</td>
                </tr>
              </table></td>
      ...
      <FORM name="messageForm" action="add.aspx" method="post">
      	<input type="hidden" name="action" value="add" />
                              <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" height="554">
                                ...
                                <TR class="tdbg" > 
                                  <TD height="29" width="186" align="right" class="style1"><strong>*CSS样式：<br /><br />系统定义 <br />+<br /> 自己定义</strong></TD>
...
.comment div{background:#ffe;padding:3px;border:1px solid #aaa;line-height:140%;margin-bottom:5px;}
                                      ...
                                      <br />(层宽width参数需要用100%或固定值px，WEB版不能用[width]!)<br />
<b>系统定义样式名UBB调用：</b><br />
