<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" Codebehind="EditMyFunc.aspx.cs"
    Inherits="KeLin.WebSite.WEB.ModelFunction.EditMyFunc" %><html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>系统单独模块管理</title>
...
<form  id="form1" name="form1" onSubmit="submits();" action="editMyFunc.aspx" method="post">
<table border="0" width="98%" align="center" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" height="30">
		<tr>
			<td align="center"> <b>我的单独模块名称*：<input type="text" name ="title" value ="<%=title %>" size="20" />
			&nbsp;&nbsp;&nbsp;&nbsp;我的单独模块分类*：<select name="typeid"><%=selecthtml.ToString() %></select>
			&nbsp;&nbsp;&nbsp;&nbsp;<input type="button" name="go" onclick="window.location.href='/WEB/ModelFunction/systemindex01.aspx?typeid=<%=typeid %>';" value=" 返 回" class="bt" />
			</td>
