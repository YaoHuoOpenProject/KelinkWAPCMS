...
<script language="javascript">
    function window.onload() {
        ...
        if (document.all("config").value == "") {
            ...
            htmlcode = htmlcode + "<title>[classname]-[sitename]</title> <!--录入网站标题-->\n";
...
<table border="0" width="98%" align="center" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" height="30">
		<tr>
			<td align="center"> <b>网页模板名称*：<input type="text" name ="title" value ="<%=title %>" size="20" />
			&nbsp;&nbsp;&nbsp;&nbsp;网页模板分类*：<select name="typeid"><%=selecthtml.ToString() %></select>
			&nbsp;&nbsp;&nbsp;&nbsp;<input type="button" name="go" onclick="window.location.href='/WEB/ModelPage/systemindex.aspx?typeid=<%=typeid %>';" value=" 返 回" class="bt" />
			</td>
