<%@ Page Language="C#" AutoEventWireup="true" Codebehind="systemindex.aspx.cs" Inherits="KeLin.WebSite.WEB.ModelFunction.systemindex" %>
...
d = new dTree('d');
d.add(0,-1,'<a href="systemindex.aspx?typeid=">查看所有分类</a>','');
...
document.write(d);
 ...
 <br /><br /><font color=red>【系统单独模块】指&lt;body&gt;与&lt;/body&gt;之间的任何一段HTML代码，如网站菜单栏，登录窗口，网站底部。此处是演示给站长看及给站长共享调用代码！</font>
                                                            ...
                                                            <asp:DataGrid ID="DataGrid1" runat="server" DataKeyField="id" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateColumn HeaderText="名称" ItemStyle-Width="200px" HeaderStyle-CssClass="column">
                                                                        <ItemTemplate>
                                                                            <a href="/web/EditPage/EditSysFunc.aspx?id=<%#DataBinder.Eval(Container.DataItem,"id") %>"
                                                                      ...
                                                                      <asp:TemplateColumn HeaderText="预览"  ItemStyle-Width="40px"
                                                                        HeaderStyle-CssClass="column">
                                                                        <ItemTemplate>
                                                                             <a href="/web/EditPage/EditSysFunc.aspx?id=<%#DataBinder.Eval(Container.DataItem,"id") %>"
                                                                                target="_self" title="查看">预览</a>
                                                                        </ItemTemplate>
                                                                    </asp:TemplateColumn>  
                                                                    
                                                                    <asp:TemplateColumn HeaderText="操作ID" SortExpression="makerid" ItemStyle-Width="40px"
                                                                        HeaderStyle-CssClass="column">
                                                                        <ItemTemplate>
                                                                            <%#DataBinder.Eval(Container.DataItem, "makerid")%>
                                                                        </ItemTemplate>
                                                                    </asp:TemplateColumn>
