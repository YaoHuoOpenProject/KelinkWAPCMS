<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="admin_WAPchange.aspx.cs" Inherits="KeLin.WebSite.shop.admin_WAPchange" %><%@ Import namespace="KeLin.ClassManager.Tool" %><%
...
if (ver == "1")
{
    ...
    if (this.INFO == "OK")
    {
        ...
        Response.Write("<a href=\"" + this.http_start + "shop/admin_userlistWAP.aspx?siteid=" + this.siteid + "&amp;classid=" + this.toclassid + "&amp;page=1\">" + this.GetLang("返回转移列表|返回列表|Return to new list") + "</a><br/>");
    }
    ...
    Response.Write("<anchor><go href=\""+http_start+"shop/admin_WAPchange.aspx\" method=\"post\" accept-charset=\"utf-8\">");
