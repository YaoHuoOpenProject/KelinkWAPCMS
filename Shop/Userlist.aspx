                                    ...
                                    <tbody>
                                                ...
                                                <table id="tblManageRanks" class="tableBorder" cellspacing="1" cellpadding="3" border="0"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <input id="Button8" name="" type="button" value=" 审 核 " onclick="DoCheck()" class="bt"/>                                                       
                                                            ...
                                                            <input id="Button13" name="" type="button" value="栏目属性" onclick="window.open('/shop/classconfigall.aspx?classid=<%=this.classid %>&siteid=<%=base.SiteId %>&page=1&sid=<%=base.SID %>');" class="bt"/>
                                                            <input id="Button7" name="" type="button" value="运费管理" onclick="window.open('/shop/smalltypelist.aspx?siteid=<%=base.SiteId %>&classid=<%=this.classid %>&sid=<%=base.SID %>');" Class="bt" />
                                                            <input id="Button5" name="" type="button" value="插放广告" onclick="DoAd()" Class="bt"/>
                                                       
                                                            <input id="Button11" name="" type="button" value="新 增" onclick="window.open('/shop/admin_WAPadd.aspx?action=class&siteid=<%=base.SiteId %>&classid=<%=this.classid %>&page=&sid=<%=base.SID %>');" Class="bt" />
                                                            ...
                                                            <input name="" type="button" value="转移我的栏目" onclick="DoMyItem()" id="Button9" Class="bt"/>
                                                             <input name="" type="button" value="复制到其它栏目" onclick="DoEditCopy()" id="Button14" Class="bt"/>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
                                                ...
                                                <asp:DataGrid ID="DataGrid1" runat="server" DataKeyField="id" AllowSorting="True"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateColumn HeaderText="栏目ID" SortExpression="book_classid" ItemStyle-Width="50px" HeaderStyle-CssClass="column">
                                                           ...
                                                           <asp:TemplateColumn HeaderText="商品图片"  HeaderStyle-CssClass="column">
                                                            <ItemTemplate>
                                                                 <img src="<%#DataBinder.Eval(Container.DataItem,"book_smallimg") %>"  height ="100" width="100" alt="缩放图"/>
                                                            </ItemTemplate>
                                                        </asp:TemplateColumn>
                                                         
                                                        <asp:TemplateColumn HeaderText="商品标题"  HeaderStyle-CssClass="column">
                                                            <ItemTemplate>
                                                        ...
                                                        <asp:TemplateColumn HeaderText="价格" ItemStyle-Width="60px" SortExpression="book_yhjiage"  HeaderStyle-CssClass="column">
                                                            <ItemTemplate>
                                                                
                                                                  市场价：￥<%#decimal.Parse(DataBinder.Eval(Container.DataItem, "book_jiage").ToString()).ToString("f2")%><br /><br />
                                                               会员价：￥<%#decimal.Parse(DataBinder.Eval(Container.DataItem, "book_yhjiage").ToString()).ToString("f2")%>
                                                               
                                                            </ItemTemplate>
                                                        </asp:TemplateColumn>
                                                        
                                                        <asp:TemplateColumn HeaderText="二维码"  ItemStyle-Width="50px" HeaderStyle-CssClass="column">
                                                            <ItemTemplate>
                                                            <a href="javascript:ViewQR('<%#ShowQRimg(DataBinder.Eval(Container.DataItem, "id").ToString())%>');">商品展示</a>
                                                               <br />
                                                               <br />
                                                                <a href="javascript:ViewQR('<%#ShowQRimg_pay(DataBinder.Eval(Container.DataItem, "id").ToString())%>');">支付界面</a>
                                                             
                                                            </ItemTemplate>
                                                        </asp:TemplateColumn>
                                                        
                                                        
                                                        <asp:TemplateColumn HeaderText="库存" SortExpression="book_hottel" ItemStyle-Width="40px" HeaderStyle-CssClass="column">
                                                            <ItemTemplate>
                                                                <%#DataBinder.Eval(Container.DataItem, "book_hottel")%>
                                                            </ItemTemplate>
                                                        </asp:TemplateColumn>
                                                        <asp:TemplateColumn HeaderText="已售" SortExpression="saleCount" ItemStyle-Width="40px" HeaderStyle-CssClass="column">
                                                            <ItemTemplate>
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                <br /><br /><font color=red>商品推荐有二个方法：<br />一、用友情链接，用于外站统计，友情链可以指定返回页面，及有每天详细PV/UV/VV/IP统计。<br />二、本站会员推荐，WAP上我的地盘---推荐奖励。<br />以上二种方法需要终端cookies支付，在订单管理中可以查询到。</font>
                                              <br /><br /><b>  二维码图存放在：/shop/upload/<%=base.SiteId %>/QR 可以将此QR目录删除，即可重新生成。</b>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
