<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="albumlist_mod.aspx.cs" Inherits="KeLin.WebSite.album.albumlist_mod" %><%@ Import namespace="KeLin.ClassManager.Tool" %><%
...
if (ver == "1")
{
    ...
    if (this.INFO == "OK")
    {
        ...
        strhtml.Append("</b><br/>");
        strhtml.Append("<a href=\"" + this.http_start + "album/albumlist.aspx?siteid=" + this.siteid + "&amp;classid=" + this.classid + "&amp;page=" + this.page + "\">" + this.GetLang("返回列表|返回列表|Back to list") + "</a><br/>");
    }
    else
    {
        strhtml.Append("<b>");
    ...
    strhtml.Append(this.GetLang("我的分类|我的分类|Class of album") + "*:<br/>");
    ...
    strhtml.Append("<anchor><go href=\""+http_start+"album/albumlist_mod.aspx\" method=\"post\" accept-charset=\"utf-8\">");
    ...
    strhtml.Append("<br/><a href=\"" + this.http_start + "album/albumlist.aspx?siteid=" + this.siteid + "&amp;classid=0&amp;smalltypeid=" + bookVo.smalltype + "&amp;page=" + this.page + "\">" + this.GetLang("返回列表|返回列表|Back to list") + "</a>");
...
else //2.0界面
{
    ...
    strhtml.Append("<form name=\"go\" action=\"" + this.http_start + "album/albumlist_mod.aspx\" method=\"post\">");
    strhtml.Append(this.GetLang("标题|標題|Title") + "*:<br/>");
    ...
    strhtml.Append("<a href=\"" + this.http_start + "album/albumlist.aspx?siteid=" + this.siteid + "&amp;classid=0&amp;smalltypeid=" + bookVo.smalltype + "&amp;page=" + this.page + "\">" + this.GetLang("返回列表|返回列表|Back to list") + "</a>");
