<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AlbumList_change.aspx.cs" Inherits="KeLin.WebSite.album.AlbumList_change" %><%@ Import namespace="KeLin.ClassManager.Tool" %><%
...
if (ver == "1")
{
    ...
    if (this.INFO == "OK")
    {
        ...
        strhtml.Append("</b><br/>");
        strhtml.Append("<a href=\"" + this.http_start + "album/albumlist.aspx?siteid=" + this.siteid + "&amp;classid=" + this.classid + "&amp;smalltypeid="+this.smalltypeid+"&amp;page=" + this.page + "\">" + this.GetLang("返回原列表|返回原列表|Return to Original list") + "</a><br/>");
        strhtml.Append("<a href=\"" + this.http_start + "album/albumlist.aspx?siteid=" + this.siteid + "&amp;classid=" + this.classid + "&amp;smalltypeid=" + this.tosmalltypeid + "&amp;page=1\">" + this.GetLang("返回转移列表|返回列表|Return to new list") + "</a><br/>");
    }
    ...
    strhtml.Append("<anchor><go href=\""+http_start+"album/albumlist_change.aspx\" method=\"post\" accept-charset=\"utf-8\">");
    ...
    strhtml.Append("<br/><a href=\"" + this.http_start + "album/albumlist.aspx?siteid=" + this.siteid + "&amp;classid=" + this.classid + "&amp;smalltypeid="+this.smalltypeid+"&amp;page=" + this.page + "\">" + this.GetLang("返回列表|返回列表|Back to list") + "</a>");
...
else //2.0界面
{
    ...
    strhtml.Append(this.GetLang("转移后分类|轉移後分类|Change ClassID") + "*:<br/>");
    //下拉选择
    strhtml.Append("<form name=\"go\" action=\""+this.http_start+"album/albumlist_change.aspx\" method=\"post\">");
    ...
    strhtml.Append("<a href=\"" + this.http_start + "album/albumlist.aspx?siteid=" + this.siteid + "&amp;classid=" + this.classid + "&amp;smalltypeid="+this.smalltypeid+"&amp;page=" + this.page + "\">" + this.GetLang("返回列表|返回列表|Back to list") + "</a>");
