<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="admin_WAPadd2.aspx.cs" Inherits="KeLin.WebSite.download.admin_WAPadd2" %><%@ Import namespace="KeLin.ClassManager.Tool" %><%
Response.Write(WapTool.showTop(this.GetLang("一对一批量上传|一对一批量上传|upload"), wmlVo));//显示头                                                                                                                                                                       
if (ver == "1")
{
    Response.Write("<p>");
    Response.Write(this.ERROR);

    Response.Write("<a href=\"" + this.http_start + "download/admin_WAPadd2.aspx?action=class&amp;siteid=" + this.siteid + "&amp;classid=" + this.classid + "&amp;page=" + this.page + "&amp;sid=" + this.sid1 + "-2-" + this.cs + "-" + this.lang + "-" + this.myua + "-" + this.width + "\">" + this.GetLang("进入WAP2.0界面上传文件|进入WAP2.0界面上传文件|wap2.0 add upfile") + "</a><br/>");
...
else //2.0界面
{
    ...
    Response.Write("<div class=\"subtitle\">一对一批量上传</div>");
    ...
    if (this.INFO != "OK")
    {
        ...
        Response.Write("<form name=\"g1\" action=\"" + http_start + "download/admin_WAPadd2.aspx\" method=\"get\">");
        ...
        Response.Write("<form name=\"f1\" action=\"" + http_start + "download/admin_WAPadd2.aspx\" enctype=\"multipart/form-data\" method=\"post\">");
        ...
        {
            Response.Write((i + 1) + "."+this.GetLang("标题|標題|Title") + "(留空取文件名):<br/>");
            ...
            Response.Write("<input type=\"text\" name=\"updateInfo\" value=\"\"/><br/>");
            ...
            Response.Write("<textarea name=\"book_content\" rows=\"3\" style=\"width:100%\"></textarea><br/>");
            
            Response.Write("----- 上传图片/文件 -------<br/>");
