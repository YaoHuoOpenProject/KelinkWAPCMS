<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="admin_WAPadd.aspx.cs" Inherits="KeLin.WebSite.download.admin_WAPadd" %><%@ Import namespace="KeLin.ClassManager.Tool" %><%
...
if (ver == "1")
{
    ...
    Response.Write("<a href=\"" + this.http_start + "download/admin_WAPadd.aspx?action=class&amp;siteid=" + this.siteid + "&amp;classid=" + this.classid + "&amp;page=" + this.page + "&amp;sid=" + this.sid1 + "-2-" + this.cs + "-" + this.lang + "-" + this.myua + "-" + this.width + "\">" + this.GetLang("进入WAP2.0界面上传文件|进入WAP2.0界面上传文件|wap2.0 add upfile") + "</a><br/>");
...
else //2.0界面
{
    ...
    if (this.INFO != "OK")
    {
        ...
        Response.Write("<form name=\"g1\" action=\"" + http_start + "download/admin_WAPadd.aspx\" method=\"get\">");
        ...
        Response.Write("<form name=\"f1\" action=\"" + http_start + "download/admin_WAPadd.aspx\" enctype=\"multipart/form-data\" method=\"post\">");
        ...
        Response.Write("<b>--------<br/>");
        Response.Write("<b>上传规则：<br/>第一个选小图片宽<=100将作为缩放图，如果没有则从大图中自动生成缩放图。<br/>第二，三，四可选软件界面截图。<br/>第五个或以上选软件文件。<br/>说白了就是图片和文件可以混合上传自动识别。图片不用选平台/屏幕/系列</b><br/>");
        Response.Write("<b>--------<br/>");
