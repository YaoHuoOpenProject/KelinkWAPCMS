<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Book_Search.aspx.cs" Inherits="KeLin.WebSite.download.Book_Search" %><%@ Import namespace="KeLin.ClassManager.Tool" %><%
Response.Write(WapTool.showTop(this.GetLang("下载搜索|下载搜索|Search"), wmlVo));//显示头 
...
strhtml.Append("<option value=\"title\">下载标题</option>");
strhtml.Append("<option value=\"lable\">标签</option>");
strhtml.Append("<option value=\"makerid\">会员上传(输入会员ID)</option>");
strhtml.Append("<option value=\"days\">N天前(输入天数)</option>");
strhtml.Append("</select><br/>");
strhtml.Append("<anchor><go href=\""+this.http_start +"download/book_list.aspx\" method=\"get\" accept-charset=\"utf-8\">");
...
strhtml.Append("<postfield name=\"lable\" value=\"$(lable)\"/>");
...
strhtml.Append("<form id=\"form1\" action=\""+this.http_start +"download/book_list.aspx\" method=\"get\">");
strhtml.Append("<div class=\"subtitle\">下载搜索</div>");
