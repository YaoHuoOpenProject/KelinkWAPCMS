<%@ Page Language="C#" AutoEventWireup="true" Codebehind="admin_userlist.aspx.cs"
    Inherits="KeLin.WebSite.adlink.admin_userlist" %>

<%@ Register Assembly="AspNetPager" Namespace="Wuqi.Webdiyer" TagPrefix="webdiyer" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>内容审核--点击广告送币内容</title>
                                        ...
                                        <td colspan="4" valign="top" align="left">
                                            <asp:DataGrid ID="DataGrid1" runat="server" DataKeyField="id" AllowSorting="True"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateColumn HeaderText="广告语" SortExpression="" ItemStyle-Width="250px" HeaderStyle-CssClass="column">
                                                    ...
                                                    <asp:TemplateColumn HeaderText="广告地址" SortExpression="" ItemStyle-Width="250px" HeaderStyle-CssClass="column">
