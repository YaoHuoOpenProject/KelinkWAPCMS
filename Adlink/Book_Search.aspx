<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Book_Search.aspx.cs" Inherits="KeLin.WebSite.adlink.Book_Search" %><%@ Import namespace="KeLin.ClassManager.Tool" %><%
Response.Write(WapTool.showTop(this.GetLang("点击广告送币搜索|点击广告送币搜索|Search"), wmlVo));//显示头 
if(ver=="1"){
%>
<p>请输入关键字：<br/>
...
<option value="title">点击广告送币标题</option>
<option value="author">点击广告送币作者</option>
<option value="days">N天前(输入天数)</option>
</select><br/>
<anchor><go href="<%=http_start%>adlink/book_list.aspx" method="get" accept-charset="utf-8">
...
<form id="form1" action="<%=http_start%>adlink/book_list.aspx" method="get">
<div class="subtitle">点击广告送币搜索</div>
<div class="content">
请输入关键字：<br/>
<input type="text" name="key" class="txt" value=""/><br/>
选择搜索项：<br/>
<select name="type" class ="KL_select">
<option value="title">点击广告送币标题</option>
<option value="author">点击广告送币作者</option>
<option value="days">N天前(上面输入天数)</option>
</select><br/>
<input type="submit" value="快速搜索" class="btn" />
