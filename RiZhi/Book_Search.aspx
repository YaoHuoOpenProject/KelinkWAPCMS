<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Book_Search.aspx.cs" Inherits="KeLin.WebSite.rizhi.Book_Search" %><%@ Import namespace="KeLin.ClassManager.Tool" %><%
Response.Write(WapTool.showTop(this.GetLang("博客搜索|博客搜索|Search"), wmlVo));//显示头 
...
strhtml.Append("<option value=\"title\">博客标题</option>");
strhtml.Append("<option value=\"author\">博客作者</option>");
strhtml.Append("<option value=\"days\">N天前(输入天数)</option>");
strhtml.Append("</select><br/>");
strhtml.Append("<anchor><go href=\""+this.http_start +"rizhi/book_list.aspx\" method=\"get\" accept-charset=\"utf-8\">");
...
strhtml.Append("<form id=\"form1\" action=\""+this.http_start +"rizhi/book_list.aspx\" method=\"get\">");
strhtml.Append("<div class=\"subtitle\">博客搜索</div>");
...
if (isWebHtml != "")
{
    ...
    //strhtml_list = strhtml_list.Substrizhi(s, strhtml_list.Length - s);
