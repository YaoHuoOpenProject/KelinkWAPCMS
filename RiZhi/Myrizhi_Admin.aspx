<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="myrizhi_admin.aspx.cs" Inherits="KeLin.WebSite.rizhi.myrizhi_admin" %><%@ Import namespace="KeLin.ClassManager.Tool" %><%
StringBuilder strhtml=new StringBuilder ();                                                                                                                                                              
Response.Write(WapTool.showTop(this.GetLang("博客分类管理|博客分类管理|my fav admin"), wmlVo));//显示头                                                                                                                                                                       
if (ver == "1")
{
    ...
    strhtml.Append("<anchor><go href=\"" + http_start + "rizhi/myrizhi_admin.aspx\" method=\"post\" accept-charset=\"utf-8\">");
    ...
    for (int i = 0; (sublistVo != null && i < sublistVo.Count); i++)
    {
        ...
        strhtml.Append("[<a href=\"" + http_start + "rizhi/myrizhi_admin_mod.aspx?action=mod&amp;siteid=" + this.siteid + "&amp;classid=0&amp;id=" + sublistVo[i].id + "&amp;backurl=" + HttpUtility.UrlEncode(backurl) + "" + "\">修</a>.<a href=\"" + http_start + "rizhi/myrizhi_admin_del.aspx?action=del&amp;siteid=" + this.siteid + "&amp;classid=0&amp;id=" + sublistVo[i].id + "&amp;backurl=" + HttpUtility.UrlEncode(backurl) + "" + "\">删</a>]<br/>");
    ...
    strhtml.Append("----------<br/>");
    strhtml.Append("<a href=\"" + http_start + "rizhi/myrizhi_admin_del.aspx?action=delall&amp;siteid=" + this.siteid + "&amp;classid=0&amp;backurl=" + HttpUtility.UrlEncode(backurl) + "" + "\">清空我的分类</a><br/>");
    strhtml.Append("<a href=\"" + this.http_start + "rizhi/myrizhi.aspx?siteid="+this.siteid+"&amp;classid=0" + "\">返回上级</a> ");
...
else //2.0界面
{
    ...
    strhtml.Append("<div class=\"title\">" + this.GetLang("博客分类管理|博客分类管理|my fav admin") + "</div>");
    ...
    strhtml.Append("<form name=\"f\" action=\"" + http_start + "rizhi/myrizhi_admin.aspx\" method=\"post\">");
    strhtml.Append("分类名称:<br/>");
