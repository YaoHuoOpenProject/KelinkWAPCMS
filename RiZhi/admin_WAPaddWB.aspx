<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="admin_WAPaddWB.aspx.cs" Inherits="KeLin.WebSite.rizhi.admin_WAPaddWB" %><%@ Import namespace="KeLin.ClassManager.Tool" %><%
Response.Write(WapTool.showTop(this.GetLang("发表微博|发表微博|content add"), wmlVo));//显示头                                                                                                                                                                       
...
if (ver == "1")
{
    ...
    if (this.INFO == "OK")
    {
        ...
        strhtml.Append("<br/><a href=\"" + this.http_start + "rizhi/rizhilist.aspx?siteid=" + this.siteid + "&amp;classid=" + this.classid + "&amp;smalltypeid=" + this.smalltypeid + "&amp;book_type=0\">" + this.GetLang("返回|返回|Back to list") + "</a><br/>");
    }
    ...
    {
        strhtml.Append("<b>内容不能小于2个字符！</b><br/>");
    ...
    if (this.INFO != "OK")
    {
        ...
        for (int i = 0; i < this.num; i++)
        {
            ...
            strhtml.Append(this.GetLang("说说|说明|say") + "*:<br/>");
        ...
        strhtml.Append("<anchor><go href=\"" + http_start + "rizhi/admin_WAPaddWB.aspx\" method=\"post\" accept-charset=\"utf-8\">");
        ...
        strhtml.Append("</go>" + this.GetLang("广 播|广 播|Add") + "</anchor><br/><br/>");

        strhtml.Append("<a href=\"" + this.http_start + "rizhi/admin_wapaddWB.aspx?action=class&amp;siteid=" + this.siteid + "&amp;classid=" + this.classid + "&amp;smalltypeid=" + this.smalltypeid + "&amp;book_type=0&amp;sid=" + this.sid1 + "-2-" + this.cs + "-" + this.lang + "-" + this.myua + "-" + this.width + "\">" + this.GetLang("进入WAP2.0界面上传|进入WAP2.0界面上传|wap2.0 add upfile") + "</a><br/>");

    }
    strhtml.Append("<a href=\"" + this.http_start + "rizhi/rizhilist.aspx?siteid=" + this.siteid + "&amp;classid=" + this.classid + "&amp;smalltypeid=" + this.smalltypeid + "\">" + this.GetLang("返回列表|返回列表|Back to list") + "</a><br/>");
...
else //2.0界面
{
    ...
    strhtml.Append("<div class=\"subtitle\">" + this.GetLang("发表微博|发表微博|Add operation") + "</div>");
    ...
    if (this.INFO == "OK")
    {
        ...
        strhtml.Append(" <a class=\"urlbtn\" href=\"" + this.http_start + "rizhi/rizhilist.aspx?siteid=" + this.siteid + "&amp;classid=" + this.classid + "&amp;smalltypeid=" + this.smalltypeid + "&amp;book_type=0\">" + this.GetLang("返回|返回|Back to list") + "</a>");
    }
    else if (this.INFO == "EXTERR")
    {
        strhtml.Append("<b>上传文件格式错误，只允许上传：" + siteVo.UpFileType + "</b><br/>");
    ...
    if (this.INFO != "OK")
    {
        ...
        strhtml.Append("<form name=\"g1\" action=\"" + http_start + "rizhi/admin_WAPaddWB.aspx\" method=\"get\">");
        ...
        //选择栏目
        strhtml.Append("<form name=\"gt\" action=\"" + http_start + "rizhi/admin_WAPaddWB.aspx\" enctype=\"multipart/form-data\" method=\"post\">");
        strhtml.Append(this.GetLang("说说|说说|say") + "*:<br/>");
        strhtml.Append("<textarea name=\"book_title\" rows=\"5\" class=\"KL_textarea\" style=\"width:100%\">" + book_title + "</textarea><br/>");
        ...
        strhtml.Append("<input type=\"hidden\" name=\"sid\" value=\"" + sid + "\"/>");
        strhtml.Append("<input type=\"submit\"  name=\"bt\" class=\"btn\" value=\"" + this.GetLang("广 播|广 播|submit") + "\"/></form>");
        strhtml.Append("</div>");
    ...
    strhtml.Append("<a href=\"" + this.http_start + "rizhi/rizhilist.aspx?siteid=" + this.siteid + "&amp;classid=" + this.classid + "&amp;smalltypeid=" + this.smalltypeid + "&amp;book_type=0\">" + this.GetLang("返回列表|返回列表|Back to list") + "</a>");
