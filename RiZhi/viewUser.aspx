<%@ Page Language="C#" AutoEventWireup="true" Codebehind="viewUser.aspx.cs" Inherits="KeLin.WebSite.rizhi.viewUser" %>
                                    ...
                                    <tr>
                                        <td colspan="4">
                                                ...
                                                <ItemTemplate>
                                                        ...
                                                        <tr>
                                                            <td class="f" colspan="2">
                                                                <span class="forumThread" id="_ct">发表者: <b>
                                            ...
                                            <asp:DataList ID="DataList1" runat="server" Height="100%" Width="100%" 
                                                RepeatColumns="1" RepeatDirection="Horizontal" ShowFooter="False" ShowHeader="False">
                                                <ItemTemplate>
                                                    <a href="<%# DataBinder.Eval(Container.DataItem, "bookfile")%>" target="_blank"><%# DataBinder.Eval(Container.DataItem, "bookfile")%></a>
                                                    <br />
                                            ...
                                            <!-- Repeater End-->
                                            <!--快捷编辑 by Saufu
                                            <table id="Table10" cellspacing="0" cellpadding="0"  border="0" width="100%"
                                                style="height: 225px">
                                                <tbody>
                                                    <tr>
                                                        <td valign="top" align="center" width="100%">
