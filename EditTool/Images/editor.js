...
if (oblog_bIsNC){
document.write('<iframe width="260" height="165" id="colourPalette" src="/EditTool/images/nc_selcolor.htm" style="visibility:hidden; position: absolute; left: 0px; top: 0px;" frameborder="0" scrolling="no" ></iframe>');
}
...
function oblog_foreColor()
{
	...
	if (oblog_bIsIE5){
		var arr = showModalDialog("/EditTool/images/selcolor.html", "", "dialogWidth:18.5em; dialogHeight:17.5em; status:0; help:0");
		if (arr != null) FormatText('forecolor', arr);
		else IframeID.focus();
	}else
		{
		FormatText('forecolor', '');
		//var arr = openEditScript('/EditTool/images/nc_selcolor.htm',250,100)}
		}
}
...
function oblog_help()
{
	//showModalDialog("/EditTool/images/help.html", "", "dialogWidth:13.5em; dialogHeight:12.5em; status:0; help:0");
...
function oblog_View()
{
	...
	if (oblog_filterScript)
	cont=oblog_FilterScript(cont);
	cont=oblog_rCode(cont,"\\[dvnews_ad]","<img src='/EditTool/images//EditTool/images/pic_ad.jpg' vspace=10 hspace=10 align=left border=1 title='Advertising'>");
...
function OpenSmiley()
{
	var arr = showModalDialog("/EditTool/images/smiley.htm", "", "dialogWidth:60em; dialogHeight:15.5em; status:0; help:0");
	if (arr != null){
		var ss;
		ss=arr.split("*")
		path=ss[0];
...
{
	var arr = showModalDialog("/EditTool/images/swf.htm", "", "dialogWidth:30em; dialogHeight:10em; status:0; help:0");
	if (arr != null){
		var ss;
		ss=arr.split("*")
		path=ss[0];
...
{
	var arr = showModalDialog("/EditTool/images/wmv.htm", "", "dialogWidth:30em; dialogHeight:13.5em; status:0; help:0");
...
{
	var arr = showModalDialog("/EditTool/images/rm.htm", "", "dialogWidth:30em; dialogHeight:13.5em; status:0; help:0");
...
{
	var arr = showModalDialog("/EditTool/images/replace.html", "", "dialogWidth:16.5em; dialogHeight:13em; status:0; help:0");
	if (arr != null){
		var ss;
		ss = arr.split("*")
		a = ss[0];
...
{
	var arr = showModalDialog("/EditTool/images/specialchar.html", "","dialogWidth:25em; dialogHeight:15em; status:0; help:0");
...
function oblog_fortable()
{
	if (!oblog_validateMode())	return;
	IframeID.focus();
	var arr = showModalDialog("/EditTool/images/table.html", window, "dialogWidth:22em; dialogHeight:18.5em; status:0; help:0;scroll:no;");
	if (arr)
	{
...
{
	var arr = showModalDialog("/EditTool/images/emot.htm", "", "dialogWidth:20em; dialogHeight:12em; status:0; help:0");
...
{
if (oblog_bIsIE5){	
	//var arr= window.open(/EditTool/images/img.htm);
	var arr=showModalDialog("/EditTool/images/img.htm",window, "dialogWidth:26em; dialogHeight:20.5em; status:0; help:0");
	IframeID.focus();
	if (arr != null)
	{
		//content=oblog_Composition.document.body.innerHTML;
...
{
if (oblog_bIsIE5){		
	var arr=showModalDialog("/EditTool/images/link.htm",window, "dialogWidth:23em; dialogHeight:11em; status:0; help:0");
	IframeID.focus();
	if (arr != null)
	{		
		oblog_InsertSymbol(arr);
...
{
	var arr = showModalDialog("/EditTool/images/file.htm", "", "dialogWidth:23em; dialogHeight:11em; status:0; help:0");
