<%@ Page Language="C#" AutoEventWireup="true" Codebehind="admin_userlist.aspx.cs"
    Inherits="KeLin.WebSite.item.admin_userlist" %>
                                            ...
                                            <table id="tblManageRanks" class="tableBorder" cellspacing="1" cellpadding="3" border="0"
                                                ...
                                                <tr>
                                                    <td class="fh" colspan="4" >
                                                        ...
                                                        <asp:Button ID="bt_DoSearch" Width="60px" Text='查 询' runat="server" OnClick="bt_DoSearch_Click" CssClass="bt">
                                                        </asp:Button>
                                                       &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;
                                        ...
                                        <td colspan="4" valign="top" align="left">
                                            <asp:DataGrid ID="DataGrid1" runat="server" DataKeyField="classid" AllowSorting="True"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateColumn HeaderText="介绍" SortExpression="" ItemStyle-Width="350px" HeaderStyle-CssClass="column">
                                                        <ItemTemplate>
