<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Book_Search.aspx.cs" Inherits="KeLin.WebSite.CLASS.Book_Search" %><%@ Import namespace="KeLin.ClassManager.Tool" %><%
Response.Write(WapTool.showTop(this.GetLang("栏目搜索|栏目搜索|Search"), wmlVo));//显示头 
if(ver=="1"){
%>
<p>请输入关键字：<br/>
...
<anchor><go href="<%=http_start%>CLASS/book_list.aspx" method="get" accept-charset="utf-8">
...
<form id="form1" action="<%=http_start%>CLASS/book_list.aspx" method="get">
<div class="subtitle">栏目搜索</div>
<div class="content">
请输入关键字：<br/>
