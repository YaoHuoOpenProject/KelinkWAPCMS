<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="admin_userlistWAP.aspx.cs" Inherits="KeLin.WebSite.CLASS.admin_userlistWAP" %><%@ Import namespace="KeLin.ClassManager.Tool" %><%
...
if (ver == "1")
{
    ...
    strhtml.Append("<b>由于内容比较多，请用电脑IE浏览器访问WEB后台【系统管理】→【栏目名称内容】，比较直观，方便管理！</b><br/>");
