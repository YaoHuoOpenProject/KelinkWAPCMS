<%@ Page Language="C#" AutoEventWireup="true" Codebehind="admin_infolist.aspx.cs"
    Inherits="KeLin.WebSite.item.admin_infolist" %>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function DoDel(type) {
            ...
            if (window.confirm("请确认删除，否则选择取消?")) {
                ...
                if (type == 0) {
                    document.getElementById("CommandType").value = "DelTop";
                } else if (type == 1) {
                    document.getElementById("CommandType").value = "DelMid";
                } else if (type == 2) {
                    document.getElementById("CommandType").value = "DelDown";
                }
                                            ...
                                            <table id="tblManageRanks" class="tableBorder" cellspacing="1" cellpadding="3" border="0"
                                                ...
                                                <tr>
                                                    <td class="fh" colspan="4" >
                                                        ...
                                                        名称/介绍关键字：<asp:TextBox ID="TextBox2" runat="server" Columns="20" MaxLength="8" Width="100px"></asp:TextBox>
                                                    
                                                        <asp:Button ID="bt_DoSearch" Width="60" Text='查 询' runat="server" OnClick="bt_DoSearch_Click" CssClass="bt">
                                                        </asp:Button>
                                                        &nbsp;&nbsp;<br /><br />
                                                        <input id="Button4" name="" type="button" value=" 删除顶部内容 " onclick="DoDel(0)" class="bt"  />&nbsp;
                                                        <input id="Button1" name="" type="button" value=" 删除中间内容 " onclick="DoDel(1)" class="bt"   />&nbsp;
                                                        <input id="Button2" name="" type="button" value=" 删除低部内容 " onclick="DoDel(2)" class="bt"   />&nbsp;
                                                    </td>
                                                </tr>
                                        ...
                                        <td colspan="4" valign="top" align="left">
                                            <asp:DataGrid ID="DataGrid1" runat="server" DataKeyField="classid" AllowSorting="True"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateColumn HeaderText="网站ID" SortExpression="userid" ItemStyle-Width="60px" HeaderStyle-CssClass="column">
                                                        <ItemTemplate>
                                                    ...
                                                    <asp:TemplateColumn HeaderText="栏目名称" SortExpression="classname" ItemStyle-Width="120px" HeaderStyle-CssClass="column">
                                                        <ItemTemplate>
                                                            <%#DataBinder.Eval(Container.DataItem, "classname")%>
                                                        </ItemTemplate>
                                                    </asp:TemplateColumn>
                                                   
                                                    <asp:TemplateColumn HeaderText="顶部内容" SortExpression="" ItemStyle-Width="150px" HeaderStyle-CssClass="column">
                                                        <ItemTemplate>
                                                            <%#DataBinder.Eval(Container.DataItem, "introduce")%>
                                                        </ItemTemplate>
                                                    </asp:TemplateColumn>
                                                    <asp:TemplateColumn HeaderText="中间内容" SortExpression="" ItemStyle-Width="150px" HeaderStyle-CssClass="column">
                                                        <ItemTemplate>
                                                            <%#DataBinder.Eval(Container.DataItem, "siterowremark")%>
                                                        </ItemTemplate>
                                                    </asp:TemplateColumn>
                                                    <asp:TemplateColumn HeaderText="底部内容" SortExpression="" ItemStyle-Width="150px" HeaderStyle-CssClass="column">
                                                        <ItemTemplate>
                                                            <%#DataBinder.Eval(Container.DataItem, "sitedowntip")%>
                                                        </ItemTemplate>
                                                    </asp:TemplateColumn>
                                                    <asp:TemplateColumn HeaderText="时间" SortExpression="creatdate" ItemStyle-Width="120px" HeaderStyle-CssClass="column">
                                                        <ItemTemplate>
