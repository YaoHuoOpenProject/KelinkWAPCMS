<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Book_Search.aspx.cs" Inherits="KeLin.WebSite.article.Book_Search" %><%@ Import namespace="KeLin.ClassManager.Tool" %><%
Response.Write(WapTool.showTop(this.GetLang("文章搜索|文章搜索|Search"), wmlVo));//显示头 
...
strhtml.Append("<option value=\"title\">文章标题</option>");
strhtml.Append("<option value=\"author\">文章作者</option>");
strhtml.Append("<option value=\"makerid\">投稿上传者(输入会员ID)</option>");
strhtml.Append("<option value=\"days\">N天前(输入天数)</option>");
strhtml.Append("</select><br/>");
strhtml.Append("<anchor><go href=\""+this.http_start +"article/book_list.aspx\" method=\"get\" accept-charset=\"utf-8\">");
...
strhtml.Append("<form id=\"form1\" action=\""+this.http_start +"article/book_list.aspx\" method=\"get\">");
strhtml.Append("<div class=\"subtitle\">文章搜索</div>");
