<%@ Page Language="C#" AutoEventWireup="true" Codebehind="systemindex.aspx.cs" Inherits="KeLin.WebSite.article.systemindex" %>
                                                        ...
                                                        <td>
                                                            <asp:DataGrid ID="DataGrid1" runat="server" DataKeyField="id" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateColumn HeaderText="标题" ItemStyle-Width="450px" HeaderStyle-CssClass="column">
                                                                        <ItemTemplate>
                                                                    ...
                                                                    <asp:TemplateColumn HeaderText="作者" SortExpression="book_author" ItemStyle-Width="120px"
                                                                        HeaderStyle-CssClass="column">
                                                                        <ItemTemplate>
                                                                            <%#DataBinder.Eval(Container.DataItem, "book_author")%>
                                                                        </ItemTemplate>
                                                                    </asp:TemplateColumn>
                                                                    <asp:TemplateColumn HeaderText="出处" SortExpression="book_pub" ItemStyle-Width="80px"
                                                                        HeaderStyle-CssClass="column">
                                                                        <ItemTemplate>
                                                                            <%#DataBinder.Eval(Container.DataItem, "book_pub")%>
                                                                        </ItemTemplate>
                                                                    </asp:TemplateColumn>
                                                                    <asp:TemplateColumn HeaderText="录入人" SortExpression="username" ItemStyle-Width="40px"
                                                                        HeaderStyle-CssClass="column">
                                                                        <ItemTemplate>
