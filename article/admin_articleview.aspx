<%@ Page Language="C#" AutoEventWireup="true" Codebehind="admin_articleview.aspx.cs"
    Inherits="KeLin.WebSite.article.admin_articleview" %>
                                                    ...
                                                    <table class="tableBorder" id="Table1" cellspacing="1" cellpadding="3" width="100%">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="fh3a">
                                                                ...
                                                                <br /><br />附件图:<br />
                                                                                                                     <%# getShowPIC(DataBinder.Eval(Container.DataItem, "book_file").ToString(), DataBinder.Eval(Container.DataItem, "book_fileINFO").ToString())%>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </ItemTemplate>
                                                                    ...
                                                                    <tbody>
                                                                        ...
                                                                        <tr>
                                                                            <td class="fh3b" valign="top" align="left">
                                                                                <asp:TextBox ID="tb_rec" runat="server" Width="660px" Height="193px" TextMode="MultiLine">
                                                                                </asp:TextBox>
                                                                                <br>
