<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="user_WAPaddFileTXT.aspx.cs" Inherits="KeLin.WebSite.article.user_WAPaddFileTXT" %>
...
if (ver == "1")
{
    ...
    Response.Write("<a href=\"" + this.http_start + "article/user_wapaddfileTXT.aspx?action=class&amp;siteid=" + this.siteid + "&amp;classid=" + this.classid + "&amp;smalltypeid=" + this.smalltypeid + "&amp;sid=" + this.sid1 + "-2-" + this.cs + "-" + this.lang + "-" + this.myua + "-" + this.width + "\">" + this.GetLang("进入WAP2.0界面上传|进入WAP2.0界面上传|wap2.0 add upfile") + "</a><br/>");
    Response.Write("<a href=\"" + this.http_start + "article/book_list.aspx?siteid=" + this.siteid + "&amp;classid=" + this.classid + "&amp;smalltypeid=" + this.smalltypeid + "\">" + this.GetLang("返回列表|返回列表|Back to list") + "</a><br/>");
...
else //2.0界面
{
    ...
    Response.Write("<div class=\"subtitle\">" + this.GetLang("TXT上传投稿|TXT上传投稿|TXT上传投稿") + "|<a href=\"" + this.http_start + "article/user_wapadd.aspx?action=class&amp;siteid=" + this.siteid + "&amp;classid=" + this.classid + "&amp;smalltypeid=0\">直接投稿</a></div>");
    ...
    if (this.INFO == "OK")
    {
        ...
        Response.Write("<br/><a href=\"" + this.http_start + "article/book_list.aspx?siteid=" + this.siteid + "&amp;classid=" + this.classid + "&amp;smalltypeid=" + this.smalltypeid + "\">" + this.GetLang("返回|返回|Back to list") + "</a>");
    }
    ...
    Response.Write("<div class=\"tip\">一经采纳，送" + tomoney + "个币,送经验:" + toexpr + "个！</div>");

    Response.Write("<div class=\"content\">");
    //选多少个
    
    Response.Write("<form name=\"g1\" action=\"" + http_start + "article/user_wapaddfileTXT.aspx\" method=\"get\">");
    ...
    //选择栏目
    Response.Write("<form name=\"gt\" action=\"" + http_start + "article/user_wapaddfileTXT.aspx\" enctype=\"multipart/form-data\" method=\"post\">");
    ...
    Response.Write("<a href=\"" + this.http_start + "article/book_list.aspx?siteid=" + this.siteid + "&amp;classid=" + this.classid + "&amp;smalltypeid=" + this.smalltypeid + "\">" + this.GetLang("返回列表|返回列表|Back to list") + "</a>");
