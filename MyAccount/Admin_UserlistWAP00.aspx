<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="admin_userlistWAP00.aspx.cs" Inherits="KeLin.WebSite.myAccount.admin_userlistWAP00" %><%@ Import namespace="KeLin.ClassManager.Tool" %><%
Response.Write(WapTool.showTop(classVo.classname, wmlVo));//显示头                                                                                                                                                                       
if (ver == "1")
{
    strhtml.Append("<p align=\"left\">");
    strhtml.Append("网站ID:<input type=\"text\" name=\"tositeid" + r + "\" value=\"" + tositeid + "\" size=\"8\"/><br/>");
    ...
    strhtml.Append("<anchor><go href=\"" + http_start + "myaccount/admin_userlistWAP00.aspx\" method=\"get\" accept-charset=\"utf-8\">");
    ...
    {
        strhtml.Append("<a href=\"" + this.http_start + "myaccount/admin_userlistWAP00.aspx?siteid=" + this.siteid + "&amp;classid=" + this.classid + "&amp;totype=&amp;tositeid=" + this.tositeid + "&amp;touserid=" + this.touserid + "\">所有</a>/");
    }
    if (this.totype == "1")
    {
        strhtml.Append("收入/");
    ...
    {
        strhtml.Append("<a href=\"" + this.http_start + "myaccount/admin_userlistWAP00.aspx?siteid=" + this.siteid + "&amp;classid=" + this.classid + "&amp;totype=1&amp;tositeid=" + this.tositeid + "&amp;touserid=" + this.touserid + "\">收入</a>/");
    }
    if (this.totype == "0")
    {
        strhtml.Append("支出");
    ...
    {
        strhtml.Append("<a href=\"" + this.http_start + "myaccount/admin_userlistWAP00.aspx?siteid=" + this.siteid + "&amp;classid=" + this.classid + "&amp;totype=0&amp;tositeid=" + this.tositeid + "&amp;touserid=" + this.touserid + "\">支出</a>");
    }
    ...
    for (int i = 0; (listVo != null && i < listVo.Count); i++)
    {
        ...
        strhtml.Append("<br/>网站ID:" + listVo[i].siteid + "/会员ID:" + listVo[i].userid);
        strhtml.Append("<br/>[" + string.Format("{0:MM-dd HH:mm}", listVo[i].addTime) + "<a href=\"" + this.http_start + "myaccount/admin_wapdel00.aspx?siteid=" + siteid + "&amp;classid=" + classid + "&amp;id=" + listVo[i].id + "&amp;totype=" + this.totype + "&amp;starttime=" + this.starttime + "&amp;endtime=" + this.endtime + "&amp;key=" + HttpUtility.UrlEncode(this.key) + "" + "\">删除</a>]");
...
else //2.0界面
{
    ...
    strhtml.Append("<div class=\"title\">记帐管理</div>");
        ...
        strhtml.Append("<form id=\"form1\" action=\"" + http_start + "myaccount/admin_userlistWAP00.aspx\" method=\"get\">");
