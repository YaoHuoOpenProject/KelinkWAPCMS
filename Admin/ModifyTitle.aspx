<%@ Page Language="C#" AutoEventWireup="true" validateRequest="false" CodeBehind="ModifyTitle.aspx.cs" Inherits="KeLin.WebSite.admin.ModifyTitle" %>
<html>
<head>
<title>顶部信息</title>
...
<%Response.End();
    ...
    <form name="form1" action="modifytitle.aspx" method="post">
