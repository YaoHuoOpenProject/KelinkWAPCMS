<%@ Page Language="C#" AutoEventWireup="true" validateRequest="false" CodeBehind="addRowInfo.aspx.cs" Inherits="KeLin.WebSite.admin.addRowInfo" %>
<html>
<head>
<title>插入信息</title>
...
<%Response.End();
  }%>       <form name="form1" action="addrowinfo.aspx" method ="post">
            ...
            <tr>
              ...
              <td width="100%" background="/NetImages/main_title_02.gif"><table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0">
                ...
                <td width="98%" height="24" valign="middle">
                	&nbsp;栏目ID为<font color="red"><b><%=classid%></b></font>的栏目前插入信息
