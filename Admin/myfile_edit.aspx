                                                                ...
                                                                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" height="162">
                                                                    ...
                                                                    <tr class="tdbg">
                                                                        <td height="56" align="right" class="TD1" width="100">
																			...
																			<br>
																			<font color="#FF0000">
																			用<a href="javascript:addubb('[myfile]');">[myfile]</a>&nbsp;<br>
																			或用UBB链接&nbsp;</font></strong><br>
                                                                            <br>
                                                                            <input type="checkbox" id="chkbr" name="chkbr" value="ON" onclick="CheckS(this.form)" checked >显示[br]
                                                                        </td>
