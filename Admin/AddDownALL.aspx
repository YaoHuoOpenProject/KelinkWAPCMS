<%@ Page Language="C#" AutoEventWireup="true" validateRequest="false" CodeBehind="AddDownALL.aspx.cs" Inherits="KeLin.WebSite.admin.AddDownALL" %>
<html>
<head>
<title>全局底部信息</title>
...
<%Response.End();
  }%>    <form name="form1" action="AddDownALL.aspx" method="post">
                                                                ...
                                                                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" height="162">
                                                                    ...
                                                                    <tr class="tdbg">
                                                                        <td height="56" align="right" class="TD1" width="100">
                                                                            &nbsp;全局底部信息<strong>：</strong>&nbsp;<br>
                                                                            (可放栏目导航等)
                                                                            <br>
                                                                            <input type="checkbox" name="chkbr" value="ON" onclick="CheckS(this.form)"  checked>显示[br]&nbsp;&nbsp;                                                                         </td>
                                                                    ...
                                                                    <tr align="center" class="tdbg">
                                                                        ...
                                                                        <input name="view" type="button" onclick ="OpenWin()" id="view" value=" 预 览 "   class="bt">&nbsp;&nbsp;
                                                                            <input name="Action" type="hidden" id="Action" value="add"><input name="Submit" type="submit"
                                                                                id="Submit" value=" 保 存 " style="cursor: hand" class="bt"></td>
                                                                    </tr>
                                                                    <tr>
