<%@ Page Language="C#" AutoEventWireup="true" Codebehind="guestlist.aspx.cs" Inherits="KeLin.WebSite.bbs.guestlist" %>
                                            ...
                                            <table id="tblManageRanks" class="tableBorder" cellspacing="1" cellpadding="3" border="0"
                                                ...
                                                <tr>
                                                    ...
                                                    审核状态：
                                                        ...
                                                        贴子ID：<asp:TextBox ID="TextBox4" runat="server" Width="64px"></asp:TextBox>标题/内容关键字：<asp:TextBox
                                        ...
                                        <td colspan="4" valign="top" align="left">
                                            <asp:DataGrid ID="DataGrid1" runat="server" DataKeyField="id" AllowSorting="True"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateColumn HeaderText="贴子ID" SortExpression="bookid" ItemStyle-Width="50px" HeaderStyle-CssClass="column">
                                                        <ItemTemplate>
                                                    ...
                                                    <asp:TemplateColumn HeaderText="回复内容" ItemStyle-Width="250px" HeaderStyle-CssClass="column">
                                                        <ItemTemplate>
