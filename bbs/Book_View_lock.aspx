<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Book_View_lock.aspx.cs" Inherits="KeLin.WebSite.bbs.Book_View_lock" %><%@ Import namespace="KeLin.ClassManager.Tool" %>
<%
...
else //2.0界面
{
    ...
    strhtml.Append("<div class=\"subtitle\">" + this.GetLang(lang1 + "锁定贴子|" + lang2 + "锁定貼子|" + lang3 + " Lock Notes") + "</div>");
    strhtml.Append(this.ERROR);
