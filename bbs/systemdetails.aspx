<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" Codebehind="systemdetails.aspx.cs"
    Inherits="KeLin.WebSite.bbs.systemdetails" %>
                        ...
                        <table class="TABLE6" cellspacing="1" cellpadding="3" width="100%">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="fh3">
                                        <asp:TextBox ID="tb_author" runat="server" Width="146px" ReadOnly="True"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="f" style="width: 16%">
                                        <font face="宋体">栏目：</font>
                                    </td>
                                    <td class="fh3">
                                        <font face="宋体">
