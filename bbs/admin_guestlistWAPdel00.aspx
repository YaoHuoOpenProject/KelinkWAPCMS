<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="admin_guestlistWAPdel00.aspx.cs" Inherits="KeLin.WebSite.bbs.admin_guestlistWAPdel00" %>
...
if (ver == "1")
{
    ...
    if (this.INFO == "")
    {
        Response.Write("<a href=\"" + this.http_start + "bbs/admin_guestlistWAPdel00.aspx?action=godel&amp;id=" + this.id + "&amp;siteid=" + this.siteid + "&amp;classid=" + this.classid + "&amp;tositeid=" + this.tositeid + "&amp;page=" + this.page + "\">" + this.GetLang("确定要删除此条记录吗？是！|確定要刪除此條記錄嗎？是！|Are you sure? YES") + "</a><br/>");
    ...
    Response.Write("<br/><a href=\"" + this.http_start + "bbs/admin_guestlistWAP00.aspx?siteid=" + this.siteid + "&amp;classid=" + this.classid + "&amp;tositeid=" + this.tositeid + "&amp;page=" + this.page + "\">" + this.GetLang("返回列表|返回列表|Back to list") + "</a>");
