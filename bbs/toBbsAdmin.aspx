<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="toBbsAdmin.aspx.cs" Inherits="KeLin.WebSite.bbs.toBbsAdmin" %><%@ Import namespace="KeLin.ClassManager.Tool" %><%
StringBuilder strhtml=new StringBuilder ();
Response.Write(WapTool.showTop(this.GetLang("版主设置|版主設置|Edition rules set"), wmlVo));//显示头                                                                                                                                                                       
if (ver == "1")
{
    strhtml.Append("<p>");
    ...
    strhtml.Append(this.GetLang("版主|版主|class admin") + ":<br/>");
    strhtml.Append("<input type=\"text\" name=\"admin" + r + "\" value=\"" + classVo.adminusername + "\"/><br/>");
    strhtml.Append("请输入会员ID，多个用|连接。<br/>");
    
    strhtml.Append("<anchor><go href=\""+http_start+"bbs/toBbsAdmin.aspx\" method=\"post\" accept-charset=\"utf-8\">");
    strhtml.Append("<postfield name=\"action\" value=\"gomod\"/>");    
    strhtml.Append("<postfield name=\"classid\" value=\""+classid+"\"/>");
    strhtml.Append("<postfield name=\"siteid\" value=\""+siteid+"\"/>");
    strhtml.Append("<postfield name=\"page\" value=\""+page+"\"/>");
    strhtml.Append("<postfield name=\"admin\" value=\"$(admin" + r + ")\"/>");      
...
else //2.0界面
{
    ...
    strhtml.Append("<form name=\"go\" action=\"" + this.http_start + "bbs/toBbsAdmin.aspx\" method=\"post\">");
    strhtml.Append(this.GetLang("版主|版主|版主") + ":<br/>");
    strhtml.Append("<input type=\"text\" name=\"admin\" value=\"" + classVo.adminusername + "\"/><br/>");
    strhtml.Append("请输入会员ID，多个用|连接。<br/>");
