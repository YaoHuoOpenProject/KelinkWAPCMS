...
{
    strhtml.Append("<div class=\"subtitle\">发表投票帖</div>");
    strhtml.Append(this.ERROR);
    if (this.INFO == "OK")
    {
    ...
    if (this.INFO != "OK")
    {
        ...
        strhtml.Append(this.GetLang("选择投票项|选择投票项|Select vote") + " <input type=\"number\" name=\"num\" style=\"width:30px;text-align:center\" value=\"" + this.num + "\" size=\"2\"/>");
        ...
        {            
            ...
            strhtml.Append("<input type=\"text\" minlength=\"1\" required=\"required\" name=\"vote\" size=\"40\"  value=\"\"/><br/>");
        }
