...
Response.Write(WapTool.showTop(classVo.classname + "专题", wmlVo));//显示头                                                                                                                                                                       
if (ver == "1")
{
    ...
    Response.Write("<a href=\"" + this.http_start + "bbs/book_list.aspx?siteid=" + siteid + "&amp;classid=" + this.classid + "&amp;page=" + this.page + "" + "\">返回上级</a> ");
