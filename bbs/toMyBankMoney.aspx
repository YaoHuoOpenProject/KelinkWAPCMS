...
Response.Write(WapTool.showTop(this.GetLang("银行存取款|银行存取款|bank"), wmlVo));//显示头                                                                                                                                                                       
if (ver == "1")
{
    strhtml.Append("<p>");
...
else //2.0界面
{
   ...
   strhtml.Append("<div class=\"tip\">");
    ...
    strhtml.Append("</div>");
    strhtml.Append("<div class=\"subtitle\">" + this.GetLang("银行存取款|银行存取款|bank") + "</div>");
    ...
    if (this.INFO != "OK")
    {
        ...
        if (this.type != "1")
        {
            strhtml.Append("<br/><a class=\"urlbtn\" href=\"" + this.http_start + "bbs/tomybankmoney.aspx?type=1&amp;siteid=" + this.siteid + "&amp;backurl=" + HttpUtility.UrlEncode(backurl) + "\">" + this.GetLang("取款操作|取款操作|取款操作") + "</a>");
        }
        else
        {
            strhtml.Append("<br/><a class=\"urlbtn\" href=\"" + this.http_start + "bbs/tomybankmoney.aspx?type=0&amp;siteid=" + this.siteid + "&amp;backurl=" + HttpUtility.UrlEncode(backurl) + "\">" + this.GetLang("存款操作|存款操作|存款操作") + "</a>");
