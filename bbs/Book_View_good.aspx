<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Book_View_good.aspx.cs" Inherits="KeLin.WebSite.bbs.Book_View_good" %><%@ Import namespace="KeLin.ClassManager.Tool" %>
<%
...
else //2.0界面
{
    ...
    strhtml.Append("<div class=\"subtitle\">" + this.GetLang(lang1 + "加精贴子|" + lang2 + "加精貼子|" + lang3 + " Top Notes") + "</div>");
    strhtml.Append(this.ERROR);
