...
else //2.0界面
{
    ...
    strhtml.Append("<a  class=\"btSelect\" href=\"" + this.http_start + "bbs/book_view_addfile.aspx?action=class&amp;siteid=" + this.siteid + "&amp;classid=" + this.classid + "&amp;page=" + this.page + "\">本地上传资贴</a> ");
    strhtml.Append("<a href=\"" + this.http_start + "bbs/book_view_addURL.aspx?action=class&amp;siteid=" + this.siteid + "&amp;classid=" + this.classid + "&amp;page=" + this.page + "\">发外站资源贴</a> ");
