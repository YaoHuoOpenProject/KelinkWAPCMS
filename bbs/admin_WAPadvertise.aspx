<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="admin_WAPadvertise.aspx.cs" Inherits="KeLin.WebSite.bbs.admin_WAPadvertise" %>
...
if (ver == "1")
{
    ...
    if (this.INFO == "OK")
    {
        ...
        Response.Write("</b><br/>");
        Response.Write("<a href=\"" + this.http_start + "bbs/admin_userlistWAP.aspx?siteid=" + this.siteid + "&amp;classid=" + this.classid + "&amp;page=" + this.page + "\">" + this.GetLang("返回列表|返回列表|Back to list") + "</a><br/>");
    }
    ...
    Response.Write("<anchor><go href=\"" + http_start + "bbs/admin_WAPadvertise.aspx\" method=\"post\" accept-charset=\"utf-8\">");
    ...
    Response.Write("<br/><a href=\"" + this.http_start + "bbs/admin_userlistWAP.aspx?siteid=" + this.siteid + "&amp;classid=" + this.classid + "&amp;page=" + this.page + "\">" + this.GetLang("返回列表|返回列表|Back to list") + "</a>");
...
else //2.0界面
{
    ...
    Response.Write("<form name=\"go\" action=\"" + this.http_start + "bbs/admin_WAPadvertise.aspx\" method=\"post\">");
    Response.Write(this.GetLang("二级列表顶部|二級列表頂部|Two top of the list") + "：<br/>");
    Response.Write("<textarea name=\"secondShowTop\" rows=\"5\" style=\"width:99%\">" + adVo.secondShowTop + "</textarea><br/>"); 
    Response.Write(this.GetLang("二级列表底部|二級列表底部|Two down of the list") + "：<br/>");
    Response.Write("<textarea name=\"secondShowDown\" rows=\"5\" style=\"width:99%\">" + adVo.secondShowDown + "</textarea><br/>"); 
    Response.Write(this.GetLang("三级内容顶部|三級內容頂部|Three top of the list") + "：<br/>");
    Response.Write("<textarea name=\"threeShowTop\" rows=\"5\" style=\"width:99%\">" + adVo.threeShowTop + "</textarea><br/>"); 
    Response.Write(this.GetLang("三级内容底部|三級內容底部|Three down of the list") + "：<br/>");
    Response.Write("<textarea name=\"threeShowDown\" rows=\"5\" style=\"width:99%\">" + adVo.threeShowDown + "</textarea><br/>");
    ...
    Response.Write("<a href=\"" + this.http_start + "bbs/admin_userlistWAP.aspx?siteid=" + this.siteid + "&amp;classid=" + this.classid + "&amp;page=" + this.page + "\">" + this.GetLang("返回列表|返回列表|Back to list") + "</a>");
