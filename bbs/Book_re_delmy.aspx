<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Book_re_delmy.aspx.cs" Inherits="KeLin.WebSite.bbs.Book_re_delmy" %><%@ Import namespace="KeLin.ClassManager.Tool" %><%
...
if (ver == "1")
{
    ...
    if (this.INFO != "OK")
    {
        //Response.Write("<a href=\"" + this.http_start + "bbs/book_re_delmy.aspx?action=godel&amp;reid=" + this.reid + "&amp;touserid=" + this.touserid + "&amp;siteid=" + this.siteid + "&amp;classid=" + this.classid + "&amp;lpage=" + this.lpage + "&amp;page=" + this.page + "&amp;ot=" + this.ot + "\">" + this.GetLang("确定要清空TA的回复吗？是！|確定要清空TA的回複嗎？是！|Are you sure? YES") + "</a><br/>");
        ...
        Response.Write("<anchor><go href=\"" + http_start + "bbs/book_re_delmy.aspx\" method=\"post\" accept-charset=\"utf-8\">");
        ...
        Response.Write("</go>1.清空TA的所有回贴（不清币和经验）</anchor> <br/>");
        ...
        Response.Write("<postfield name=\"sid\" value=\"" + sid + "\" />");
        Response.Write("</go>2.清空TA的所有回贴（清币）</anchor> <br/>");
        Response.Write("<anchor><go href=\"" + http_start + "bbs/book_list_delmy.aspx\" method=\"post\" accept-charset=\"utf-8\">");
        Response.Write("<postfield name=\"action\" value=\"godel\" />");
        Response.Write("<postfield name=\"siteid\" value=\"" + siteid + "\" />");
        Response.Write("<postfield name=\"classid\" value=\"" + classid + "\" />");
        ...
        Response.Write("<postfield name=\"sid\" value=\"" + sid + "\" />");
        Response.Write("</go>3.清空TA的所有回贴（清币+清经验值）</anchor> <br/>");
    ...
    Response.Write("<br/><a href=\"" + this.http_start + "bbs/book_re_my.aspx?action=class&amp;siteid=" + this.siteid + "&amp;classid=" + this.classid + "&amp;lpage="+this.lpage+"&amp;page=" + this.page + "&amp;ot="+this.ot+"&amp;touserid="+this.touserid+"\">" + this.GetLang("返回列表|返回列表|Back to list") + "</a>");
...
else //2.0界面
{
    ...
    if (this.INFO != "OK")
    {
        ...
        //Response.Write("<a href=\"" + this.http_start + "bbs/book_re_delmy.aspx?action=godel&amp;reid=" + this.reid + "&amp;touserid=" + this.touserid + "&amp;siteid=" + this.siteid + "&amp;classid=" + this.classid + "&amp;lpage=" + this.lpage + "&amp;page=" + this.page + "&amp;ot=" + this.ot + "\">" + this.GetLang("确定要清空此回复吗？是！|確定要刪除此回複嗎？是！|Are you sure? YES") + "</a><br/>");
        if (this.INFO == "PASSERROR")
        {
            Response.Write("<b>*" + this.GetLang("密码错误！|密码错误！|NO PASS !") + "</b><br/>");
