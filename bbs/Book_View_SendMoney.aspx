...
Response.Write(WapTool.showTop(this.GetLang("发表派币贴|发表派币贴|add subject"), wmlVo));//显示头                                                                                                                                                                       
if (ver == "1")
{
    strhtml.Append("<p>");
    ...
    if (this.INFO != "OK")
    {
        ...
        strhtml.Append("系统设置最大礼金为:" + maxs + "<br/>我当前" + WapTool.GetSiteMoneyName(siteVo.sitemoneyname, this.lang) + ":" + userVo.money + "<br/>");

        strhtml.Append("派总礼金:<input type=\"text\" format=\"*N\" name=\"freemoney\" value=\"" + freemoney + "\" size=\"4\"/><br/>");

        strhtml.Append("派币楼层:<br/><input type=\"text\"  name=\"freerule1\" value=\"" + freerule1 + "\" /><br/>");
        strhtml.Append("(例:1|2|4|8|15)<br/>");
        strhtml.Append("派币值:<br/><input type=\"text\"  name=\"freerule2\" value=\"" + freerule2 + "\"  /><br/>");
        strhtml.Append("(例:200|100|50|30|20)<br/>");
       
        strhtml.Append("如果每人每日币一次，只需要：派币楼层录入 0 ，派币值录入每人得到币值：如100<br/>");
        ...
        strhtml.Append("</go>" + this.GetLang("发表派币贴|发表派币贴|submit new subject") + "</anchor><br/><br/>");
    }

    strhtml.Append("<a href=\"" + this.http_start + "bbs/book_view_add.aspx?action=class&amp;classid=" + this.classid + "&amp;siteid=" + this.siteid + "\">发表普通贴</a><br/>");
...
else //2.0界面
{
    ...
    if (this.INFO != "OK")
    {
        ...
        strhtml.Append("派币楼层:<br/><input type=\"text\" class=\"txt\" name=\"freerule1\" value=\"" + freerule1 + "\"/><br/>");
        strhtml.Append("(例:1|2|4|8|15)<br/>");
        strhtml.Append("派币值:<br/><input type=\"text\" class=\"txt\"  name=\"freerule2\" value=\"" + freerule2 + "\"  /><br/>");
        strhtml.Append("(例:200|100|50|30|20)<br/>");

        strhtml.Append("如果每人每日派币，只需要：派币楼层录入 0 ，派币值录入每层得到币值：如100<br/>");
        ...
        strhtml.Append("<input type=\"submit\" name=\"g\" class=\"btn\" value=\"" + this.GetLang("发表派币贴|发表派币贴|submit new subject") + "\"/>");
    ...
    strhtml.Append("<a href=\"" + this.http_start + "bbs/book_view_add.aspx?action=class&amp;classid=" + this.classid + "&amp;siteid=" + this.siteid + "\">发表普通贴</a> ");
