<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Book_Search.aspx.cs" Inherits="KeLin.WebSite.card.Book_Search" %><%@ Import namespace="KeLin.ClassManager.Tool" %><%
Response.Write(WapTool.showTop(this.GetLang("名片搜索|名片搜索|Search"), wmlVo));//显示头 
if(ver=="1"){
%>
<p>请输入关键字：<br/>
...
<option value="title">公司名或产品信息</option>
<option value="author">姓名</option>
<option value="days">N天前(输入天数)</option>
</select><br/>
<anchor><go href="<%=http_start%>card/book_list.aspx" method="get" accept-charset="utf-8">
...
<form id="form1" action="<%=http_start%>card/book_list.aspx" method="get">
<div class="subtitle">名片搜索</div>
<div class="content">
请输入关键字：<br/>
