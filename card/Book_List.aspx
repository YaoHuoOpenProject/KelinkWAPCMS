<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Book_List.aspx.cs" Inherits="KeLin.WebSite.card.Book_List" %><%@ Import namespace="KeLin.ClassManager.Tool" %><%
...
if (ver == "1")
{
    ...
    for (int i = 0; (listVo != null && i < listVo.Count); i++)
    {
        ...
        strhtml.Append(index + ".<a href=\"" + http_start + "card/book_view.aspx?siteid=" + siteid + "&amp;classid=" + this.classid + "&amp;touserid=" + listVo[i].userid + "&amp;lpage=" + CurrentPage + "&amp;backurl=" + HttpUtility.UrlEncode(this.GetUrlQueryString()) + "" + "\">" + listVo[i].realname + "[" + listVo[i].ltd + "]</a><br/>");
    }
    if (listVo == null)
    {
    ...
    if (action == "search")
    {
        strhtml.Append("<a href=\"" + this.http_start + "card/book_search.aspx?siteid=" + siteid + "&amp;classid=" + classid + "" + "\">返回搜索</a> ");
    }
...
else //2.0界面
{
    ...
    for (int i = 0; (listVo != null && i < listVo.Count); i++)
    {
        ...
        strhtml.Append(index + ".<a href=\"" + http_start + "card/book_view.aspx?siteid=" + siteid + "&amp;classid=" + this.classid + "&amp;touserid=" + listVo[i].userid + "&amp;lpage=" + CurrentPage + "&amp;backurl="+HttpUtility.UrlEncode(this.GetUrlQueryString())+"" + "\">" + listVo[i].realname + "[" + listVo[i].ltd + "]</a></div>");
    }
