<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="admin_WAPModifyadd.aspx.cs" Inherits="KeLin.WebSite.paimai.admin_WAPModifyadd" %>
...
if (ver == "1")
{
    ...
    Response.Write("<a href=\"" + this.http_start + "paimai/admin_wapmodifyadd.aspx?action=class&amp;siteid=" + this.siteid + "&amp;classid=" + this.classid + "&amp;smalltypeid=" + this.smalltypeid + "&amp;sid=" + this.sid1 + "-2-" + this.cs + "-" + this.lang + "-" + this.myua + "-" + this.width + "\">" + this.GetLang("进入WAP2.0界面续传|进入WAP2.0界面续传|wap2.0 add upfile") + "</a><br/>");
...
else //2.0界面
{
    ...
    if (this.INFO == "OK")
    {
        ...
        Response.Write("<br/><a href=\"" + this.http_start + "paimai/book_view.aspx?siteid=" + this.siteid + "&amp;classid=" + this.classid + "&amp;id=" + this.id + "\">" + this.GetLang("查看效果|查看效果|see") + "</a>");
    }
    ...
    Response.Write("<form name=\"g1\" action=\"" + http_start + "paimai/admin_WAPModifyadd.aspx\" method=\"get\">");
    ...
    //选择栏目
    Response.Write("<form name=\"gt\" action=\"" + http_start + "paimai/admin_WAPModifyadd.aspx\" enctype=\"multipart/form-data\" method=\"post\">");
