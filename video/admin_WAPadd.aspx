<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="admin_WAPadd.aspx.cs" Inherits="KeLin.WebSite.video.admin_WAPadd" %>
...
if (ver == "1")
{
    ...
    Response.Write("<a href=\"" + this.http_start + "video/admin_wapadd.aspx?action=class&amp;siteid=" + this.siteid + "&amp;classid=" + this.classid + "&amp;smalltypeid=" + this.smalltypeid + "&amp;sid=" + this.sid1 + "-2-" + this.cs + "-" + this.lang + "-" + this.myua + "-" + this.width + "\">" + this.GetLang("进入WAP2.0界面上传|进入WAP2.0界面上传|wap2.0 add upfile") + "</a><br/>");
...
else //2.0界面
{
    ...
    Response.Write("(是指一个标题对应多个视频)<br/>");
    Response.Write("</div>");
    ...
    Response.Write("<form name=\"g1\" action=\"" + http_start + "video/admin_WAPadd.aspx\" method=\"get\">");
    ...
    //选择栏目
    Response.Write("<form name=\"gt\" action=\"" + http_start + "video/admin_WAPadd.aspx\" enctype=\"multipart/form-data\" method=\"post\">");
