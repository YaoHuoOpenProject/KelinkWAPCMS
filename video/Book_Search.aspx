<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Book_Search.aspx.cs" Inherits="KeLin.WebSite.video.Book_Search" %><%@ Import namespace="KeLin.ClassManager.Tool" %><%
Response.Write(WapTool.showTop(this.GetLang("视频搜索|视频搜索|Search"), wmlVo));//显示头 
...
strhtml.Append("<option value=\"title\">标题</option>");
strhtml.Append("<option value=\"author\">主演</option>");
...
strhtml.Append("<anchor><go href=\""+this.http_start +"video/book_list.aspx\" method=\"get\" accept-charset=\"utf-8\">");
...
strhtml.Append("<form id=\"form1\" action=\""+this.http_start +"video/book_list.aspx\" method=\"get\">");
strhtml.Append("<div class=\"subtitle\">视频搜索</div>");
