<%@ Page Language="C#" AutoEventWireup="true" Codebehind="addUser.aspx.cs" Inherits="KeLin.WebSite.video.addUser" %>
            ...
            <tbody>
                ...
                <tr>
                    <td valign="top" align="left">                        
                        <table class="tableBorder" cellspacing="1" cellpadding="3" width="100%" class="TABLE6">
                            <tbody>
                                <tr>
                                    <td class="column" colspan="4">
                                        <font face="宋体">视频内容 </font>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td colspan="3" class="fh3">
                                        <asp:TextBox ID="tb_money" runat="server" Width="82px">0</asp:TextBox>
                                        ( 0 表示不需要)</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td colspan="3" class="fh3">
                                        <FTB:FreeTextBox ID="FreeTextBox1" runat="server" ButtonPath="../images/ftb/office2003/" ImageGalleryPath="video/upload"
                                            Height="200px">
                                        </FTB:FreeTextBox>
                                    </td>
                                </tr>
