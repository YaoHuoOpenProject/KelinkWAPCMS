<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="admin_WAPadvertise.aspx.cs" Inherits="KeLin.WebSite.link.admin_WAPadvertise" %><%@ Import namespace="KeLin.ClassManager.Tool" %><%
...
if (ver == "1")
{
    ...
    Response.Write("<anchor><go href=\""+http_start+"link/admin_WAPadvertise.aspx\" method=\"post\" accept-charset=\"utf-8\">");
...
else //2.0界面
{
    ...
    Response.Write("<form name=\"go\" action=\""+this.http_start+"link/admin_WAPadvertise.aspx\" method=\"post\">");
    Response.Write(this.GetLang("二级列表顶部|二級列表頂部|Two top of the list") + "*:<br/>");
