<%@ Page Language="C#" AutoEventWireup="true" Codebehind="userlist.aspx.cs" Inherits="KeLin.WebSite.link.userlist" %>
                                                ...
                                                <table id="tblManageRanks" class="tableBorder" cellspacing="1" cellpadding="3" border="0"
                                                    ...
                                                    <tr>
                                                        <td class="fh" colspan="4">
                                                            ...
                                                            <asp:DropDownList ID="DropDownList1" runat="server">
                                                                ...
                                                                标题ID：<asp:TextBox ID="TextBox1" runat="server" Columns="20" MaxLength="8"
                                                                Width="64px"></asp:TextBox>
                                                            ...
                                                            <input id="Button13" name="" type="button" value="重 置" onclick="window.location.href='userlist.aspx'" Class="bt" />
                                                    ...
                                                    <tr>
                                                        <td class="fh" colspan="4">
                                                            ...
                                                            <input id="Button12" name="" type="button" value=" 配 置 " onclick="window.open('/link/ClassConfigAll.aspx?action=class&siteid=<%=base.SiteId %>&classid=<%=this.classid %>&page=&sid=<%=base.SID %>');" class="bt"/>
                                                           <input id="Button7" name="" type="button" value=" 审 核 " onclick="DoCheck()" class="bt"/>
                                                        <input id="Button8" name="" type="button" value="取消审核" onclick="DoUnCheck()" class="bt"/>
                                                            <input id="Button11" name="" type="button" value="新 增" onclick="window.open('/link/admin_WAPadd.aspx?action=class&siteid=<%=base.SiteId %>&classid=<%=this.classid %>&page=&sid=<%=base.SID %>');" Class="bt" />
                                                            ...
                                                            <input id="Button14" name="" type="button" value="自定义条件删除" onclick="window.open('/link/admin_wapdel_strwhere.aspx?action=class&siteid=<%=base.SiteId %>&classid=<%=this.classid %>&page=&sid=<%=base.SID %>');" class="bt"/>
                                            ...
                                            <td colspan="4" valign="top" align="left">
                                                <asp:DataGrid ID="DataGrid1" runat="server" DataKeyField="id" AllowSorting="True"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateColumn HeaderText="状态" SortExpression="ishidden" ItemStyle-HorizontalAlign="Center" HeaderStyle-CssClass="column"
                                                            ItemStyle-Width="40px">
                                                            <ItemTemplate>
                                                                <img src="/NetImages/<%#DataBinder.Eval(Container.DataItem, "ishidden")%>.gif" alt="审核状态" />
                                                            </ItemTemplate>
                                                        </asp:TemplateColumn>
                                                        <asp:TemplateColumn HeaderText="栏目ID" SortExpression="book_classid" ItemStyle-Width="50px" HeaderStyle-CssClass="column">
                                                            <ItemTemplate>
                                                            <input type ="hidden" id="classidtemp" name ="classidtemp" value ="<%#DataBinder.Eval(Container.DataItem,"book_classid") %>" />
                                                         ...
                                                         <asp:TemplateColumn HeaderText="WAP" HeaderStyle-CssClass="column" ItemStyle-Width="40px">
                                                            <ItemTemplate>
                                                                <a href="book_view.aspx?siteid=<%#DataBinder.Eval(Container.DataItem,"userid") %>&classid=<%#DataBinder.Eval(Container.DataItem,"book_classid") %>&id=<%#DataBinder.Eval(Container.DataItem,"id") %>&sid=<%=base.SID %>"
                                                                    target="_blank" title="查看文章及回复">
                                                                    查看
                                                                </a>
                                                               <br /> ID:<%#DataBinder.Eval(Container.DataItem,"id") %>
                                                            </ItemTemplate>
                                                        </asp:TemplateColumn>
                                                        ...
                                                        <asp:TemplateColumn HeaderText="提交者" SortExpression="book_author"  HeaderStyle-CssClass="column">
                                                            <ItemTemplate>
                                                      ...
                                                      给对方查询地址：<br />
                                                            <input type="text" value="http://<%=base.GetMyDomain() %>/link/searchlist.aspx?id=<%#DataBinder.Eval(Container.DataItem, "id")%>" style="width:200px"/>
                                                      
                                                      
                                                        指定跳转地址：<br />
                                                     
                                                            <input type="text" value="<%#DataBinder.Eval(Container.DataItem, "redirectURL")%>" style="width:200px"/>
                                                        </ItemTemplate>
                                                    </asp:TemplateColumn>
                                                        
                                                        <asp:TemplateColumn HeaderText="点击UV" SortExpression="book_click"  HeaderStyle-CssClass="column">
                                                            <ItemTemplate>
                                                        ...
                                                        <asp:TemplateColumn HeaderText="返回点击" SortExpression="book_re"  HeaderStyle-CssClass="column">
                                                            ...
                                                            今日IP:<%#DataBinder.Eval(Container.DataItem, "IP")%><br />
                                                                ...
                                                                【<a href="#" onclick ="javascript:window.open('/shop/orderlist.aspx?fromlinkid=<%#DataBinder.Eval(Container.DataItem, "id")%>');">推荐商店订单明细<a />】<br />
                                                                【<a href="#" onclick ="javascript:window.open('/FormEdit/userlist01_Data.aspx?fromlinkid=<%#DataBinder.Eval(Container.DataItem, "id")%>');">推荐自定义表单明细<a />】
