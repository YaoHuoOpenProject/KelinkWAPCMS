<%@ Page Language="C#" AutoEventWireup="true" Codebehind="admin_userlist.aspx.cs"
    Inherits="KeLin.WebSite.link.admin_userlist" %>

<%@ Register Assembly="AspNetPager" Namespace="Wuqi.Webdiyer" TagPrefix="webdiyer" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>内容审核--友情链接内容</title>
                                          ...
                                          <table id="tblManageRanks" class="tableBorder" cellspacing="1" cellpadding="3" border="0"
                                                ...
                                                <tr>
                                                    <td class="fh" colspan="2" style="width: 100%">
                                                        ...
                                                        </asp:DropDownList>网站ID：<asp:TextBox ID="TextBox3" runat="server" Width="64px"></asp:TextBox>
                                                        栏目ID：<asp:TextBox ID="TextBox1" runat="server" Columns="20" MaxLength="8" Width="64px"></asp:TextBox>
                                                        标题/内容关键字：<asp:TextBox ID="TextBox2" runat="server" Columns="20" MaxLength="8" Width="100px"></asp:TextBox>
                                        ...
                                        <td colspan="4" valign="top" align="left">
                                            <asp:DataGrid ID="DataGrid1" runat="server" DataKeyField="id" AllowSorting="True"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateColumn HeaderText="状态" SortExpression="ishidden" ItemStyle-HorizontalAlign="Center"
                                                    ...
                                                    <asp:TemplateColumn HeaderText="网站ID" SortExpression="userid" ItemStyle-Width="50px" HeaderStyle-CssClass="column">
                                                        
                                                        <ItemTemplate>
                                                            <a href="admin_userlist.aspx?tositeid=<%#DataBinder.Eval(Container.DataItem,"userid") %>"
                                                    ...
                                                    <asp:TemplateColumn HeaderText="栏目ID" SortExpression="book_classid" ItemStyle-Width="50px" HeaderStyle-CssClass="column">
                                                        ...
                                                        <ItemTemplate>
                                                            <a href="admin_userlist.aspx?classid=<%#DataBinder.Eval(Container.DataItem,"book_classid") %>"
                                                                target="_self" title="快速进入此栏目">
                                                                <%#DataBinder.Eval(Container.DataItem, "book_classid")%>
                                                            </a>
                                                        </ItemTemplate>
                                                    </asp:TemplateColumn>
                                                    <asp:TemplateColumn HeaderText="栏目名称" SortExpression="classname" ItemStyle-Width="80px" HeaderStyle-CssClass="column">
                                                        
                                                        <ItemTemplate>
                                                            <%#DataBinder.Eval(Container.DataItem, "classname")%>
                                                        </ItemTemplate>
                                                    </asp:TemplateColumn>
                                                    <asp:TemplateColumn HeaderText="标题" SortExpression="" ItemStyle-Width="200px" HeaderStyle-CssClass="column">
                                                        
                                                        <ItemTemplate>
                                                            <a href="viewUser.aspx?bookid=<%#DataBinder.Eval(Container.DataItem,"id") %>"
                                                                target="_self" title="查看友情链接及回复">
                                                                <%#DataBinder.Eval(Container.DataItem, "book_title")%>
                                                            </a>
                                                        </ItemTemplate>
                                                    </asp:TemplateColumn>
                                                    <asp:TemplateColumn HeaderText="链接" SortExpression="book_pub" ItemStyle-Width="120px" HeaderStyle-CssClass="column">
                                                        
                                                        <ItemTemplate>
                                                            <input type="text" value="<%#DataBinder.Eval(Container.DataItem, "book_pub")%>" style="width:120px"/>
                                                        </ItemTemplate>
                                                    </asp:TemplateColumn>
                                                    <asp:TemplateColumn HeaderText="返链" SortExpression="book_re" ItemStyle-Width="40px" HeaderStyle-CssClass="column">
