<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Book_Search.aspx.cs" Inherits="KeLin.WebSite.link.Book_Search" %><%@ Import namespace="KeLin.ClassManager.Tool" %><%
Response.Write(WapTool.showTop(this.GetLang("友情链接搜索|友情链接搜索|Search"), wmlVo));//显示头 
...
strhtml.Append("<option value=\"title\">友情链接标题</option>");
strhtml.Append("<option value=\"author\">友情链接作者</option>");
strhtml.Append("<option value=\"days\">N天前(输入天数)</option>");
strhtml.Append("</select><br/>");
strhtml.Append("<anchor><go href=\""+this.http_start +"link/book_list.aspx\" method=\"get\" accept-charset=\"utf-8\">");
...
strhtml.Append("<form id=\"form1\" action=\""+this.http_start +"link/book_list.aspx\" method=\"get\">");
strhtml.Append("<div class=\"subtitle\">友情链接搜索</div>");
strhtml.Append("<div class=\"content\">");
strhtml.Append("请输入关键字：<br/>");
strhtml.Append("<input type=\"text\" class=\"txt\" name=\"key\" value=\"\"/><br/>");
strhtml.Append("选择搜索项：<br/>");
strhtml.Append("<select name=\"type\" class=\"sel\">");
strhtml.Append("<option value=\"title\">网站标题</option>");
strhtml.Append("<option value=\"author\">站长昵称</option>");
strhtml.Append("<option value=\"days\">N天前(上面输入天数)</option>");
strhtml.Append("</select><br/>");
strhtml.Append("<input type=\"submit\" class=\"btn\" value=\"快速搜索\" class=\"btn\" />");
