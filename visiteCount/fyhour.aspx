<%@ Page Language="C#" AutoEventWireup="true" Codebehind="fyhour.aspx.cs" Inherits="KeLin.WebSite.visiteCount.fyhour" %>
                                ...
                                <tbody>
                                    <tr>
                                        <td colspan="5" align="center">
                                            <asp:LinkButton ID="LinkButton1" runat="server" OnClick="LinkButton1_Click"  CssClass="bt">当天按时段统计</asp:LinkButton>
                                            &nbsp;&nbsp;&nbsp;&nbsp;
                                            <asp:LinkButton ID="LinkButton2" runat="server" OnClick="LinkButton2_Click"  CssClass="bt">所有按时段统计</asp:LinkButton>
                                            &nbsp;&nbsp;&nbsp;&nbsp;总访问人数：<%=total %>
                                        </td>
                                    </tr>
                                    <tr>
