<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" Codebehind="EveryDateList.aspx.cs"
    Inherits="KeLin.WebSite.visiteCount.EveryDateList" %><%@ Register Assembly="AspNetPager" Namespace="Wuqi.Webdiyer" TagPrefix="webdiyer" %>
<%
        ...
        <table cellspacing="0" cellpadding="0" width="100%" border="0">
            <tbody>
                ...
                <tr>
                    ...
                    <font color="red">   运营商城市统计需在web.config配置KL_VisiteCount_Detail参数，设为1开启，默认0关闭。
                    当前状态：
