<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" Codebehind="datailList.aspx.cs"
    Inherits="KeLin.WebSite.visiteCount.datailList" %><%@ Import namespace="KeLin.ClassManager.Tool" %>
...
<body>
 ...
 &nbsp;&nbsp;
                        ...
                        <%if (this.KL_VisiteCount_Detail=="1")
                          ...
                          {
                              Response.Write("关闭");
                          } %>，建议关闭此功能，否则可能产生大量数据导致暴库。方法在web.config配置KL_VisiteCount_Detail参数，设为0关闭。
                        </font>
                                      </td>
                                    </tr>
                                </tbody>
