<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MobileUA_list00WAP_mod.aspx.cs" Inherits="KeLin.WebSite.WapStyle.MobileUA_list00WAP_mod" %><%@ Import namespace="KeLin.ClassManager.Tool" %><%
...
if (ver == "1")
{
    ...
    if (this.INFO != "OK")
    {
        ...
        Response.Write("<select name=\"namecn" + this.r + "\" value=\"" + bookVo.nameCN + "\">");        
        ...
        Response.Write("<select name=\"series" + this.r + "\" value=\"" + bookVo.Series + "\">");
        Response.Write(this.serial);
        Response.Write("<option value=\"\">留空-暂时不知道</option>");
        Response.Write("</select><br/>");
        
        Response.Write("操作系统:<br/>");
        Response.Write("<select name=\"osystem" + this.r + "\" value=\"" + bookVo.OSystem + "\">");
        Response.Write(this.platform);
        Response.Write("<option value=\"\">留空-暂时不知道</option>");
        Response.Write("</select><br/>");

        Response.Write("手机屏幕:<br/>");
        Response.Write("<select name=\"screen" + this.r + "\" value=\""+bookVo.widthpx+"X"+bookVo.heightpx+"\">");
        ...
        Response.Write("</select><br/>");
        Response.Write("修改信息:<br/><input type=\"text\" name=\"ismodify" + this.r + "\" value=\"" + bookVo.ismodify + "\"/><br/>");
        ...
        Response.Write("<anchor><go href=\"" + http_start + "wapstyle/mobileua_list00wap_mod.aspx\" method=\"post\" accept-charset=\"utf-8\">");
        ...
        Response.Write("<postfield name=\"ismodify\" value=\"$(ismodify" + r + ")\"/>");
    ...
    Response.Write("<br/>");
    Response.Write("<a href=\"" + http_start + "wapstyle/mobileua_list00wap.aspx?id="+id+"&amp;siteid=" + siteid + "&amp;classid=" + classid + "&amp;key=" + HttpUtility.UrlEncode(key) + "&amp;backurl=" + HttpUtility.UrlEncode(backurl) + "" + "\">返回上级</a> ");
...
else //2.0界面
{
    ...
    Response.Write("<div class=\"subtitle\">" + this.GetLang("修改型号|修改型号|modify phone model") + "</div>");
    ...
    if (this.INFO != "OK")
    {
        ...
        Response.Write("<form name=\"f\" action=\"" + http_start + "wapstyle/mobileua_list00wap_mod.aspx\" method=\"post\">");
        Response.Write("中文品牌*:<br/>");
        ...
        Response.Write("<option value=\"" + bookVo.version + "\">" + bookVo.version + "</option>");
        Response.Write("<option value=\"不清楚\">不清楚</option>");
        Response.Write("<option value=\"WAP1.0\">WAP1.0</option>");
        Response.Write("<option value=\"WAP2.0\">WAP2.0</option>");
        Response.Write("<option value=\"WAP1.0/2.0\">WAP1.0/2.0</option>");
        ...
        Response.Write("<option value=\"全支持\">全支持</option>");
        Response.Write("</select><br/>");
        Response.Write("修改信息:<br/><input type=\"text\" name=\"ismodify\" value=\"" + bookVo.ismodify + "\"/><br/>");

        Response.Write("机型首页显示:<br/>");
        Response.Write("<select name=\"showindex\">");
        Response.Write("<option value=\"" + bookVo.showIndex + "\">" + bookVo.showIndex + "</option>");
