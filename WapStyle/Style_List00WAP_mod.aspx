<%@ Page Language="C#" AutoEventWireup="true" validateRequest=false CodeBehind="Style_List00WAP_mod.aspx.cs" Inherits="KeLin.WebSite.WapStyle.Style_List00WAP_mod" %><%@ Import namespace="KeLin.ClassManager.Tool" %><%
Response.Write(WapTool.showTop(this.GetLang("修改CSS样式|修改CSS样式|modify CSS"), wmlVo));//显示头                                                                                                                                                                       
if (ver == "1")
{
    Response.Write("<p align=\"left\">");

    Response.Write("点击此进入<a href=\""+this.http_start+"wapstyle/Style_List00WAP_mod.aspx?id="+this.id+"&amp;siteid="+this.siteid+"&amp;classid="+this.classid+"&amp;sid="+this.sid1+"-2-"+this.cs+"-"+this.lang+"-"+this.myua+"-"+this.width+"\">WAP2.0编辑管理</a><br/>");
...
else //2.0界面
{
    ...
    if (this.INFO != "OK")
    {
        ...
        Response.Write("<form name=\"f\" action=\"" + http_start + "wapstyle/Style_List00WAP_mod.aspx\" method=\"post\">");
        ...
        Response.Write("CSS样式:<br/><textarea name=\"style\" rows=\"12\" style=\"width:100%\">" + stVo.style.Replace("<","&lt;").Replace(">","&gt;") + "</textarea><br/>");
