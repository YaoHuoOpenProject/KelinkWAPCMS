<%@ Page Language="C#" AutoEventWireup="true" validateRequest="false" CodeBehind="MobileUA_List00_add.aspx.cs" Inherits="KeLin.WebSite.WapStyle.MobileUA_List00_add" %>
<html>
<head>
            ...
            <tr>
              ...
              <td width="100%" background="../NetImages/main_title_02.gif"><table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                  ...
                  <td width="98%" height="24" valign="middle">系统资源 &gt;&gt; 机型资源 &gt;&gt; 新增机型</td>
                </tr>
              </table></td>
...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
  <tr> 
    <td width="100%" align="center" valign="top"> 
      <FORM name="messageForm" action="MobileUA_List00_add.aspx" method="post">
                              ...
                              <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" height="554">
                                ...
                                <TR class="tdbg" > 
                                  ...
                                  <TD class="TD3"> <div align="left">&nbsp;  
                                      <INPUT Class="input" name="rand" value="0" size=50>
                                    </div></TD>
                                </TR>
                                <TR class="tdbg" > 
                                ...
                                <TR class="tdbg" >
                                  ...
                                  <TD class="TD3"><div align="left">&nbsp;  
                                      <INPUT Class="input" name="nameen" value="" size=50>
                                    </div> 
                                  </TD>
                                </TR>
                                <TR class="tdbg" >
                                  ...
                                  <TD class="TD3"><div align="left">&nbsp;  
                                      <INPUT Class="input" name="mode" value="" size=50>
                                    </div> 
                                  </TD>
                                </TR>
                                                                <TR class="tdbg" >
                                ...
                                <TR class="tdbg" >
                                  ...
                                  <TD class="TD3"><div align="left">&nbsp;  
                                      <INPUT Class="input" name="remark" value="" size=100>
                                      <br />(支持UBB内容，如论坛栏目链接，图片栏目链接。单用户个人版，DIY版可用。多用户版请不要用。)
                                    </div> 
                                  </TD>
                                </TR>
