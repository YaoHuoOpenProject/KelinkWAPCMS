<%@ Page Language="C#" AutoEventWireup="true" validateRequest="false" CodeBehind="Style_List00_add.aspx.cs" Inherits="KeLin.WebSite.WapStyle.Style_List00_add" %>
<html>
<head>
      	...
      	<input type="hidden" name="action" value="add" />
                              <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" height="554">
                                ...
                                <TR class="tdbg" >
                                  ...
                                  <TD class="TD3"><div align="left">&nbsp;  
                                      <INPUT Class="input" name="style_name" value="" size=50> (如果下面样式有HTML5效果，请在名称上加上"[HTML5]"，方便选皮肤时显示)
                                    </div> 
                                  </TD>
                                </TR>
                                <TR class="tdbg" > 
...
.comment div{background:#ffe;padding:3px;border:1px solid #aaa;line-height:140%;margin-bottom:5px;}
                                      ...
                                      <br />
(层宽width参数用[width]代替，可按选机型屏幕适配!)<br/>
<b>系统定义样式名UBB调用：</b><br />
