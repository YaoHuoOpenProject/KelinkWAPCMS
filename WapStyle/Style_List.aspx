<%@ Page Language="C#" AutoEventWireup="true" validateRequest="false" CodeBehind="Style_List.aspx.cs" Inherits="KeLin.WebSite.WapStyle.Style_List" %>
<html>
<head>
...
<script language="JavaScript" type="text/JavaScript">
  ...
  { }
    ...
    function daoru() {
        window.open("/WapStyle/Style_List00.aspx", "daoruwindow", "height=520, width=720, toolbar= no, menubar=no, scrollbars=yes, resizable=no, location=no, status=no")
    }
</script>
<title>CSS样式列表</title>
</head>
...
<div id="title">
   ...
   <div class="tit_center">
      <ul>
        ...
        <li><a href="../WapStyle/Style_List.aspx"  class="check">皮肤CSS样式</a></li>
   ...
   <table id="tblManageRanks" class="tableBorder" cellspacing="1" cellpadding="3" border="0"
                                                                                ...
                                                                                <tr>
                                                                                    <td class="fh" align="left">
                                                                                        ...
                                                                                        <input name="" type="button" value=" 导入系统默认CSS样式 " onClick="daoru();" id="Button3" class="bt"/>
