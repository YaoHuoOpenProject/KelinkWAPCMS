<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Book_Search.aspx.cs" Inherits="KeLin.WebSite.wml.Book_Search" %><%@ Import namespace="KeLin.ClassManager.Tool" %><%
Response.Write(WapTool.showTop(this.GetLang("wml搜索|wml搜索|Search"), wmlVo));//显示头 
if(ver=="1"){
%>
<p>请输入关键字：<br/>
...
<option value="title">wml标题</option>
<option value="author">wml作者</option>
<option value="days">N天前(输入天数)</option>
</select><br/>
<anchor><go href="<%=http_start%>wml/book_list.aspx" method="get" accept-charset="utf-8">
...
<form id="form1" action="<%=http_start%>wml/book_list.aspx" method="get">
<div class="subtitle">wml搜索</div>
<div class="content">
请输入关键字：<br/>
