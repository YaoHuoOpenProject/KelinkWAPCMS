<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="admin_WAPmodify.aspx.cs" Inherits="KeLin.WebSite.ring.admin_WAPmodify" %><%@ Import namespace="KeLin.ClassManager.Tool" %><%
...
if (ver == "1")
{
    ...
    if (this.INFO == "OK")
    {
        ...
        Response.Write("</b><br/>");
        Response.Write("<a href=\"" + this.http_start + "ring/admin_userlistWAP.aspx?siteid=" + this.siteid + "&amp;classid=" + this.classid + "&amp;page=" + this.page + "\">" + this.GetLang("返回列表|返回列表|Back to list") + "</a><br/>");
    }
    else if(this.INFO!="")
    {
        Response.Write("<b>");
    ...
    Response.Write("<a href=\"" + this.http_start + "ring/admin_wapmodify.aspx?action=class&amp;siteid=" + this.siteid + "&amp;classid=" + this.classid + "&amp;id=" + this.id + "&amp;sid=" + this.sid1 + "-2-" + this.cs + "-" + this.lang + "-" + this.myua + "-" + this.width + "\">" + this.GetLang("进入WAP2.0界面修改|进入WAP2.0界面修改|wap2.0 modify") + "</a><br/>");
    
    Response.Write("<br/><a href=\"" + this.http_start + "ring/admin_userlistWAP.aspx?siteid=" + this.siteid + "&amp;classid=" + this.classid + "&amp;page=" + this.page + "\">" + this.GetLang("返回列表|返回列表|Back to list") + "</a>");
...
else //2.0界面
{
    ...
    Response.Write("<a href=\""+this.http_start+"ring/admin_wapmodifyadd.aspx?siteid="+this.siteid+"&classid="+this.classid+"&id="+this.id+"&sid="+this.sid+"\">续传铃声</a>");
    Response.Write("</div>");
    Response.Write("<div class=\"content\">");
    Response.Write("<form name=\"go\" action=\"" + this.http_start + "ring/admin_WAPmodify.aspx\" method=\"post\">");
    ...
    Response.Write("铃声地址：<br/><textarea name=\"book_file\" rows=\"3\" style=\"width:100%\">" + bookVo.book_file + "</textarea><br/>");
    ...
    Response.Write("<a href=\"" + this.http_start + "ring/admin_userlistWAP.aspx?siteid=" + this.siteid + "&amp;classid=" + this.classid + "&amp;page=" + this.page + "\">" + this.GetLang("返回列表|返回列表|Back to list") + "</a>");
