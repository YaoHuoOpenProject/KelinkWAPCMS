<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="admin_modifyUserOrder.aspx.cs" Inherits="KeLin.WebSite.shop.admin_modifyUserOrder" %>
                    ...
                    <td valign="top" align="left">                        
                        <table class="TABLE6" cellspacing="1" cellpadding="3" width="100%">
                            <tbody>
                                ...
                                <tr>
                                    <td width="16%" class="f" style="width: 16%">
                                        <font face="宋体">修改价格： </font>
                                    </td>
                                    <td colspan="3" class="fh3">
                                        <asp:TextBox ID="productmoney" runat="server" Width="400px"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td class="f" style="width: 16%">
                                        <font face="宋体">店长回复： </font>
                                    </td>
                                    <td colspan="3" class="fh3">
                                        <asp:TextBox ID="book_reply" runat="server" Height="100px" TextMode="MultiLine" Width="400px"></asp:TextBox>
                                        <br />
                                    </td>
                                </tr>
                                <tr>
