<%@ Page Language="C#" AutoEventWireup="true" Codebehind="viewUser.aspx.cs" Inherits="KeLin.WebSite.shop.viewUser" %>
                                                    ...
                                                    <table class="tableBorder" id="Table1" cellspacing="1" cellpadding="3" width="100%">
                                                        ...
                                                        <tr>
                                                            <td class="f" colspan="2">
                                                                <span class="forumThread" id="_ct">产品型号: <b>
                                                                    <%# DataBinder.Eval(Container.DataItem, "book_xinghao")%>
                                                                </b>&nbsp;&nbsp;&nbsp; 市场价格: <b>
                                                                    <%# DataBinder.Eval(Container.DataItem, "book_jiage")%>
                                                                </b>&nbsp;&nbsp;&nbsp; 会员价格:<b><%# DataBinder.Eval(Container.DataItem, "book_yhjiage")%></b>&nbsp;&nbsp;&nbsp;
                                                                </span>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <td class="fh3a">
                                                                <img id="siteimgs" name="img" style="cursor: hand;" src="<%# DataBinder.Eval(Container.DataItem, "book_smallimg")%>"
                                                                    width="50" height="50"><br />
                                                                定购热线：<%# DataBinder.Eval(Container.DataItem, "book_hottel")%><br />
                                                                短信咨询：<%# DataBinder.Eval(Container.DataItem, "book_shortmessage")%><br />
                                                                <br />
                                                                                        ...
                                                                                        <td class="f" valign="top" width="100%">
                                                                                            <table cellspacing="0" cellpadding="2" width="100%">
                                                                                                <tr align="right">
                                                                                                    <td>
                                                                                                        <a href="">
                                                                                                            <img alt="回复" src="/NetImages/newpost.gif" border="0"></a> <a href="">
