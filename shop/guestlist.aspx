<%@ Page Language="C#" AutoEventWireup="true" Codebehind="guestlist.aspx.cs" Inherits="KeLin.WebSite.shop.guestlist" %>
                                            ...
                                            <table id="tblManageRanks" class="tableBorder" cellspacing="1" cellpadding="3" border="0"
                                                ...
                                                <tr>
                                                    ...
                                                    审核状态：
                                                        ...
                                                        商店ID：<asp:TextBox ID="TextBox4" runat="server" Width="64px"></asp:TextBox>  关键字：<asp:TextBox
                                                ...
                                                <tr>
                                                    ...
                                                    <input id="Button1" name="" type="button" value=" 审 核 " onclick="DoCheck()" class="bt" />
                                                        ...
                                                        &nbsp;&nbsp;
                                                        <input id="Button5" name="" type="button" value=" 修 改 " onclick="DoEdit()" class="bt"/>
                                                        &nbsp;&nbsp;
                                        ...
                                        <td colspan="4" valign="top" align="left">
                                            <asp:DataGrid ID="DataGrid1" runat="server" DataKeyField="id" AllowSorting="True"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateColumn HeaderText="查看" SortExpression="bookid" ItemStyle-Width="50px" HeaderStyle-CssClass="column">
                                                        <ItemTemplate>
                                                            <a href="/shop/book_view.aspx?siteid=<%#DataBinder.Eval(Container.DataItem,"devid") %>&classid=<%#DataBinder.Eval(Container.DataItem,"classid") %>&id=<%#DataBinder.Eval(Container.DataItem,"bookid") %>&sid=<%=base.SID %>"
                                                                target="_blank" title="查看或修改">
                                                                查看[<%#DataBinder.Eval(Container.DataItem, "bookid")%>]
                                                            </a>
                                                        </ItemTemplate>
                                                    </asp:TemplateColumn>
                                                    ...
                                                    <asp:TemplateColumn HeaderText="回复人" SortExpression="nickname" ItemStyle-Width="100px" HeaderStyle-CssClass="column">
                                                        <ItemTemplate>
                                                            <%#DataBinder.Eval(Container.DataItem, "nickname")%>
                                                        </ItemTemplate>
                                                    </asp:TemplateColumn>
                                                    <asp:TemplateColumn HeaderText="回复时间" SortExpression="redate" ItemStyle-Width="130px" HeaderStyle-CssClass="column">
                                                        <ItemTemplate>
