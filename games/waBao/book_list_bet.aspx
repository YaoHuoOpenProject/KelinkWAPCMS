<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="book_list_bet.aspx.cs" Inherits="KeLin.WebSite.Games.waBao.book_list_bet" %><%@ Import namespace="KeLin.ClassManager.Tool" %><%
...
if (ver == "1")
{
    ...
    strhtml.Append("<anchor><go href=\"" + http_start + "games/wabao/book_list_bet.aspx\" method=\"get\" accept-charset=\"utf-8\">");
...
else //2.0界面
{
    ...
    strhtml.Append("<form name=\"re\" action=\"" + http_start + "games/waBao/book_list_bet.aspx\" method=\"get\">");
