...
else //2.0界面
{
    ...
    strhtml.Append("<br/><a href=\"" + this.http_start + "games/chuiniu/add.aspx?siteid=" + this.siteid + "&amp;classid=" + this.classid + "\"><img src=\"dh.gif\" alt=\"PIC\"/>我要公开挑战</a>");
    strhtml.Append("</div>");
    strhtml.Append("<div class=\"subtitle\">最新吹牛-<a href=\""+this.http_start+"games/chuiniu/index.aspx?siteid="+this.siteid+"&amp;classid="+this.classid+"&amp;r="+this.r+"&amp;sid="+this.sid+"\">刷新</a></div>");
    //显示列表    
    for (int i = 0; (listVo != null && i < listVo.Count); i++)
    {
    ...
    strhtml.Append("<div class=\"subtitle\">聊天交流 <a class=\"urlbtn\" href=\"" + this.http_start + "games/chuiniu/index.aspx?siteid=" + this.siteid + "&amp;classid=" + this.classid + "&amp;r=" + this.r + "\">刷新</a></div>");
    strhtml.Append("<div class=\"content\">");
    ...
    if (showRe > 0)
    {
        ...
        {
            strhtml.Append("<div class=\"bt1\"><a href=\"" + http_start + "games/chat/book_re.aspx?nid=chuiniu&amp;classid=" + classid + "&amp;siteid=" + siteid + "" + "\">查看更多...</a></div>");
