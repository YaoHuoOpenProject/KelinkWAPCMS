...
<%
 set rsq=Server.CreateObject("ADODB.Recordset")
  ssql="select id,txt,zb from wap_game_chuiniu where siteid="&siteid&" order by id desc"
...
response.write("<a href='"&http_start&"games/chuiniu/aniu.asp?siteid="&siteid&"&amp;classid="&classid&jid2&"&amp;page=" & epage+1 & "'>下页</a> ")
end if
if epage>1 then
response.write("<a href='"&http_start&"games/chuiniu/aniu.asp?siteid="&siteid&"&amp;classid="&classid&jid2&"&amp;page=" & epage-1 & "'>上页</a>")
end if
%>
