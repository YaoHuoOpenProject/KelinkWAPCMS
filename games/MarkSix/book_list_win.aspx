<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="book_list_win.aspx.cs" Inherits="KeLin.WebSite.Games.marksix.book_list_win" %><%@ Import namespace="KeLin.ClassManager.Tool" %><%
...
if (ver == "1")
{
    ...
    strhtml.Append("<br/>--------<br/>");
    strhtml.Append("<a href=\"" + this.http_start + "games/MarkSix/Rank.aspx?siteid=" + siteid + "&amp;classid=" + this.classid + "" + "\">返回上级</a>-");
