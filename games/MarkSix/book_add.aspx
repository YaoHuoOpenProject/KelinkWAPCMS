<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="book_add.aspx.cs" Inherits="KeLin.WebSite.Games.marksix.book_add" %><%@ Import namespace="KeLin.ClassManager.Tool" %><%
...
else //2.0界面
{
    ...
    if (this.INFO != "OK")
    {
        ...
        strhtml.Append("<form name=\"re\" action=\"" + http_start + "games/marksix/book_add.aspx\" method=\"get\">");
