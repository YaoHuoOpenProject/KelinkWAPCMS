<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="book_list.aspx.cs" Inherits="KeLin.WebSite.Games.marksix.book_list" %><%@ Import namespace="KeLin.ClassManager.Tool" %><%
...
if (ver == "1")
{
    ...
    strhtml.Append("<anchor><go href=\"" + http_start + "games/marksix/book_list.aspx\" method=\"get\" accept-charset=\"utf-8\">");
...
else //2.0界面
{
    ...
    strhtml.Append("<form name=\"re\" action=\"" + http_start + "games/marksix/book_list.aspx\" method=\"get\">");
