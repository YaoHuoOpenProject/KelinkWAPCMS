<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="book_list_bet.aspx.cs" Inherits="KeLin.WebSite.Games.marksix.book_list_bet" %><%@ Import namespace="KeLin.ClassManager.Tool" %><%
...
if (ver == "1")
{
    ...
    strhtml.Append("<anchor><go href=\"" + http_start + "games/MarkSix/book_list_bet.aspx\" method=\"get\" accept-charset=\"utf-8\">");
...
else //2.0界面
{
    ...
    strhtml.Append("<form name=\"re\" action=\"" + http_start + "games/marksix/book_list_bet.aspx\" method=\"get\">");
    strhtml.Append("年份:<input type=\"text\" name=\"toyear\" size=\"4\" value=\"" + toyear + "\"/> ");

    strhtml.Append("期号:<input type=\"text\" name=\"content\" size=\"4\" value=\"" + content + "\"/><br/>");
