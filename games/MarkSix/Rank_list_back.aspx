<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Rank_list_back.aspx.cs" Inherits="KeLin.WebSite.Games.MarkSix.Rank_list_back" %><%@ Import namespace="KeLin.ClassManager.Tool" %><%
string title ="返利活动";
...
if (ver == "1")
{
    ...
    {
        Response.Write("返利成功，<a href=\"" + this.http_start + "games/MarkSix/rank_list.aspx?siteid=" + this.siteid + "&amp;classid=" + this.classid + "\">返回</a><br/>");
    ...
    if (this.INFO != "OK")
    {
        ...
        Response.Write("<anchor><go href=\"" + http_start + "games/MarkSix/rank_list_back.aspx\" method=\"post\" accept-charset=\"utf-8\">");
    ...
    Response.Write("--------<br/>");
    Response.Write("<a href=\"" + this.http_start + "games/MarkSix/rank_list.aspx?siteid=" + this.siteid + "&amp;classid=" + this.classid + "\">" + this.GetLang("返回上级|返回上级|Back to list") + "</a> ");
...
else //2.0界面
{
    ...
    {
        Response.Write("<div class=\"tip\">返利成功，<a href=\"" + this.http_start + "games/MarkSix/rank_list.aspx?siteid=" + this.siteid + "&amp;classid=" + this.classid + "\">返回</a></div>");
    ...
    if (this.INFO != "OK")
    {
        ...
        Response.Write("<form name=\"gt\" action=\"" + http_start + "games/MarkSix/rank_list_back.aspx\" method=\"post\">");
