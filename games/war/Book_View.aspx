<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Book_View.aspx.cs" Inherits="KeLin.WebSite.Games.war.Book_View" %><%@ Import namespace="KeLin.ClassManager.Tool" %><%
...
if (ver == "1")
{
    ...
    {
        Response.Write("挑战方部署[" + GamesClassManager.Tool.GetWarType(bookVo.myWar.ToString()) + "]<br/>");
        Response.Write("应战者:" + bookVo.winNickname + "<br/>");
        Response.Write("应战方部署[" + GamesClassManager.Tool.GetWarType(bookVo.winWar.ToString()) + "]<br/>");
        Response.Write("三战局情报[" + GamesClassManager.Tool.GetWarRestult(bookVo.winWar.ToString(), bookVo.myWar.ToString(), 0) + "]<br/>");
  ...
  Response.Write("<a href=\"" + this.http_start + "games/war/book_list.aspx?siteid=" + this.siteid + "&amp;classid=" + this.classid + "&amp;type="+type+"&amp;touserid="+touserid+"\">" + this.GetLang("返回上级|返回上级|Back to list") + "</a> ");
