<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="doit.aspx.cs" Inherits="KeLin.WebSite.Games.quankun.doit" %><%@ Import namespace="KeLin.ClassManager.Tool" %><%
...
if (ver == "1")
{
    ...
    {
        Response.Write("<div class=\"tip\">压注成功，<a href=\"" + this.http_start + "games/quankun/index.aspx?siteid=" + this.siteid + "&amp;classid=" + this.classid + "\">返回</a></div>");
    ...
    if (this.INFO != "OK")
    {
        ...
        Response.Write("压<b>" + this.myquankun + "点</b>，请输入" + siteVo.sitemoneyname + "数量(" + min + "-" + max + "):<br/>");
        Response.Write("<input type=\"\" name=\"mymoney" + r + "\" value=\""+min+"\" size=\"6\"/><br/>");

        Response.Write("<anchor><go href=\"" + http_start + "games/quankun/doit.aspx\" method=\"post\" accept-charset=\"utf-8\">");
        Response.Write("<postfield name=\"action\" value=\"gomod\"/>");
        Response.Write("<postfield name=\"classid\" value=\"" + classid + "\"/>");
        Response.Write("<postfield name=\"siteid\" value=\"" + siteid + "\"/>");
        Response.Write("<postfield name=\"id\" value=\"" + id + "\"/>");
        Response.Write("<postfield name=\"myquankun\" value=\"" + myquankun + "\"/>");
  ...
  Response.Write("<a href=\"" + this.http_start + "games/quankun/index.aspx?siteid=" + this.siteid + "&amp;classid=" + this.classid + "\">" + this.GetLang("返回上级|返回上级|Back to list") + "</a> ");
...
else //2.0界面
{
    ...
    if (this.INFO != "OK")
    {
        ...
        Response.Write("<form name=\"gt\" action=\"" + http_start + "games/quankun/doit.aspx\" method=\"post\">");
        Response.Write("您目前共有" + userVo.money + "个" + siteVo.sitemoneyname + "！<br/>");
        Response.Write("还有" + WapTool.DateToString(this.leftTime, base.lang, 0) + "开盅！<br/>");
        Response.Write("压<b>" + this.myquankun + "点</b>，请输入" + siteVo.sitemoneyname + "数量(" + min + "-" + max + "):<br/>");
        ...
        Response.Write("<input type=\"hidden\" name=\"myquankun\" value=\"" + myquankun + "\"/>");
