<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Book_List.aspx.cs" Inherits="KeLin.WebSite.Games.quankun.Book_List" %><%@ Import namespace="KeLin.ClassManager.Tool" %><%
string title="投注记录";
...
if (ver == "1")
{
    ...
    strhtml.Append("<anchor><go href=\"" + http_start + "games/quankun/book_list.aspx\" method=\"get\" accept-charset=\"utf-8\">");
...
else //2.0界面
{
    ...
    strhtml.Append("<form name=\"f\" aciont=\"" + http_start + "games/quankun/book_list.aspx\" method=\"get\">");
