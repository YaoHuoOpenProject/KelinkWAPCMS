<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ClassConfigAll.aspx.cs" Inherits="KeLin.WebSite.Games.horse.ClassConfigAll" %><%@ Import namespace="KeLin.ClassManager.Tool" %><%
Response.Write(WapTool.showTop(this.GetLang("赛马场配置|赛马场配置|site setup"), wmlVo));//显示头                                                                                                                                                                       
if (ver == "1")
{
    Response.Write("<p>");
    ...
    Response.Write("<anchor><go href=\"" + http_start + "games/horse/ClassConfigAll.aspx\" method=\"post\" accept-charset=\"utf-8\">");
    ...
    if (backtype == "wap")
    {
        Response.Write("<br/><a href=\"" + this.http_start + "games/horse/index.aspx?siteid=" + this.siteid + "&amp;classid=" + this.classid + "\">" + this.GetLang("返回上级|返回上级|Back to set") + "</a> ");
    }
...
else //2.0界面
{
    ...
    Response.Write("<div class=\"subtitle\">" + this.GetLang("赛马场配置|赛马场配置|site setup") + "</div>");
    if (this.INFO == "OK")
    {
    ...
    Response.Write("<form name=\"f\" action=\"" + http_start + "games/horse/ClassConfigAll.aspx\" method=\"post\">");
    Response.Write("[0]每次赢家获得赌注:<br/>");
