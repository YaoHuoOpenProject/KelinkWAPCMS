<%@ Page Language="C#" AutoEventWireup="true" Codebehind="userlist.aspx.cs" Inherits="KeLin.WebSite.myAccount.userlist" %>

<%@ Register Assembly="AspNetPager" Namespace="Wuqi.Webdiyer" TagPrefix="webdiyer" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>myAccount代码资源</title>
...
<link href="/NetCSS/style.css" rel="stylesheet" type="text/css">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function DoEdit() {
            ...
            window.open('/myAccount/admin_WAPmodify.aspx?action=go&id=' + edtHangBiaoShis + '&siteid=<%=base.SiteId %>&classid=' + toclassid + '&page=1&sid=<%=base.SID %>');
         ...
         **/
            window.location.href = "/admin/modifyAD.aspx?systype=myAccount";
        }
        function DoContent() {
        ...
        function DoSmall() {
            window.location.href="../admin/systemclass.aspx?systype=myAccount&classid="+document.getElementById("TextBox4").value;  
        }
        function DoMyItem() {
            var delHangBiaoShis = GetOnChecked();
            if (delHangBiaoShis == null || delHangBiaoShis == "") {
...
window.location.href="upload_bath.aspx?systype=myAccount&classid="+ItemID;
//window.open ("upload_bath.aspx?systype=myAccount&classid=<%=classid%>", "addsystemwindow", "height=450, width=550, toolbar= no, menubar=no, scrollbars=no, resizable=no, location=no, status=no");
}
function daoru() { 
                                            ...
                                            <td colspan="4" valign="top" align="left">
                                                <asp:DataGrid ID="DataGrid1" runat="server" DataKeyField="id" AllowSorting="True"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateColumn HeaderText="网站ID" SortExpression="siteid" ItemStyle-Width="80px"
                                                            HeaderStyle-CssClass="column">
                                                            <ItemTemplate>
                                                        ...
                                                        <asp:TemplateColumn HeaderText="会员ID" SortExpression="userid" HeaderStyle-CssClass="column" ItemStyle-Width="60px">
                                                            <ItemTemplate>
                                                                <%#DataBinder.Eval(Container.DataItem, "userid")%>
                                                            </ItemTemplate>
                                                        </asp:TemplateColumn>
                                                         <asp:TemplateColumn HeaderText="日期" SortExpression="paytime" ItemStyle-HorizontalAlign="Center"
                                                            ItemStyle-Width="40px" HeaderStyle-CssClass="column">
                                                            <ItemTemplate>
                                                                <%#DataBinder.Eval(Container.DataItem, "paytime")%>
                                                            </ItemTemplate>
                                                        </asp:TemplateColumn>
                                                        <asp:TemplateColumn HeaderText="收支" SortExpression="totype" ItemStyle-HorizontalAlign="Center"
                                                            ItemStyle-Width="40px" HeaderStyle-CssClass="column">
                                                            <ItemTemplate>
                                                                <%#getTypeName(DataBinder.Eval(Container.DataItem, "totype").ToString())%>
                                                            </ItemTemplate>
                                                        </asp:TemplateColumn>
                                                         <asp:TemplateColumn HeaderText="金额" SortExpression="money" HeaderStyle-CssClass="column">
                                                            <ItemTemplate>
                                                        ...
                                                        <asp:TemplateColumn HeaderText="备注" SortExpression="remark" ItemStyle-Width="200px"
                                                            HeaderStyle-CssClass="column">
                                                            <ItemTemplate>
