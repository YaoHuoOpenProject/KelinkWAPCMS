<%@ Page Language="C#" AutoEventWireup="true" Codebehind="bank_my_list.aspx.cs" Inherits="KeLin.WebSite.chinabank.bank_my_list" %><%@ Import namespace="KeLin.ClassManager.Tool" %>
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateColumn HeaderText="结果" SortExpression="valid" ItemStyle-Width="60px"
                                                         ...
                                                         <asp:TemplateColumn HeaderText="支付时间" SortExpression="valid_time" ItemStyle-Width="120px"
                                                            HeaderStyle-CssClass="column">
                                                            <ItemTemplate>
                                                                <%#DataBinder.Eval(Container.DataItem, "valid")%>
                                                            </ItemTemplate>
                                                        </asp:TemplateColumn>
