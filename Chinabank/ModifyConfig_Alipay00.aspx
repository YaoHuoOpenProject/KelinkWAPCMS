<%@ Page Language="C#" AutoEventWireup="true" validateRequest="false" CodeBehind="modifyConfig_Alipay00.aspx.cs" Inherits="KeLin.WebSite.chinabank.modifyConfig_Alipay00" %>
<html>
<head>
            ...
            <tr>
              ...
              <td width="100%" background="../NetImages/main_title_02.gif"><table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                  ...
                  <td width="98%" height="24" valign="middle">支付宝配置收费接口参数</td>
                </tr>
              </table></td>
...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
  <tr> 
    <td width="100%" align="center" valign="top"> 
     ...
     <FORM name="Form1" action="modifyConfig_alipay00.aspx" method="post">
                                ...
                                <TR align=center class='title'> 
                                 ...
                                 <TR class="tdbg" > 
                                  ...
                                  <TD width="702" class="TD2" rowspan="5" valign="top"> 
									...
									<br>
&nbsp;<b>步骤一：</b>登录支付宝网站(<a target="_blank" href="http://www.alipay.com">www.alipay.com</a>)，进入商家服务。


									<br><br>

&nbsp;<b>步骤二：</b>选择开通：“双功能收款”即担保交易和即时到帐功能，个人可申请哦<br>
									<br>
&nbsp;<b>步骤三：</b>开通后，即可查到合作者身份(Partner ID)和安全校验码(Key)，完成配置。
									<br><br>
&nbsp;<b>步骤四：</b>掉单/结算，登录支付平台WEB后台处理！<br><br>
&nbsp;<b>请注意：</b><font color=red>此业务是你与直接与支付宝合作！有什么支付类问题可申请支付宝技术支持！  
                                ...
                                <tr>
                                  ...
                                  <TD class="TD2" width="367">&nbsp; 
									...
									&nbsp; 例:由于网络原因，可能会有掉单，即提交了没有充值成功，请把订单号发给客服：QQ:XXXXXXX(200字内)
									<br /><br />淘宝WEB支付建议：请不要使用IE8浏览器，请换成遨游、或者火狐等浏览器
									</TD>
                                	</tr>
