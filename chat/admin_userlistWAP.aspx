<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="admin_userlistWAP.aspx.cs" Inherits="KeLin.WebSite.chat.admin_userlistWAP" %><%@ Import namespace="KeLin.ClassManager.Tool" %><%
...
if (ver == "1")
{
    ...
    strhtml.Append("<anchor><go href=\"" + http_start + "chat/admin_userlistWAP.aspx\" method=\"get\" accept-charset=\"utf-8\">");
    ...
    strhtml.Append("【<a href=\"" + this.http_start + "chat/classconfigall.aspx?siteid=" + this.siteid + "&amp;classid=" + this.classid + "\">更多栏目属性设置</a>】<br/>");
...
else //2.0界面
{
    ...
    strhtml.Append("<form name=\"f\" aciont=\"" + http_start + "chat/admin_userlistWAP.aspx\" method=\"post\">");
