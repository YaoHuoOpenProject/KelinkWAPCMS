<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="admin_WAPmodify.aspx.cs" Inherits="KeLin.WebSite.gongqiu.admin_WAPmodify" %><%@ Import namespace="KeLin.ClassManager.Tool" %><%
...
if (ver == "1")
{
    ...
    if (this.INFO == "OK")
    {
        ...
        Response.Write("</b><br/>");
        Response.Write("<a href=\"" + this.http_start + "gongqiu/admin_userlistWAP.aspx?siteid=" + this.siteid + "&amp;classid=" + this.classid + "&amp;page=" + this.page + "\">" + this.GetLang("返回列表|返回列表|Back to list") + "</a><br/>");
    }
    ...
    Response.Write("<anchor><go href=\""+http_start+"gongqiu/admin_WAPmodify.aspx\" method=\"post\" accept-charset=\"utf-8\">");
...
else //2.0界面
{
    ...
    Response.Write("<form name=\"go\" action=\"" + this.http_start + "gongqiu/admin_WAPmodify.aspx\" method=\"post\">");
    Response.Write(this.GetLang("标题|標題|Title") + "*:<br/>");
