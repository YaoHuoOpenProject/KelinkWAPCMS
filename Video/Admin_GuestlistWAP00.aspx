<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="admin_guestlistWAP00.aspx.cs" Inherits="KeLin.WebSite.video.admin_guestlistWAP00" %><%@ Import namespace="KeLin.ClassManager.Tool" %><%
Response.Write(WapTool.showTop(this.GetLang("视频评论审核|视频评论审核|Check Content of the video"), wmlVo));//显示头                                                                                                                                                                       
if (ver == "1")
{
    strhtml.Append("<p align=\"left\">");
    strhtml.Append("<a href=\"" + this.http_start + "video/admin_userlistWAP00.aspx?siteid=" + this.siteid + "&amp;classid=" + this.classid + "&amp;tositeid=" + this.tositeid + "\">内容审核</a>.评论审核<br/>");
    ...
    strhtml.Append("<anchor><go href=\"" + http_start + "video/admin_guestlistWAP00.aspx\" method=\"get\" accept-charset=\"utf-8\">");
    ...
    strhtml.Append("<br/>");
    strhtml.Append("<a href=\"" + this.http_start + "video/admin_guestlistWAP00.aspx?action=gocheckall&amp;state=0&amp;siteid=" + this.siteid + "&amp;classid=" + this.classid + "&amp;tositeid=" + this.tositeid + "&amp;page=" + this.CurrentPage + "\">审核所有</a>.<a href=\"" + this.http_start + "video/admin_guestlistWAP00.aspx?action=gocheckall&amp;state=1&amp;siteid=" + this.siteid + "&amp;classid=" + this.classid + "&amp;tositeid=" + this.tositeid + "&amp;page=" + this.CurrentPage + "\">取消所有审核</a><br/>");
    ...
    for (int i = 0; (listVo != null && i < listVo.Count); i++)
    {
        ...
        {
            YesOrNo = "×";
            CheckStr = "[<a href=\"" + this.http_start + "video/admin_guestlistWAP00.aspx?action=gocheck&amp;id=" + listVo[i].id + "&amp;state=0&amp;siteid=" + this.siteid + "&amp;classid=" + this.classid + "&amp;tositeid="+this.tositeid+"&amp;page=" + this.CurrentPage + "\">审核</a>]";
        }
        else
        {
            YesOrNo = "√";
            CheckStr = "[<a href=\"" + this.http_start + "video/admin_guestlistWAP00.aspx?action=gocheck&amp;id=" + listVo[i].id + "&amp;state=1&amp;siteid=" + this.siteid + "&amp;classid=" + this.classid + "&amp;tositeid="+this.tositeid+"&amp;page=" + this.CurrentPage + "\">取审</a>]";
        }
        strhtml.Append(index + "." + YesOrNo + "[" + this.tositeid + "]" + CheckStr + "[<a href=\"" + this.http_start + "video/admin_guestlistWAPdel00.aspx?action=go&amp;id=" + listVo[i].id + "&amp;siteid=" + this.siteid + "&amp;classid=" + this.classid + "&amp;tositeid=" + this.tositeid + "&amp;page=" + this.CurrentPage + "\">删</a>]<a href=\"" + this.http_start + "bbs/userinfo.aspx?action=class&amp;siteid=" + siteid + "&amp;touserid=" + listVo[i].userid + "" + "\">" + listVo[i].nickname + "</a>:" + listVo[i].content + "<br/>(" + listVo[i].redate + ")<br/>");
    }
    if (listVo == null)
    {
...
else //2.0界面
{
    ...
    strhtml.Append("<div class=\"tip\"><a href=\"" + this.http_start + "video/admin_guestlistWAP00.aspx?action=gocheckall&amp;state=0&amp;siteid=" + this.siteid + "&amp;classid=" + this.classid + "&amp;tositeid=" + this.tositeid + "&amp;page=" + this.CurrentPage + "\">审核所有</a>.<a href=\"" + this.http_start + "video/admin_guestlistWAP00.aspx?action=gocheckall&amp;state=1&amp;siteid=" + this.siteid + "&amp;classid=" + this.classid + "&amp;tositeid=" + this.tositeid + "&amp;page=" + this.CurrentPage + "\">取消所有审核</a></div>");
