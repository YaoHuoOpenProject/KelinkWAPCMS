<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ClassConfigAll.aspx.cs" Inherits="KeLin.WebSite.video.ClassConfigAll" %><%@ Import namespace="KeLin.ClassManager.Tool" %><%
...
if (ver == "1")
{
    ...
    Response.Write("<option value=\"" + KL_VIDRE_Anonymous_Open + "\">Web.confi配置：" + KL_VIDRE_Anonymous_Open + "</option>");
   
    Response.Write("</select><br/>(优先级web.config中“KL_VIDRE_Anonymous_Open”值)<br/>");
    ...
    Response.Write("当前栏目上传地址:<input type=\"text\" name=\"bookUP" + r + "\" value=\"[url=" + this.http_start + "video/user_wapadd.aspx?siteid=" + this.siteid + "&amp;classid=" + this.classid + "]我要上传[/url]\" /> <br/>");
    Response.Write("我的上传记录:<input type=\"text\" name=\"bookUPmylist" + r + "\" value=\"[url=" + this.http_start + "video/book_list.aspx?action=search&amp;siteid="+this.siteid +"&amp;classid=0&amp;key=[userid]&amp;type=makerid]我的上传记录[/url]\" /> <br/>");
    ...
    Response.Write("例:<input type=\"text\" name=\"infos"+r+"\" value=\"[url=/video/book_list.aspx?siteid=[siteid]&amp;classid=[classid]]返回[classname][/url]-[url=/wapindex.aspx?siteid=[siteid]]返回首页[/url]\"/><br/>");
    ...
    if (userVo.managerlvl == "00" || userVo.managerlvl == "01")
    {
        ...
        Response.Write("是否更新所有视频栏目？");
        Response.Write("<br/><input type=\"text\"  name=\"chkall" + r + "\" size=\"3\" value=\"no\"/>如果是输入yes");
        Response.Write("<br/>------------<br />");
    }
    Response.Write("<anchor><go href=\""+http_start+"video/ClassConfigAll.aspx\" method=\"post\" accept-charset=\"utf-8\">");
    ...
    Response.Write("<br/><a href=\"" + this.http_start + "video/admin_userlistWAP.aspx?siteid=" + this.siteid + "&amp;classid=" + this.classid + "\">" + this.GetLang("返回上级|返回上级|Back to set") + "</a> ");
...
else //2.0界面
{
    ...
    Response.Write("<form name=\"f\" action=\"" + http_start + "video/ClassConfigAll.aspx\" method=\"post\">");
    Response.Write("[0]二级页面显示小图标:");
    ...
    Response.Write("当前栏目投稿地址:<input type=\"text\" name=\"bookUP" + r + "\" value=\"[url=" + this.http_start + "video/user_wapadd.aspx?siteid=" + this.siteid + "&amp;classid=" + this.classid + "]投稿[/url]\" /> <br/>");
    Response.Write("我的投稿记录:<input type=\"text\" name=\"bookUPmylist" + r + "\" value=\"[url=" + this.http_start + "video/book_list.aspx?action=search&amp;siteid=" + this.siteid + "&amp;classid=0&amp;key=[userid]&amp;type=makerid]我的投稿记录[/url]\" /> <br/>");
    ...
    Response.Write("例:<input type=\"text\" name=\"infos\" value=\"[url=/video/book_list.aspx?siteid=[siteid]&amp;classid=[classid]]返回[classname][/url]-[url=/wapindex.aspx?siteid=[siteid]]返回首页[/url]\"/><br/>");
    ...
    Response.Write("<a href=\"" + this.http_start + "video/admin_userlistWAP.aspx?siteid=" + this.siteid + "&amp;classid=" + this.classid + "\">" + this.GetLang("返回上级|返回上级|Back to set") + "</a> ");
