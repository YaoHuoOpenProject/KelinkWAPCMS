<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Book_View_del00.aspx.cs" Inherits="KeLin.WebSite.XinZhang.Book_View_del00" %><%@ Import namespace="KeLin.ClassManager.Tool" %><%
  ...
  if (this.INFO != "OK")
   {
       ...
       strhtml.Append("<anchor><go href=\"" + http_start + "xinzhang/Book_View_del00.aspx\" method=\"post\" accept-charset=\"utf-8\">");
   ...
   else if (this.INFO == "NOPASS")
   {
    ...
    if (this.INFO != "OK")
    {
        ...
        strhtml.Append("<form name=\"f\" action=\"" + http_start + "xinzhang/Book_View_del00.aspx\" method=\"post\">");
