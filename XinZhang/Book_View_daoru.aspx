<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Book_View_daoru.aspx.cs" Inherits="KeLin.WebSite.XinZhang.Book_View_daoru" %><%@ Import namespace="KeLin.ClassManager.Tool" %><%
Response.Write(WapTool.showTop("导入勋章", wmlVo));//显示头  
  ...
  if (this.INFO != "OK")
   {
       ...
       strhtml.Append("<anchor><go href=\"" + http_start + "xinzhang/book_view_daoru.aspx\" method=\"post\" accept-charset=\"utf-8\">");
       ...
       strhtml.Append("</go>确定导入</anchor> <br/>");
   }
    ...
    //}
    strhtml.Append("<div class=\"subtitle\">导入勋章</div>");
    
 
    
    if (this.INFO == "OK")
   {
       strhtml.Append("<div class=\"tip\"><b>*导入成功！</b></div>");
   }
    else if (this.INFO == "NOFORMAT")
   {
   ...
   else if (this.INFO == "NOPASS")
   {
    ...
    if (this.INFO != "OK")
    {
        ...
        strhtml.Append("<form name=\"f\" action=\"" + http_start + "xinzhang/book_view_daoru.aspx\" method=\"post\">");
        ...
        strhtml.Append("<input type=\"submit\" name=\"\" value=\"确定导入\"/><br/>");
        strhtml.Append("</form>");
        strhtml.Append("</div>");
    }
