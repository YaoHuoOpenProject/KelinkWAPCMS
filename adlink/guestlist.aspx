<%@ Page Language="C#" AutoEventWireup="true" Codebehind="guestlist.aspx.cs" Inherits="KeLin.WebSite.adlink.guestlist" %>
                                            ...
                                            <table id="tblManageRanks" class="tableBorder" cellspacing="1" cellpadding="3" border="0"
                                                ...
                                                <tr>
                                                    <td class="column" colspan="4">
                                                        ...
                                                        <a style="cursor: hand" onclick="DoReBack()">详细记录管理</a>&nbsp;&nbsp;
                                                        <!-- <a style="cursor: hand"
                                                ...
                                                <tr>
                                                    <td class="fh" colspan="4" >
                                                        ...
                                                        广告ID：<asp:TextBox ID="TextBox4" runat="server" Width="64px"></asp:TextBox> 关键字：<asp:TextBox
                                                            ID="TextBox2" runat="server" Columns="20" MaxLength="8" Width="191px"></asp:TextBox>
                                                ...
                                                <tr>
                                                    <td class="fh" colspan="4">
                                                        ...
                                                        &nbsp;
                                                        <input id="Button1" name="" type="button" value=" 清 空 " onclick="DoDelALL()" Class="bt"/>
                                                    </td>
                                                </tr>
                                            </table>
                                            ...
                                            <asp:DataGrid ID="DataGrid1" runat="server" DataKeyField="id" AllowSorting="True"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateColumn HeaderText="栏目ID" SortExpression="classid" ItemStyle-Width="50px" HeaderStyle-CssClass="column">
                                                        <ItemTemplate>
                                                            <a href="guestlist.aspx?classid=<%#DataBinder.Eval(Container.DataItem,"classid") %>"
                                                                target="_self" title="快速进入此栏目">
                                                                <%#DataBinder.Eval(Container.DataItem,"classid")%>
                                                            </a>
                                                        </ItemTemplate>
                                                    </asp:TemplateColumn>
                                                    <asp:TemplateColumn HeaderText="广告ID" SortExpression="bookid" ItemStyle-Width="50px" HeaderStyle-CssClass="column">
                                                        <ItemTemplate>
                                                            <a href="guestlist.aspx?bookid=<%#DataBinder.Eval(Container.DataItem,"bookid") %>"
                                                                target="_self" title="查看或修改">
                                                                <%#DataBinder.Eval(Container.DataItem, "bookid")%>
                                                            </a>
                                                        </ItemTemplate>
                                                    </asp:TemplateColumn>
                                                    <asp:TemplateColumn HeaderText="用户名" SortExpression="nickname" ItemStyle-Width="100px" HeaderStyle-CssClass="column">
                                                        <ItemTemplate>
                                                            <%#DataBinder.Eval(Container.DataItem, "nickname")%>
                                                        </ItemTemplate>
                                                    </asp:TemplateColumn>
                                                    <asp:TemplateColumn HeaderText="点击时间" SortExpression="redate" ItemStyle-Width="130px" HeaderStyle-CssClass="column">
                                                        <ItemTemplate>
                                                            <%#DataBinder.Eval(Container.DataItem, "redate")%>
                                                        </ItemTemplate>
                                                    </asp:TemplateColumn>
                                                  
                                                    <asp:TemplateColumn HeaderText="手机IP/UA" ItemStyle-Width="200px" HeaderStyle-CssClass="column">
                                                        <ItemTemplate>
                                                            <%#DataBinder.Eval(Container.DataItem, "content")%>
                                                        </ItemTemplate>
                                                    </asp:TemplateColumn>
                                                    <asp:TemplateColumn HeaderText="得分/币" ItemStyle-Width="50px" HeaderStyle-CssClass="column">
                                                        <ItemTemplate>
                                                            <%#DataBinder.Eval(Container.DataItem, "myGetMoney")%>
                                                        </ItemTemplate>
                                                    </asp:TemplateColumn>
                                                </Columns>
                                            </asp:DataGrid>
