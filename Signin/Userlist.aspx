<%@ Page Language="C#" AutoEventWireup="true" Codebehind="userlist.aspx.cs"
    Inherits="KeLin.WebSite.qiandao.userlist" %>
...
<link href="/NetCSS/style.css" rel="stylesheet" type="text/css">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function DoContent() {
            window.open("/Signin/Signin.aspx?Action=Admin&Mod=index&siteid=<%=base.SiteId %>&sid=<%=base.SID %>");
            }
        function DoReBack() {
                                          ...
                                          <table id="tblManageRanks" class="tableBorder" cellspacing="1" cellpadding="3" border="0"
                                                ...
                                                <tr>
                                                    <td class="fh" colspan="4">
                                                        <input id="Button1" name="" type="button" value="参数配置" onclick="DoContent()" class="bt"/>
                                                        &nbsp;&nbsp;
