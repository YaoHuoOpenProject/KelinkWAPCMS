<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="buyMember.aspx.cs" Inherits="KeLin.WebSite.clan.buyMember" %><%@ Import namespace="KeLin.ClassManager.Tool" %><%
...
if (ver == "1")
{
    ...
    {
        strhtml.Append("<b>家族基金只有" + bookVo.clan_money + "！</b><br/>");
    ...
    {
        strhtml.Append("当前允许加入最大成员数 " + bookVo.clan_maxMemberCount + " 个<br/>");
        strhtml.Append("当前家族基金：" + bookVo.clan_money + " 个<br/>");
        strhtml.Append("<b>每增加一个成员 = " + STATE + " 个"+siteVo.sitemoneyname+"</b><br/>");
        ...
        strhtml.Append("<anchor><go href=\"" + http_start + "clan/buyMember.aspx\" method=\"post\" accept-charset=\"utf-8\">");
...
else //2.0界面
{
    ...
    strhtml.Append("<div class=\"subtitle\">购买成员数</div>");
    ...
    {
        strhtml.Append("<b>家族基金只有" + bookVo.clan_money  + "！不够呢。</b><br/>");
    ...
    if (this.INFO != "OK" && this.INFO != "CLOSE")
    {
        ...
        strhtml.Append("<form name=\"f\" action=\"" + http_start + "clan/buymember.aspx\" method=\"post\">");
