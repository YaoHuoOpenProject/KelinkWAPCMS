<%@ Page Language="C#" AutoEventWireup="true" Codebehind="systemindex.aspx.cs" Inherits="KeLin.WebSite.ring.systemindex" %>
...
d = new dTree('d');
d.add(0,-1,'<a href="systemindex.aspx?typeid=">资源分类</a>','');
                                                                        ...
                                                                        <td>
                                                                            <asp:DataGrid ID="DataGrid1" runat="server" DataKeyField="id" AllowSorting="True"
                                                                                ...
                                                                                <Columns>
                                                                                    ...
                                                                                    <asp:TemplateColumn HeaderText="歌手" SortExpression="book_author" HeaderStyle-CssClass="column">
                                                                                        <ItemTemplate>
                                                                                            <%#DataBinder.Eval(Container.DataItem, "book_author")%>
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateColumn>
                                                                                    <asp:TemplateColumn HeaderText="上传者" SortExpression="username" ItemStyle-Width="40px" HeaderStyle-CssClass="column">
                                                                                        <ItemTemplate>
                                                                                            <%#DataBinder.Eval(Container.DataItem, "username")%>( <%#DataBinder.Eval(Container.DataItem, "makerid")%>)
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateColumn>
