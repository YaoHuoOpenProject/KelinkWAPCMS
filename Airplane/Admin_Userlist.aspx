<%@ Page Language="C#" AutoEventWireup="true" Codebehind="admin_userlist.aspx.cs"
    Inherits="KeLin.WebSite.airplane.admin_userlist" %>
                                                ...
                                                <tr>
                                                    <td class="fh" colspan="2" style="width: 100%">
                                                        ...
                                                        <asp:DropDownList ID="DropDownList1" runat="server">
                                                            <asp:ListItem Value="" Selected>未选</asp:ListItem>
                                                            <asp:ListItem Value="0">审核</asp:ListItem>
                                                            <asp:ListItem Value="1">未审核</asp:ListItem>
                                                        </asp:DropDownList>栏目ID：<asp:TextBox ID="TextBox3" runat="server" Width="64px"></asp:TextBox>
                                                        航班号：<asp:TextBox ID="TextBox1" runat="server" Columns="20" MaxLength="8" Width="64px"></asp:TextBox>
                                                        备注/介绍关键字：<asp:TextBox ID="TextBox2" runat="server" Columns="20" MaxLength="8" Width="100px"></asp:TextBox>
                                            ...
                                            <asp:DataGrid ID="DataGrid1" runat="server" DataKeyField="id" AllowSorting="True"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateColumn HeaderText="栏目ID" SortExpression="classid" ItemStyle-Width="50px" HeaderStyle-CssClass="column">
                                                        <ItemTemplate>
                                                            <a href="admin_userlist.aspx?classid=<%#DataBinder.Eval(Container.DataItem,"classid") %>"
                                                    ...
                                                    <asp:TemplateColumn HeaderText="航班号" ItemStyle-Width="120px" HeaderStyle-CssClass="column">
                                                        <ItemTemplate>
                                                            <a href="viewUser.aspx?bookid=<%#DataBinder.Eval(Container.DataItem,"id") %>" target="_self"
                                                                title="查看">
