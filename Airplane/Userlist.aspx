<%@ Page Language="C#" AutoEventWireup="true" Codebehind="userlist.aspx.cs" Inherits="KeLin.WebSite.airplane.userlist" %>
...
<link href="/NetCSS/style.css" rel="stylesheet" type="text/css">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function DoEdit() {
            ...
            window.open('/airplane/admin_WAPmodify.aspx?action=go&id=' + edtHangBiaoShis + '&siteid=<%=base.SiteId %>&classid=' + toclassid + '&page=1&sid=<%=base.SID %>');         
        }
        function DoDel() {
        ...
        function DoNew() {
            ...
            window.open('/airplane/admin_WAPadd.aspx?siteid=<%=base.SiteId %>&classid=<%=this.classid %>&page=1&sid=<%=base.SID %>');         
        }
        function DoAd() {        
            window.location.href="../admin/modifyAD.aspx?systype=airplane";
        }
        function DoTop() {
            var delHangBiaoShis = GetOnChecked();
            if (delHangBiaoShis == null || delHangBiaoShis == "") {
        ...
        function DoSmall() {
            window.location.href="../admin/systemclass.aspx?systype=airplane&classid="+document.getElementById("TextBox4").value;  
        }
        function DoMyItem() {
            var delHangBiaoShis = GetOnChecked();
            if (delHangBiaoShis == null || delHangBiaoShis == "") {
                                                    ...
                                                    <tr>
                                                        <td class="fh" colspan="4">
                                                         <input id="Button8" name="" type="button" value=" 审 核 " onclick="DoCheck()" class="bt"/>                                                       
                                                            ...
                                                            <input id="Button7" name="" type="button" value="新 增" onclick="DoNew()"  class="bt"/>
                                        ...
                                        <tr>
                                            <td colspan="4" valign="top" align="left">
                                                <asp:DataGrid ID="DataGrid1" runat="server" DataKeyField="id" AllowSorting="True"
                                                    AutoGenerateColumns="False" PageSize="25" ShowFooter="True" CssClass="tableBorder"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateColumn HeaderText="栏目ID" SortExpression="classid" ItemStyle-Width="50px" HeaderStyle-CssClass="column">
                                                            <ItemTemplate>
                                                                <input type ="hidden" id="classidtemp" name ="classidtemp" value ="<%#DataBinder.Eval(Container.DataItem,"classid") %>" /><a href="userlist.aspx?classid=<%#DataBinder.Eval(Container.DataItem,"classid") %>"
                                                                    target="_self" title="快速进入此栏目">
                                                                    <%#DataBinder.Eval(Container.DataItem, "classid")%>
                                                                </a>
                                                            </ItemTemplate>
                                                        </asp:TemplateColumn>
                                                        <asp:TemplateColumn HeaderText="航班号" ItemStyle-Width="120px" HeaderStyle-CssClass="column">
                                                            <ItemTemplate>
                                                                <a href="viewUser.aspx?bookid=<%#DataBinder.Eval(Container.DataItem,"id") %>"
                                                                    target="_self" title="查看及回复">
                                                                    <%#DataBinder.Eval(Container.DataItem, "planenum")%>
                                                                </a>
                                                            </ItemTemplate>
                                                        </asp:TemplateColumn>
                                                        <asp:TemplateColumn HeaderText="机型" SortExpression="planetype" ItemStyle-Width="100px" HeaderStyle-CssClass="column">
                                                            <ItemTemplate>
                                                                <%#DataBinder.Eval(Container.DataItem, "planetype")%>
                                                            </ItemTemplate>
                                                        </asp:TemplateColumn>
                                                        <asp:TemplateColumn HeaderText="仓位" SortExpression="seattype" ItemStyle-Width="40px" HeaderStyle-CssClass="column">
                                                            <ItemTemplate>
                                                                <%#DataBinder.Eval(Container.DataItem, "seattype")%>
                                                            </ItemTemplate>
                                                        </asp:TemplateColumn>
                                                        <asp:TemplateColumn HeaderText="仓位" SortExpression="money" ItemStyle-Width="40px" HeaderStyle-CssClass="column">
                                                            <ItemTemplate>
                                                                <%#DataBinder.Eval(Container.DataItem, "money")%>
                                                            </ItemTemplate>
                                                        </asp:TemplateColumn>
                                                        <asp:TemplateColumn HeaderText="起始站" SortExpression="startCity" ItemStyle-Width="80px" HeaderStyle-CssClass="column">
                                                            <ItemTemplate>
                                                                <%#DataBinder.Eval(Container.DataItem, "startCity")%>
                                                            </ItemTemplate>
                                                        </asp:TemplateColumn>
                                                        <asp:TemplateColumn HeaderText="降落站" SortExpression="endCity" ItemStyle-Width="80px" HeaderStyle-CssClass="column">
                                                            <ItemTemplate>
                                                                <%#DataBinder.Eval(Container.DataItem, "endCity")%>
                                                            </ItemTemplate>
                                                        </asp:TemplateColumn>
                                                        <asp:TemplateColumn HeaderText="起始时间" SortExpression="starttime" ItemStyle-Width="80px" HeaderStyle-CssClass="column">
                                                            <ItemTemplate>
                                                                <%#DataBinder.Eval(Container.DataItem, "starttime")%>
                                                            </ItemTemplate>
                                                        </asp:TemplateColumn>
                                                        <asp:TemplateColumn HeaderText="降落时间" SortExpression="endtime" ItemStyle-Width="80px" HeaderStyle-CssClass="column">
                                                            <ItemTemplate>
                                                                <%#DataBinder.Eval(Container.DataItem, "endtime")%>
                                                            </ItemTemplate>
                                                        </asp:TemplateColumn>
                                                        <asp:TemplateColumn HeaderText="浏览" SortExpression="hits" ItemStyle-Width="40px" HeaderStyle-CssClass="column">
                                                            <ItemTemplate>
                                                                <%#DataBinder.Eval(Container.DataItem, "hits")%>
                                                            </ItemTemplate>
                                                        </asp:TemplateColumn>
                                                        <asp:TemplateColumn HeaderText="精华" SortExpression="isgood" ItemStyle-HorizontalAlign="Center"
                                                            ItemStyle-Width="30px" HeaderStyle-CssClass="column">
                                                            <ItemTemplate>
                                                                <img src="/NetImages/f<%#DataBinder.Eval(Container.DataItem, "isgood")%>.gif"
                                                                    alt="精华状态" />
                                                            </ItemTemplate>
                                                        </asp:TemplateColumn>
                                                        <asp:TemplateColumn HeaderText="顶置" SortExpression="istop" ItemStyle-HorizontalAlign="Center"
                                                            ItemStyle-Width="30px" HeaderStyle-CssClass="column">
                                                            <ItemTemplate>
                                                                <img src="/NetImages/f<%#DataBinder.Eval(Container.DataItem, "istop")%>.gif"
                                                                    alt="顶置状态" />
                                                            </ItemTemplate>
                                                        </asp:TemplateColumn>
