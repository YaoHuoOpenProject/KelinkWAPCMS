...
if (ver == "1")
{
    ...
    strhtml.Append("订单号：<input type=\"text\" name=\"toid" + r + "\" value=\"" + toid + "\" size=\"5\"/>");
    ...
    //strhtml.Append("<a href=\""+http_start+"airplane/admin_guestlistwap.aspx?id="+id+"&amp;classid="+classid+"&amp;siteid="+siteid+"&amp;lpage="+lpage+"&amp;rnd="+r+"&amp;sid="+sid+"\">刷新</a> ");
    ...
    for (int i = 0; (listVo != null && i < listVo.Count); i++)
    {
        ...
        strhtml.Append("[<a href=\"" + this.http_start + "airplane/admin_guestlistWAPmod.aspx?action=go&amp;id=" + listVo[i].id + "&amp;siteid=" + this.siteid + "&amp;classid=" + this.classid + "&amp;page=" + this.CurrentPage + "\">处理</a>]");
    ...
    strhtml.Append("<a href=\"" + this.http_start + "airplane/admin_userlistWAP.aspx?action=class&amp;siteid=" + siteid + "&amp;classid=" + classid + "&amp;page="+lpage+"" + "\">返回列表</a> ");
...
else //2.0界面
{
    ...
    strhtml.Append("<option value=\"0\">进行中</option>");
    strhtml.Append("</select><br/>");
    strhtml.Append("订单号：<input type=\"text\" name=\"toid\" value=\"" + toid + "\" size=\"5\"/>");
