<%@ Page Language="C#" AutoEventWireup="true" Codebehind="addUser.aspx.cs" Inherits="KeLin.WebSite.airplane.addUser" %>

<%@ Register Assembly="FreeTextBox" Namespace="FreeTextBoxControls" TagPrefix="FTB" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>新增航班预订内容</title>
                            ...
                            <td colspan="4">
                                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                        ...
                                        <td width="100%" background="../Images/main_title_02.gif">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td colspan="3" class="fh3">
                                        <img id="imgPhoto" src="" runat="server" width="50" height="50" border="0" alt="航班小图标" />
