<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Book_Search.aspx.cs" Inherits="KeLin.WebSite.airplane.Book_Search" %><%@ Import namespace="KeLin.ClassManager.Tool" %><%
Response.Write(WapTool.showTop(this.GetLang("航班搜索|航班搜索|Search"), wmlVo));//显示头 
...
strhtml.Append("<option value=\"title\">航班公司</option>");
strhtml.Append("<option value=\"author\">航班号</option>");
strhtml.Append("<option value=\"days\">N天前(输入天数)</option>");
strhtml.Append("</select><br/>");
strhtml.Append("<anchor><go href=\""+this.http_start +"airplane/book_list.aspx\" method=\"get\" accept-charset=\"utf-8\">");
...
strhtml.Append("<form id=\"form1\" action=\""+this.http_start +"airplane/book_list.aspx\" method=\"get\">");
strhtml.Append("<div class=\"subtitle\">航班搜索</div>");
