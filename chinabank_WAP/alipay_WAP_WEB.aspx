<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="alipay_WAP_WEB.aspx.cs" Inherits="KeLin.WebSite.chinabank_WAP.alipay_WAP_WEB" %><%@ Import namespace="KeLin.ClassManager.Tool" %><%
if(this.INFO =="OK"){
    wmlVo.timer = "1";
...
Response.Write(WapTool.showTop("支付宝电脑版支付", wmlVo));//显示头                                                                                                                                                                       
if (ver == "1")
{
    strhtml.Append("<p>");
    strhtml.Append(this.ERROR);

    strhtml.Append("<a href=\"" + this.http_start + "chinabank_wap/alipay_wap_web.aspx?siteid=" + this.siteid + "&amp;sid=" + this.sid1 + "-2-" + this.cs + "-" + this.lang + "-" + this.myua + "-" + this.width + "\">" + this.GetLang("进入WAP2.0支付界面|进入WAP2.0界面支付界面|wap2.0 add upfile") + "</a><br/>");
...
else //2.0界面
{
    ...
    strhtml.Append("<div class=\"subtitle\">支付宝电脑版支付</div>");
    ...
    }else if (action == "")
    {
        ...
        strhtml.Append("<br/><form name=\"f\" action=\"" + this.http_start + "chinabank_wap/alipay_wap_web_default.aspx\" method=\"get\">");
        ...
        strhtml.Append("<input type=\"hidden\" name=\"userid\" value=\"" + userid + "\"/>");
