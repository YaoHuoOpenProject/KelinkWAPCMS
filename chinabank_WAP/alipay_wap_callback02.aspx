<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="alipay_wap_callback02.aspx.cs" Inherits="KeLin.WebSite.chinabank_WAP.alipay_wap_callback02" %><%@ Import namespace="KeLin.ClassManager.Tool" %><%
Response.Write(WapTool.showTop(this.GetLang("支付结果|支付结果|pay info"), wmlVo));//显示头                                                                                                                                                                       
if (ver == "1")
{
    Response.Write("<p>");
...
else //2.0界面
{
    ...
    Response.Write("<div class=\"subtitle\">" + this.GetLang("支付结果|支付结果|pay info") + "</div>");
    Response.Write(this.ERROR);
