...
<card id="main" title="征途卡支付">
<p align="left">
<%if Cint(isclose)=1 then%>
<br/>
支付金额:<br/>
<select name="p3_Amt<%=ranNum%>" value="10.0">
<option value="10.0">10元</option>
<option value="20.0">20元</option>
<option value="30.0">30元</option>
<option value="50.0">50元</option>
<option value="60.0">60元</option>
<option value="100.0">100元</option>
<option value="300.0">300元</option>
<option value="468.0">468元</option>
</select><br/>
征途卡序列号:<br/>
...
<anchor> 马 上 支 付
 <go href="<%=http_start%>chinabank_wap/req.asp" method="post" accept-charset="utf-8">
  ...
  <postfield name="pd_FrpId" value="ZHENGTU"/>
