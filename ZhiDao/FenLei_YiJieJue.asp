...
<%
    ...
    Sub Page_Load()
        ...
        Rs.Open "SELECT [ID],[BiaoTi],[HuiDaShu] FROM [ZhiDao_WenTi] WHERE [WenTiZhuangTai]<>'0' AND [SuoShuFenLei]="&ID&" AND [siteid]="&siteid&" ORDER BY [ID] DESC",Conn,1,1
        ...
        Else
            ...
            For i=1 To 10
                ...
                Response.Write(((Page-1)*10+i)&".<a href="""&Server.HTMLEncode(ChuLiDiZhi("WenTi.asp?ID="&Rs("ID")&"&type=fly&fid="&ID&"&page="&Page))&""">"&Server.HTMLEncode(Rs("BiaoTi"))&"("&Rs("HuiDaShu")&")</a><br/>")
            ...
            If Rs.PageCount>1 Then
                ...
                If Page<Rs.PageCount Then
                    Response.Write("<a href="""&Server.HTMLEncode(ChuLiDiZhi("FenLei_YiJieJue.asp?ID="&ID&"&page="&(Page+1)))&""">[下页]</a>")
                End If
                
                If Page>1 Then
                    Response.Write("<a href="""&Server.HTMLEncode(ChuLiDiZhi("WenTi_YiJieJue.asp?ID="&ID&"&page="&(Page-1)))&""">[上页]</a>")
                End If
