...
Dim LOAD_Str
    ...
    Sub Page_Load()
        ...
        If Request.QueryString("Act")="En" Then
            ...
            Conn.Execute("UPDATE [ZhiDao_FenLei] SET [FenLeiMingChen]='"&CheckSql(FenLeiMingChen_)&"' WHERE [ID]="&ID&" AND [siteid]="&siteid)
        ...
        Else
            ...
            Rs.Open "SELECT [FenLeiMingChen] FROM [ZhiDao_FenLei] WHERE [ID]="&ID,Conn,1,1
...
<script language="JavaScript" src="../NetCSS/table.js" type="text/JavaScript"></script>
 ...
 <form method="post" action="Web_FenLei_XiuGai.asp?Act=En&ID=<%=ID %>">
            ...
            <tr>
              ...
              <td width="98%" background="/NetImages/main_title_02.gif"><table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                  ...
                  <td width="98%" height="24" valign="middle">修改分类
