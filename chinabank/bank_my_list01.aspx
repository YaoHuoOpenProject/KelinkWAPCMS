<%@ Page Language="C#" AutoEventWireup="true" Codebehind="bank_my_list01.aspx.cs" Inherits="KeLin.WebSite.chinabank.bank_my_list01" %><%@ Import namespace="KeLin.ClassManager.Tool" %>
                                                    ...
                                                    <tr>
                                                        <td class="fh" colspan="4">
                                                            ...
                                                            <asp:DropDownList ID="bankType" runat="server">
                                                                ...
                                                                <asp:ListItem Value="2">北京网银(已关闭)</asp:ListItem>
                                                            </asp:DropDownList>
                                                            ...
                                                            网站ID：<asp:TextBox ID="tositeid" runat="server" Columns="20" MaxLength="8"
                                            ...
                                            <td colspan="4" valign="top" align="left">
                                                <asp:DataGrid ID="DataGrid1" runat="server" DataKeyField="id" AllowSorting="True"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateColumn HeaderText="订单号" SortExpression="order_id" ItemStyle-HorizontalAlign="Center"
                                                            ItemStyle-Width="80px" HeaderStyle-CssClass="column">
                                                            <ItemTemplate>
                                                                <%#DataBinder.Eval(Container.DataItem, "order_id")%>
                                                            </ItemTemplate>
                                                        </asp:TemplateColumn>
                                                        <asp:TemplateColumn HeaderText="网站ID" SortExpression="siteid" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="80px"
                                                        ...
                                                        <asp:TemplateColumn HeaderText="增加天数" SortExpression="sitedates" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="80px"
                                                            HeaderStyle-CssClass="column">
                                                            <ItemTemplate>
                                                                <%#DataBinder.Eval(Container.DataItem, "sitedates")%>
                                                            </ItemTemplate>
                                                        </asp:TemplateColumn>
                                                       
                                                        <asp:TemplateColumn HeaderText="增加空间" SortExpression="sitespace" ItemStyle-Width="80px" ItemStyle-HorizontalAlign="Center" HeaderStyle-CssClass="column">
                                                            <ItemTemplate>
                                                                <%#DataBinder.Eval(Container.DataItem, "sitespace")%> M
                                                            </ItemTemplate>
                                                        </asp:TemplateColumn>
                                                         <asp:TemplateColumn HeaderText="价钱" SortExpression="money" ItemStyle-Width="40px" HeaderStyle-CssClass="column">
                                                            <ItemTemplate>
                                                        ...
                                                        <asp:TemplateColumn HeaderText="操作时间" SortExpression="add_time" ItemStyle-Width="120px"
                                                            HeaderStyle-CssClass="column">
                                                            <ItemTemplate>
                                                                <%#DataBinder.Eval(Container.DataItem, "add_time")%>
                                                            </ItemTemplate>
                                                        </asp:TemplateColumn>
                                                        <asp:TemplateColumn HeaderText="操作人" SortExpression="oper_userid" ItemStyle-Width="40px"
                                                            HeaderStyle-CssClass="column">
                                                            <ItemTemplate>
                                                                <%#DataBinder.Eval(Container.DataItem, "oper_userid")%>
                                                            </ItemTemplate>
                                                        </asp:TemplateColumn>
                                                        <asp:TemplateColumn HeaderText="结果" SortExpression="valid" ItemStyle-Width="60px"
                                                            HeaderStyle-CssClass="column">
                                                            <ItemTemplate>
                                                                <%#GetShowPic(DataBinder.Eval(Container.DataItem, "valid").ToString())%>
                                                            </ItemTemplate>
                                                        </asp:TemplateColumn>
                                                         <asp:TemplateColumn HeaderText="支付时间" SortExpression="valid_time" ItemStyle-Width="120px"
                                                            HeaderStyle-CssClass="column">
                                                            <ItemTemplate>
                                                                <%#DataBinder.Eval(Container.DataItem, "valid_time")%>
                                                            </ItemTemplate>
                                                        </asp:TemplateColumn>
                                                         <asp:TemplateColumn HeaderText="支付信息" SortExpression="valid_info" ItemStyle-Width="120px"
                                                            HeaderStyle-CssClass="column">
                                                            <ItemTemplate>
                                                                <%#DataBinder.Eval(Container.DataItem, "valid_info")%>
                                                            </ItemTemplate>
                                                        </asp:TemplateColumn>
                                                          <asp:TemplateColumn HeaderText="接口" SortExpression="banktype" ItemStyle-Width="60px"
                                                            HeaderStyle-CssClass="column">
                                                            <ItemTemplate>
                                                                <%#GetShowType(DataBinder.Eval(Container.DataItem, "banktype").ToString())%>
                                                            </ItemTemplate>
                                                        </asp:TemplateColumn>
                                                    </Columns>
                                                </asp:DataGrid>
