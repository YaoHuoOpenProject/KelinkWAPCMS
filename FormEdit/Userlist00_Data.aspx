<%@ Page Language="C#" AutoEventWireup="true" Codebehind="userlist00_Data.aspx.cs"
    Inherits="KeLin.WebSite.FormEdit.userlist00_Data" %>

<%@ Register Assembly="AspNetPager" Namespace="Wuqi.Webdiyer" TagPrefix="webdiyer" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>内容审核--表单接收内容</title>
...
<link href="/NetCSS/style.css" rel="stylesheet" type="text/css">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function DoContent() {
            window.location.href="userlist00.aspx";
            }
        function DoReBack() {
            window.location.href="userlist00_Data.aspx";        
        }
        function DoCheck() {
            var SelectNo = checkSelectNo('chkAll');
            if (SelectNo == 0) {
                                          ...
                                          <table id="tblManageRanks" class="tableBorder" cellspacing="1" cellpadding="3" border="0"
                                                ...
                                                <tr>
                                                    <td class="column" colspan="4">
                                                        &nbsp;&nbsp;<a  href="userlist00.aspx" >表单设计管理</a>&nbsp;&nbsp;&nbsp;
                                                            <a href="userlist00_data.aspx" >接收内容管理</a>&nbsp;&nbsp;</td>
                                                </tr>
                                                <tr>
                                                    <td class="fh" colspan="2" style="width: 100%">
                                                        网站ID：<asp:TextBox ID="TextBox3" runat="server" Columns="20" MaxLength="8" Width="64px"></asp:TextBox>
                                        ...
                                        <td colspan="4" valign="top" align="left">
                                            <asp:DataGrid ID="DataGrid1" runat="server" DataKeyField="id" AllowSorting="True"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateColumn HeaderText="来自栏目ID" SortExpression="classid" ItemStyle-Width="80px" HeaderStyle-CssClass="column">
                                                     ...
                                                     <asp:TemplateColumn HeaderText="表单ID" SortExpression="bookid" ItemStyle-Width="80px" HeaderStyle-CssClass="column">
                                                    ...
                                                    <asp:TemplateColumn HeaderText="内容" SortExpression="" ItemStyle-Width="250px" HeaderStyle-CssClass="column">
                                                        ...
                                                        <ItemTemplate>
                                                           <textarea name="book_content" rows="5" style="width:100%"><%#DataBinder.Eval(Container.DataItem, "formdata")%></textarea>
                                                           
                                                        </ItemTemplate>
                                                    </asp:TemplateColumn>
                                                    <asp:TemplateColumn HeaderText="操作人" SortExpression="book_content" ItemStyle-Width="200px" HeaderStyle-CssClass="column">
