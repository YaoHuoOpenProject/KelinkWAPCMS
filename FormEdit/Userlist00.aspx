<%@ Page Language="C#" AutoEventWireup="true" Codebehind="userlist00.aspx.cs"
    Inherits="KeLin.WebSite.FormEdit.userlist00" %>

<%@ Register Assembly="AspNetPager" Namespace="Wuqi.Webdiyer" TagPrefix="webdiyer" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>内容审核--表单设计</title>
                                            ...
                                            <asp:DataGrid ID="DataGrid1" runat="server" DataKeyField="id" AllowSorting="True"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateColumn HeaderText="网站ID" SortExpression="siteid" ItemStyle-Width="50px" HeaderStyle-CssClass="column">
                                                        ...
                                                        <ItemTemplate>
                                                            <a href="userlist00.aspx?tositeid=<%#DataBinder.Eval(Container.DataItem,"siteid") %>"
                                                    ...
                                                    <asp:TemplateColumn HeaderText="栏目ID" SortExpression="book_classid" ItemStyle-Width="50px" HeaderStyle-CssClass="column">
                                                        ...
                                                        <ItemTemplate>
                                                            <a href="userlist00.aspx?classid=<%#DataBinder.Eval(Container.DataItem,"book_classid") %>"
                                                    ...
                                                    <asp:TemplateColumn HeaderText="描述" SortExpression="book_content" ItemStyle-Width="200px" HeaderStyle-CssClass="column">
                                                    ...
                                                    <asp:TemplateColumn HeaderText="添加时间" SortExpression="addtime" ItemStyle-Width="120px" HeaderStyle-CssClass="column">
                                                     ...
                                                     <asp:TemplateColumn HeaderText="提交数据" SortExpression="book_submit" ItemStyle-Width="120px"
                                                            HeaderStyle-CssClass="column">
                                                            <ItemTemplate>
                                                                <%#DataBinder.Eval(Container.DataItem, "book_submit")%>
                                                                <br />
                                                                <a href="userlist00_data.aspx?bookid= <%#DataBinder.Eval(Container.DataItem, "id")%>">【查看数据】</a>
                                                            </ItemTemplate>
                                                        </asp:TemplateColumn>
                                                </Columns>
                                            </asp:DataGrid>
