<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ClassConfigAll.aspx.cs" Inherits="KeLin.WebSite.Games.egg.ClassConfigAll" %><%@ Import namespace="KeLin.ClassManager.Tool" %><%
Response.Write(WapTool.showTop(this.GetLang("砸金蛋配置|砸金蛋配置|site setup"), wmlVo));//显示头                                                                                                                                                                       
if (ver == "1")
{
    Response.Write("<p>");
    ...
    if (backtype == "wap")
    {
        Response.Write("<br/><a href=\"" + this.http_start + "games/egg/index.aspx?siteid=" + this.siteid + "&amp;classid=" + this.classid + "\">" + this.GetLang("返回上级|返回上级|Back to set") + "</a> ");
    }
...
else //2.0界面
{
    ...
    Response.Write("<div class=\"subtitle\">" + this.GetLang("砸金蛋配置|砸金蛋配置|site setup") + "</div>");
    if (this.INFO == "OK")
    {
    ...
    Response.Write("<form name=\"f\" action=\"" + http_start + "games/egg/ClassConfigAll.aspx\" method=\"post\">");
    Response.Write("[0]贫民区需要币:<br/>");
