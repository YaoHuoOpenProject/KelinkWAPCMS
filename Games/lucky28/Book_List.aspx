<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Book_List.aspx.cs" Inherits="KeLin.WebSite.Games.lucky28.Book_List" %><%@ Import namespace="KeLin.ClassManager.Tool" %><%
string title="投注记录";
...
if (ver == "1")
{
    ...
    strhtml.Append("<anchor><go href=\"" + http_start + "games/lucky28/book_list.aspx\" method=\"get\" accept-charset=\"utf-8\">");
    ...
    for (int i = 0; (listVo != null && i < listVo.Count); i++)
    {
        ...
        strhtml.Append("压" + listVo[i].typesName + "花"+listVo[i].myMoney + siteVo.sitemoneyname + ",");
        if (listVo[i].state == 1)
        {
...
else //2.0界面
{
    ...
    strhtml.Append("<form name=\"f\" aciont=\"" + http_start + "games/lucky28/book_list.aspx\" method=\"get\">");
