<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Book_List.aspx.cs" Inherits="KeLin.WebSite.Games.apple.Book_List" %><%@ Import namespace="KeLin.ClassManager.Tool" %><%
string title="投注记录";
...
if (ver == "1")
{
    ...
    strhtml.Append("<anchor><go href=\"" + http_start + "games/apple/book_list.aspx\" method=\"get\" accept-charset=\"utf-8\">");
    ...
    for (int i = 0; (listVo != null && i < listVo.Count); i++)
    {
        ...
        strhtml.Append(".第" + listVo[i].appleID + "期");
        ...
        strhtml.Append("压<b>" + listVo[i].typesName+"</b>下"+listVo[i].myMultiple+"注共" + listVo[i].myMoney + siteVo.sitemoneyname + ",");
        if (listVo[i].state == 1)
        {
