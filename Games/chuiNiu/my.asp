...
<a href="<%=http_start%>games/chuiniu/add.asp?siteid=<%=siteid%>&amp;classid=<%=classid%><%=jid2%>">我要吹牛</a><br/>
【我的牛牛】<br/>
<%
 set rsq=Server.CreateObject("ADODB.Recordset")
  ssql="select * from wap_game_chuiniu where fbz=" & userid & " and siteid="&siteid&" order by id desc"
...
response.write("<a href='"&http_start&"games/chuiniu/my.asp?siteid="&siteid&"&amp;classid="&classid&jid2&"&amp;page=" & epage+1 & "'>下页</a> ")
end if
if epage>1 then
response.write("<a href='"&http_start&"games/chuiniu/my.asp?siteid="&siteid&"&amp;classid="&classid&jid2&"&amp;page=" & epage-1 & "'>上页</a>")
end if
%>
