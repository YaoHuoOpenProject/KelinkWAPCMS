<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="admin_bet.aspx.cs" Inherits="KeLin.WebSite.Games.happyTen.admin_bet" %><%@ Import namespace="KeLin.ClassManager.Tool" %><%
...
if (ver == "1")
{
    ...
    strhtml.Append("<a href=\"" + this.http_start + "games/happyTen/classconfigall.aspx?siteid=" + this.siteid + "&amp;classid=" + this.classid + "&amp;backtype=wap\">参数配置</a>|开奖兑奖管理");
    ...
    strhtml.Append("<anchor><go href=\"" + http_start + "games/happyTen/admin_bet.aspx\" method=\"get\" accept-charset=\"utf-8\">");
    ...
    strhtml.Append("<br/>--------<br/>");
    strhtml.Append("<a href=\"" + this.http_start + "games/happyTen/book_add.aspx?siteid=" + this.siteid + "&amp;classid=" + this.classid + "\">手工添加期数</a><br/>");
    strhtml.Append("【清空所有开奖记录】<br/>");
    strhtml.Append("否|<a href=\"" + this.http_start + "games/happyTen/admin_bet.aspx?action=godel&amp;siteid=" + this.siteid + "&amp;classid=" + this.classid + "&amp;typeid=0\">是</a><br/>");
    strhtml.Append("【清空所有下注记录】<br/>");
    strhtml.Append("否|<a href=\"" + this.http_start + "games/happyTen/admin_bet.aspx?action=godel&amp;siteid=" + this.siteid + "&amp;classid=" + this.classid + "&amp;typeid=1\">是</a><br/>");
    strhtml.Append("【清空赌神记录】<br/>");
    strhtml.Append("否|<a href=\"" + this.http_start + "games/happyTen/admin_bet.aspx?action=godel&amp;siteid=" + this.siteid + "&amp;classid=" + this.classid + "&amp;typeid=2\">是</a><br/>");
    strhtml.Append("【<a href=\"" + this.http_start + "games/happyTen/rank_list_back.aspx?siteid=" + this.siteid + "&amp;classid=" + this.classid + "&amp;typeid=2\">返利操作</a>】<br/>");
    ...
    for (int i = 0; (listVo != null && i < listVo.Count); i++)
    {
        ...
        if (listVo[i].state == 0)
        {
            ...
            strhtml.Append("[<a href=\"" + this.http_start + "games/happyTen/book_modify.aspx?siteid=" + this.siteid + "&amp;classid=" + this.classid + "&amp;id=" + listVo[i].id + "\">修改</a>]");
        }
        else
        {
            ...
            if (listVo[i].state == 1)
            {
                ...
                strhtml.Append("[<a href=\"" + this.http_start + "games/happyTen/book_Win.aspx?siteid=" + this.siteid + "&amp;classid=" + this.classid + "&amp;id=" + listVo[i].id + "\">开奖</a>]");
            }
        }
        strhtml.Append("<br/>");
        kk = kk + 1;
...
else //2.0界面
{
    ...
    strhtml.Append(ERROR);
    strhtml.Append("<div class=\"subtitle\"><a href=\"" + this.http_start + "games/happyTen/classconfigall.aspx?siteid=" + this.siteid + "&amp;classid=" + this.classid + "&amp;backtype=wap&amp;sid="+this.sid+"\">参数配置</a>|开奖兑奖管理</div>");
    if (this.INFO == "OK")
    {
    ...
    strhtml.Append("<form name=\"re\" action=\"" + http_start + "games/happyTen/admin_bet.aspx\" method=\"get\">");
    ...
    for (int i = 0; (listVo != null && i < listVo.Count); i++)
    {
        ...
        if (listVo[i].state == 0)
        {
            ...
            strhtml.Append(listVo[i].years + "年第" + listVo[i].period + "期:<a href=\"" + http_start + "games/happyTen/book_list_bet.aspx?siteid=" + this.siteid + "&amp;classid=" + this.classid + "&amp;toyear=" + listVo[i].years + "&amp;content=" + listVo[i].period + "" + "\">待开奖" + "</a>(" + GamesClassManager.Tool.MarkSix_state(listVo[i].state) + ")");
            strhtml.Append("[<a href=\""+this.http_start+"games/happyTen/book_modify.aspx?siteid="+this.siteid+"&amp;classid="+this.classid+"&amp;id="+listVo[i].id+"&amp;sid="+this.sid+"\">修改</a>]");
        }
        else
        {
            strhtml.Append(listVo[i].years + "年第" + listVo[i].period + "期:<a href=\"" + http_start + "games/happyTen/book_list_bet.aspx?siteid=" + this.siteid + "&amp;classid=" + this.classid + "&amp;toyear=" + listVo[i].years + "&amp;content=" + listVo[i].period + "" + "\">" + listVo[i].ball1 + "-" + listVo[i].ball2 + "-" + listVo[i].ball3 + "-" + listVo[i].ball4 + "-" + listVo[i].ball5 + "-" + listVo[i].ball6 + "-" + listVo[i].ball7 + "-" + listVo[i].ball8 + "</a>(" + GamesClassManager.Tool.MarkSix_state(listVo[i].state) + ")");
