<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="add.aspx.cs" Inherits="KeLin.WebSite.Games.stone.add" %><%@ Import namespace="KeLin.ClassManager.Tool" %><%
...
if (ver == "1")
{
  ...
  if (this.INFO != "OK"){
      ...
      Response.Write("<input type=\"text\" name=\"mymoney" + r + "\" size=\"6\" value=\"" + min + "\"/><br/>");
      ...
      Response.Write("<anchor><go href=\"" + http_start + "games/stone/add.aspx\" method=\"post\" accept-charset=\"utf-8\">");
...
else //2.0界面
{
    ...
    if (this.INFO != "OK")
    {
        ...
        Response.Write("<form name=\"gt\" action=\"" + http_start + "games/stone/add.aspx\" method=\"post\">");
        Response.Write("您目前共有" + userVo.money + "个"+siteVo.sitemoneyname + "！<br/>");
        Response.Write("请输入您的赌注(最少"+min+"个金币,最多"+max+"个金币)*:<br/>");
        Response.Write("<input type=\"text\" name=\"mymoney\" size=\"6\" value=\"" + min + "\"/><br/>");
        Response.Write("请选择您的出招:<br/>");        
