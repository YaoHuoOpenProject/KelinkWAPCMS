<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Book_View.aspx.cs" Inherits="KeLin.WebSite.Games.stone.Book_View" %><%@ Import namespace="KeLin.ClassManager.Tool" %><%
...
if (ver == "1")
{
    ...
    {
        Response.Write("挑战方出的是[" + GamesClassManager.Tool.GetStoneType(bookVo.myStone.ToString()) + "]<br/>");
        Response.Write("应战者:" + bookVo.winNickname + "<br/>");
        Response.Write("应战出的是[" + GamesClassManager.Tool.GetStoneType(bookVo.winStone.ToString()) + "]<br/>");
        //if (type == "0")
        //{
  ...
  Response.Write("<a href=\"" + this.http_start + "games/stone/book_list.aspx?siteid=" + this.siteid + "&amp;classid=" + this.classid + "&amp;type="+type+"&amp;touserid="+touserid+"\">" + this.GetLang("返回上级|返回上级|Back to list") + "</a> ");
