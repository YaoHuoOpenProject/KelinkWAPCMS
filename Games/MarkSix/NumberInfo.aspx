<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NumberInfo.aspx.cs" Inherits="KeLin.WebSite.Games.marksix.NumberInfo" %><%@ Import namespace="KeLin.ClassManager.Tool" %><%
...
if (ver == "1")
{
    ...
    strhtml.Append("<anchor><go href=\"" + http_start + "games/MarkSix/numberinfo.aspx\" method=\"get\" accept-charset=\"utf-8\">");
...
else //2.0界面
{
    ...
    strhtml.Append("<form name=\"from1\" action=\""+this.http_start+"games/marksix/numberinfo.aspx\" method=\"get\">");
