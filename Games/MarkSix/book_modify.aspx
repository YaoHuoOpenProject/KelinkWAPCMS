<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="book_modify.aspx.cs" Inherits="KeLin.WebSite.Games.marksix.book_modify" %><%@ Import namespace="KeLin.ClassManager.Tool" %><%
...
else //2.0界面
{
    ...
    if (this.INFO != "OK")
    {
        ...
        strhtml.Append("<form name=\"re\" action=\"" + http_start + "games/marksix/book_modify.aspx\" method=\"get\">");
