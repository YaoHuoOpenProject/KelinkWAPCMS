<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="book_list.aspx.cs" Inherits="KeLin.WebSite.Games.waBao.book_list" %><%@ Import namespace="KeLin.ClassManager.Tool" %><%
...
if (ver == "1")
{
    ...
    strhtml.Append("<anchor><go href=\"" + http_start + "games/wabao/book_list.aspx\" method=\"get\" accept-charset=\"utf-8\">");
    ...
    for (int i = 0; (listVo != null && i < listVo.Count); i++)
    {
        ...
        if (listVo[i].state == 0)
        {
            strhtml.Append(listVo[i].years + "年第" + listVo[i].period + "期:<a href=\"" + http_start + "games/waBao/book_list_bet.aspx?siteid=" + this.siteid + "&amp;classid=" + this.classid + "&amp;toyear=" + listVo[i].years + "&amp;content=" + listVo[i].period + "" + "\">待开奖" + "</a>(" + GamesClassManager.Tool.MarkSix_state(listVo[i].state) + ")");
        }
        else
        {
            strhtml.Append(listVo[i].years + "年第" + listVo[i].period + "期:<a href=\"" + http_start + "games/waBao/book_list_bet.aspx?siteid=" + this.siteid + "&amp;classid=" + this.classid + "&amp;toyear=" + listVo[i].years + "&amp;content=" + listVo[i].period + "" + "\">" + listVo[i].ball1 + "," + listVo[i].ball2 + "," + listVo[i].ball3 + "|" + listVo[i].ball4 + "|" + listVo[i].ball5 + "|" + listVo[i].ball6 + " " + listVo[i].ball7 + " " + listVo[i].ball8 + "</a>(" + GamesClassManager.Tool.MarkSix_state(listVo[i].state) + ")");
        }
        strhtml.Append("<br/>");
        kk = kk + 1;
    }
...
else //2.0界面
{
    ...
    strhtml.Append("<form name=\"re\" action=\"" + http_start + "games/waBao/book_list.aspx\" method=\"get\">");
    ...
    strhtml.Append("<input type=\"submit\" name=\"go\" class=\"btn\" value=\"查询\"/></form> ");
