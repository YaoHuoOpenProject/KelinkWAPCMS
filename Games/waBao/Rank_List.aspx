<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Rank_List.aspx.cs" Inherits="KeLin.WebSite.Games.waBao.Rank_List" %><%@ Import namespace="KeLin.ClassManager.Tool" %><%
...
if (ver == "1")
{
    ...
    if (type == "0")
    {
       ...
       strhtml.Append("<a href=\"" + this.http_start + "games/waBao/Rank_list.aspx?type=0&amp;id=" + this.id + "&amp;siteid=" + this.siteid + "&amp;classid=" + this.classid + "\">胜率</a>");
    ...
    else
    {
        ...
        strhtml.Append(".<a href=\"" + this.http_start + "games/waBao/Rank_list.aspx?type=1&amp;id=" + this.id + "&amp;siteid=" + this.siteid + "&amp;classid=" + this.classid + "\">盈利</a>");
    ...
    if (base.IsCheckManagerLvl("|00|01|", ""))
    {
        ...
        {
            strhtml.Append(".<a href=\"" + this.http_start + "games/waBao/Rank_list.aspx?type=2&amp;id=" + this.id + "&amp;siteid=" + this.siteid + "&amp;classid=" + this.classid + "\">亏损</a>");
        }

        strhtml.Append(".<a href=\"" + this.http_start + "games/waBao/Rank_list_back.aspx?siteid=" + this.siteid + "&amp;classid=" + this.classid + "\">返利</a>");
