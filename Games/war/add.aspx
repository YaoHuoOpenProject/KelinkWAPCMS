<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="add.aspx.cs" Inherits="KeLin.WebSite.Games.war.add" %><%@ Import namespace="KeLin.ClassManager.Tool" %><%
...
if (ver == "1")
{
  ...
  if (this.INFO != "OK"){
      ...
      Response.Write("请输入您的赌注(" + min + "-" + max + ")*:<br/>");
      ...
      Response.Write("<option value=\"4\">地雷</option>");
      Response.Write("</select><br/>");
      Response.Write("<anchor><go href=\"" + http_start + "games/war/add.aspx\" method=\"post\" accept-charset=\"utf-8\">");
      ...
      Response.Write("<br/><a href=\"" + this.http_start + "games/war/info.aspx?siteid=" + this.siteid + "&amp;classid=" + this.classid + "\">游戏规则</a>");  
...
else //2.0界面
{
    ...
    if (this.INFO != "OK")
    {
        ...
        Response.Write("<form name=\"gt\" action=\"" + http_start + "games/war/add.aspx\" method=\"post\">");
        Response.Write("您目前共有" + userVo.money + "个"+siteVo.sitemoneyname + "！<br/>");
        Response.Write("请输入您的赌注("+min+"-"+max+")*:<br/>");
