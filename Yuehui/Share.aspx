...
Response.Write(WapTool.showTop(this.GetLang("分享约会|分享约会|share Notes"), wmlVo));//显示头 
string title = "你的好友推荐给你一个好约会《"+bookVo.yh_title+"》";
string content = "推荐给你一个好约会《"+bookVo.yh_title+"》,网址是"+http_start+"yuehui/book_view.aspx?siteid="+this.siteid+"&amp;classid="+this.classid+"&amp;id="+this.id+"";
string content2="推荐给你一个好约会《"+bookVo.yh_title+"》,[url="+http_start+"yuehui/book_view.aspx?siteid="+this.siteid+"&amp;classid="+this.classid+"&amp;id="+this.id+"]点击进入[/url]";
if(ver=="1"){
    ...
    if (downloadpath == "")
    {
        Response.Write("标题:<a href=\"" + this.http_start + "yuehui/book_view.aspx?siteid=" + this.siteid + "&amp;classid=" + this.classid + "&amp;lpage=" + this.lpage + "&amp;id=" + this.id + "\">" + bookVo.yh_title + "</a><br/>");
        //Response.Write("作者:<a href=\"" + this.http_start + "yuehui/userinfo.aspx?siteid=" + this.siteid + "&amp;touserid=" + bookVo.book_pub + "\">" + bookVo.book_author + "(ID:" + bookVo.book_pub + ")</a><br/>");
    ...
    Response.Write("<a href=\"" + this.http_start + "yuehui/Share.aspx?action=fav&amp;siteid=" + this.siteid + "&amp;classid=" + this.classid + "&amp;id=" + this.id + "&amp;lpage=" + this.lpage + "\">加入收藏/保存书签</a><br/>");
    Response.Write("----------<br/>");
    
  
    
    Response.Write("<br/><a href=\"" + this.http_start + "yuehui/book_view.aspx?siteid=" + this.siteid + "&amp;classid=" + this.classid + "&amp;lpage=" + this.lpage + "&amp;id=" + this.id + "\">" + this.GetLang("返回内容|返回内容|Back to subject") + "</a>");
    Response.Write(" <a href=\"" + this.http_start + "yuehui/book_list.aspx?siteid=" + this.siteid + "&amp;classid=" + this.classid + "&amp;page=" + this.lpage + "\">" + this.GetLang("返回列表|返回列表|Back to list") + "</a>");
    Response.Write(WapTool.GetVS(wmlVo));
    Response.Write("</p>");
    
}else{ //2.0界面

    Response.Write("<div class=\"title\">" + this.GetLang("分享约会|分享约会|share Notes") + "</div>");
    Response.Write(this.ERROR);
    if (this.INFO == "WAITING")
    {
    ...
    Response.Write("<a href=\"" + this.http_start + "yuehui/book_view.aspx?siteid=" + this.siteid + "&amp;classid=" + this.classid + "&amp;lpage=" + this.lpage + "&amp;id=" + this.id + "\">" + this.GetLang("返回内容|返回内容|Back to subject") + "</a>");
    Response.Write(" <a href=\"" + this.http_start + "yuehui/book_list.aspx?siteid=" + this.siteid + "&amp;classid=" + this.classid + "&amp;page=" + this.lpage + "\">" + this.GetLang("返回列表|返回列表|Back to list") + "</a>");
    Response.Write("</div>");
    Response.Write("</div>");
}
