...
Response.Write(WapTool.showTop(this.GetLang("查看评论|查看回複|View Reply"), wmlVo));//显示头                                                                                                                                                                       
if (ver == "1")
{
    ...
    if (this.INFO == "OK")
    {
        ...
        strhtml.Append("</b> ");
        strhtml.Append("<a href=\"" + this.http_start + "yuehui/book_view.aspx?siteid=" + siteid + "&amp;classid=" + classid + "&amp;id=" + id + "&amp;lpage=" + lpage + "" + "\">返回</a><br/>");
    }
    ...
    strhtml.Append("<a href=\""+http_start+"yuehui/book_re.aspx?id="+id+"&amp;classid="+classid+"&amp;siteid="+siteid+"&amp;lpage="+lpage+"&amp;rnd="+r+"&amp;sid="+sid+"\">刷新</a> ");
    if(userid=="0"){
        strhtml.Append("<a href=\""+http_start+"waplogin.aspx?siteid="+siteid+"&amp;sid="+sid+"&amp;backurl="+HttpUtility.UrlEncode("yuehui/book_re.aspx?action=class&siteid="+siteid+"&classid="+classid+"&id="+id)+"\">登录</a>");
    }
    strhtml.Append("<br/>");
...
else //2.0界面
{
    ...
    strhtml.Append(ERROR);
   // strhtml.Append("<div class=\"subtitle\">" + this.GetLang("查看评论|查看回複|View Reply") + "</div>");
    if (this.INFO == "OK")
    {
