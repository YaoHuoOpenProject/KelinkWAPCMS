<%@ Page Language="C#" AutoEventWireup="true" Codebehind="viewUser.aspx.cs" Inherits="KeLin.WebSite.guessbook.viewUser" %>
                                                ...
                                                <ItemTemplate>
                                                    <table class="tableBorder" id="Table1" cellspacing="1" cellpadding="3" width="100%">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="fh3a"><%# DataBinder.Eval(Container.DataItem,"book_content").ToString().Replace("[br]","<br/>")%>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </ItemTemplate>
