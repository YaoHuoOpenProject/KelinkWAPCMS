<%@ Page Language="C#" AutoEventWireup="true" Codebehind="userlist.aspx.cs" Inherits="KeLin.WebSite.guessbook.userlist" %>
...
<link href="/NetCSS/style.css" rel="stylesheet" type="text/css">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function DoEdit() {
            ...
            window.open('/guessbook/admin_WAPmodify.aspx?action=go&id=' + edtHangBiaoShis + '&siteid=<%=base.SiteId %>&classid=' + toclassid + '&page=1&sid=<%=base.SID %>');        
        }
        function DoDel() {
        ...
        function DoAd() {        
            window.location.href="../admin/modifyAD.aspx?systype=guessbook";
        }
        function DoTop() {
            var delHangBiaoShis = GetOnChecked();
            if (delHangBiaoShis == null || delHangBiaoShis == "") {
        ...
        function DoSmall() {
            window.location.href="../admin/systemclass.aspx?systype=guessbook&classid="+document.getElementById("TextBox4").value;  
        }
        function DoMyItem() {
            var delHangBiaoShis = GetOnChecked();
            if (delHangBiaoShis == null || delHangBiaoShis == "") {
                                                ...
                                                <table id="tblManageRanks" class="tableBorder" cellspacing="1" cellpadding="3" border="0"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <input id="Button8" name="" type="button" value=" 审 核 " onclick="DoCheck()" class="bt"/>                                                       
                                                            ...
                                                            <input id="Button7" name="" type="button" value="栏目属性设置" onclick="window.open('/guessbook/classconfigall.aspx?classid=<%=this.classid %>&siteid=<%=base.SiteId %>&page=1&sid=<%=base.SID %>');" class="bt"/>
                                                            <input id="Button5" name="" type="button" value="插放广告" onclick="DoAd()" Class="bt"/>
                                                       
                                                            <input id="Button11" name="" type="button" value="新 增" onclick="window.open('/guessbook/admin_WAPadd.aspx?action=class&siteid=<%=base.SiteId %>&classid=<%=this.classid %>&page=&sid=<%=base.SID %>');" Class="bt" />
                                            ...
                                            <td colspan="4" valign="top" align="left">
                                                <asp:DataGrid ID="DataGrid1" runat="server" DataKeyField="id" AllowSorting="True"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateColumn HeaderText="悄悄话" SortExpression="ishidden" ItemStyle-Width="80px" HeaderStyle-CssClass="column">
                                                            <ItemTemplate>
                                                                <img src="/NetImages/f<%#DataBinder.Eval(Container.DataItem, "ishidden")%>.gif" alt="." />
                                                            </ItemTemplate>
                                                        </asp:TemplateColumn>
