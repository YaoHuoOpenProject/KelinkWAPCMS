<%@ Page Language="C#" AutoEventWireup="true" Codebehind="userlist4.aspx.cs" Inherits="KeLin.WebSite.novel.userlist4" %>
                                                ...
                                                <asp:DataGrid ID="DataGrid1" runat="server" DataKeyField="id" AllowSorting="True"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateColumn HeaderText="操作"  ItemStyle-Width="100px"
                                                            HeaderStyle-CssClass="column">
                                                            <ItemTemplate>
                                                          <input id="Button6" name="" type="button" value=" 修 改 " onclick="window.open('/novel/admin_WAPadd4.aspx?action=go&bookid=<%#DataBinder.Eval(Container.DataItem, "bookid")%>&id=<%#DataBinder.Eval(Container.DataItem, "id")%>&siteid=<%=base.SiteId %>&classid=0&page=1&sid=<%=base.SID %>');" class="bt" /><br />
                                                            </ItemTemplate>
                                                        </asp:TemplateColumn>
                                                    </Columns>
                                                </asp:DataGrid>
