<%@ Page Language="C#" AutoEventWireup="true" Codebehind="userlist2.aspx.cs" Inherits="KeLin.WebSite.novel.userlist2" %>
                                    ...
                                    <tbody>
                                                ...
                                                <table id="tblManageRanks" class="tableBorder" cellspacing="1" cellpadding="3" border="0"
                                                    ...
                                                    <tr>
                                                        <td class="fh" colspan="4">
                                                            书本ID：<asp:TextBox ID="TextBox4" runat="server" Columns="20" MaxLength="8"
                                                                Width="64px"></asp:TextBox>
                                                           分卷关键字：<asp:TextBox ID="TextBox5" runat="server" Columns="20" MaxLength="8" Width="156px"></asp:TextBox>
                                                            <asp:Button ID="bt_DoSearch" Width="60" Text='查 询' runat="server" OnClick="bt_DoSearch_Click" CssClass="bt">
                                                            </asp:Button>
                                                            <input type ="hidden" name="classid" value ="<%=this.classid %>" />
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td class="fh" colspan="4">
                                                       
                                                           <input id="Button2" name="" type="button" value="添加分卷" onclick="window.open('/novel/admin_WAPadd2.aspx?num=2&action=go&bookid=<%=this.bookid%>&classid=0&siteid=<%=base.SiteId %>&page=1&sid=<%=base.SID %>');" class="bt"/>
                                        ...
                                        <tr>
                                            <td colspan="4" valign="top" align="left">
                                                <asp:DataGrid ID="DataGrid1" runat="server" DataKeyField="VolumeID" AllowSorting="True"
                                                    ...
                                                    <Columns>
                                                        <asp:TemplateColumn HeaderStyle-CssClass="column">
                                                            ...
                                                            <ItemTemplate>
                                                                <input type="checkbox" name="chkSelect" value='<%# DataBinder.Eval(Container.DataItem, "VolumeID") %>'
                                                        ...
                                                        <asp:TemplateColumn HeaderText="书本ID" SortExpression="bookid" 
                                                            HeaderStyle-CssClass="column">
                                                            <ItemTemplate>
                                                             <input type ="hidden" id="classidtemp" name ="classidtemp" value ="<%#DataBinder.Eval(Container.DataItem,"volumeid") %>" />
                                                                    <%#DataBinder.Eval(Container.DataItem, "bookid")%>
                                                                
                                                            </ItemTemplate>
                                                        </asp:TemplateColumn>
                                                        <asp:TemplateColumn HeaderText="分卷名称" SortExpression="VolumeName" HeaderStyle-CssClass="column">
                                                            <ItemTemplate>
                                                                <%#DataBinder.Eval(Container.DataItem, "VolumeName")%>
                                                            </ItemTemplate>
                                                        </asp:TemplateColumn>
                                                        
                                                        
                                                        <asp:TemplateColumn HeaderText="排序号" SortExpression="VolumeNum" HeaderStyle-CssClass="column">
                                                            <ItemTemplate>
                                                                <%#DataBinder.Eval(Container.DataItem, "orderNum")%>   
                                                            </ItemTemplate>
                                                        </asp:TemplateColumn>
                                                        
                                                        <asp:TemplateColumn HeaderText="操作"   HeaderStyle-CssClass="column" ItemStyle-Width="160px">
                                                            <ItemTemplate>
                                                              <input id="Button2" name="" type="button" value="添加分卷" onclick="window.open('/novel/admin_WAPadd2.aspx?num=2&action=go&bookid=<%#DataBinder.Eval(Container.DataItem, "bookid")%>&classid=<%=this.classid %>&siteid=<%=base.SiteId %>&page=1&sid=<%=base.SID %>');" class="bt"/>
                                                                 <input id="Button6" name="" type="button" value="修 改 " onclick="window.open('/novel/admin_WAPadd2.aspx?num=2&action=go&bookid=<%#DataBinder.Eval(Container.DataItem, "bookid")%>&id=<%#DataBinder.Eval(Container.DataItem, "volumeId")%>&classid=<%=this.classid %>&siteid=<%=base.SiteId %>&page=1&sid=<%=base.SID %>');"class="bt" />
