<%@ Page Language="C#" AutoEventWireup="true" Codebehind="userlist3.aspx.cs" Inherits="KeLin.WebSite.novel.userlist3" %>
...
<link href="/NetCSS/style.css" rel="stylesheet" type="text/css">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function GetOnChecked() {
            ...
            var uprank = document.getElementsByName('uprank');
            var myrank = document.getElementsByName('myrank');
            var n = a.length;
            //alert(n);			
            for (var i = 0; i < n; i++) {
                if (a[i].checked) {
                    ...
                    varmyrank = varmyrank + sChar + myrank[i].value;
                    sChar = ',';
                }

            }
            uprank.value = varmyrank;
            ...
            <tbody>
                                    ...
                                    <tbody>
                                                ...
                                                <table id="tblManageRanks" class="tableBorder" cellspacing="1" cellpadding="3" border="0"
                                                    ...
                                                    <tr>
                                                        <td class="column" colspan="4" align="left">
                                                            &nbsp;&nbsp;
                                                            <a style="cursor: hand" onclick="window.location.href='userlist.aspx?classid=0';">书本管理</a>&nbsp;&nbsp;
                                                            <a style="cursor: hand" onclick="window.location.href='userlist2.aspx?classid='+document.getElementById('TextBox4').value;">分卷管理</a>&nbsp;&nbsp; 
                                                            <a style="cursor: hand" onclick="window.location.href='userlist3.aspx?classid='+document.getElementById('TextBox4').value;"">目录章节管理</a>&nbsp;&nbsp; 
                                                            <a style="cursor: hand" onclick="window.location.href='userlist4.aspx?classid='+document.getElementById('TextBox4').value;"">回复管理</a>&nbsp;&nbsp; 
                                                    ...
                                                    <tr>
                                                        <td class="fh" colspan="4">
                                                            ...
                                                            </asp:DropDownList>书本ID：<asp:TextBox ID="TextBox4" runat="server" Columns="20" MaxLength="8"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <input id="Button3" name="" type="button" value=" 审 核 " onclick="DoCheck()" class="bt"/>                                                       
                                                            ...
                                                            <input id="Button2" name="" type="button" value="添加本书章节" onclick="window.open('/novel/admin_WAPadd3.aspx?action=go&bookid=<%=this.bookid%>&classid=0&siteid=<%=base.SiteId %>&page=1&sid=<%=base.SID %>');" class="bt"/>
                                                           
                                                            
                                                            <input id="Button4" name="" type="button" value="删 除" onclick="DoDel()" class="bt"/>
                                                  
                                                             <input id="Button1" name="" type="button" value="采集接口" onclick="window.open('/novel/admin_WAPadd5.aspx?num=2&action=go&classid=<%=this.classid %>&siteid=<%=base.SiteId %>&page=1&sid=<%=base.SID %>');" class="bt"/>
                                                            
                                                           <input id="Button7" name="" type="button" value="批量更新排序号" onclick="DoRank()" class="bt"/>
                                        ...
                                        <tr>
                                            <td colspan="4" valign="top" align="left">
                                                <asp:DataGrid ID="DataGrid1" runat="server" DataKeyField="SectionId" AllowSorting="True"
                                                    ...
                                                    <Columns>
                                                        <asp:TemplateColumn HeaderStyle-CssClass="column">
                                                            ...
                                                            <ItemTemplate>
                                                                <input type="checkbox" name="chkSelect" value='<%# DataBinder.Eval(Container.DataItem, "sectionid") %>'
                                                        ...
                                                        <asp:TemplateColumn HeaderText="书本ID" SortExpression="bookid" ItemStyle-Width="50px"
                                                            ...
                                                            <ItemTemplate>
                                                                <input type ="hidden" id="classidtemp" name ="classidtemp" value ="<%#DataBinder.Eval(Container.DataItem,"bookid") %>" /><a href="userlist3.aspx?classid=<%#DataBinder.Eval(Container.DataItem,"bookid") %>"
                                                        ...
                                                        <asp:TemplateColumn HeaderText="章节ID" HeaderStyle-CssClass="column" ItemStyle-Width="50px">
                                                         ...
                                                         <asp:TemplateColumn HeaderText="章节名称" HeaderStyle-CssClass="column"  ItemStyle-Width="200px">
                                                            <ItemTemplate>
                                                        ...
                                                        <asp:TemplateColumn HeaderText="查看内容"  HeaderStyle-CssClass="column">
                                                            <ItemTemplate>
                                                               <a href="<%#DataBinder.Eval(Container.DataItem, "contentURL")%>" target="_blank" > <%#DataBinder.Eval(Container.DataItem, "contentURL")%> </a>
                                                            </ItemTemplate>
                                                        </asp:TemplateColumn>
                                                        <asp:TemplateColumn HeaderText="字数" SortExpression="charNum" HeaderStyle-CssClass="column">
                                                            <ItemTemplate>
                                                                <%#DataBinder.Eval(Container.DataItem, "charNum")%>
                                                            </ItemTemplate>
                                                        </asp:TemplateColumn>
                                                        <asp:TemplateColumn HeaderText="回复" SortExpression="book_re" HeaderStyle-CssClass="column">
                                                            <ItemTemplate>
                                                               <%#DataBinder.Eval(Container.DataItem, "book_re")%>
                                                            </ItemTemplate>
                                                        </asp:TemplateColumn>
                                                        <asp:TemplateColumn HeaderText="排序号" SortExpression="rank" ItemStyle-Width="40px"
                                                            HeaderStyle-CssClass="column">
                                                            <ItemTemplate>
                                                                <input type="text" name="myrank" value ="<%#DataBinder.Eval(Container.DataItem, "rank")%>" size="5" />
                                                            </ItemTemplate>
                                                        </asp:TemplateColumn>
                                                        <asp:TemplateColumn HeaderText="更新时间" SortExpression="addtime" ItemStyle-Width="100px"
                                                            HeaderStyle-CssClass="column">
                                                            <ItemTemplate>
                                                                <%#DataBinder.Eval(Container.DataItem, "addtime")%>
                                                            </ItemTemplate>
                                                        </asp:TemplateColumn>
                                                        <asp:TemplateColumn HeaderText="操作"  ItemStyle-Width="100px"
                                                            HeaderStyle-CssClass="column">
                                                            <ItemTemplate>
                                                           <input id="Button2" name="" type="button" value="添加本书章节" onclick="window.open('/novel/admin_WAPadd3.aspx?action=go&bookid=<%#DataBinder.Eval(Container.DataItem, "bookid")%>&classid=0&siteid=<%=base.SiteId %>&page=1&sid=<%=base.SID %>');" class="bt"/><br />
                                                            <input id="Button6" name="" type="button" value="修改此行内容" onclick="window.open('/novel/admin_WAPadd3.aspx?action=go&bookid=<%#DataBinder.Eval(Container.DataItem, "bookid")%>&id=<%#DataBinder.Eval(Container.DataItem, "sectionid")%>&siteid=<%=base.SiteId %>&classid=0&page=1&sid=<%=base.SID %>');" class="bt" /><br />
                                                           <input id="Button5" name="" type="button" value="续传此行内容" onclick="window.open('/novel/admin_WAPadd3_add.aspx?action=go&bookid=<%#DataBinder.Eval(Container.DataItem, "bookid")%>&id=<%#DataBinder.Eval(Container.DataItem, "sectionid")%>&siteid=<%=base.SiteId %>&classid=0&page=1&sid=<%=base.SID %>');" class="bt" />
                                                            </ItemTemplate>
                                                        </asp:TemplateColumn>
                                                    </Columns>
                                                </asp:DataGrid>
                ...
                <tr>
                    <td colspan="2">
                        ...
                        <input type="hidden" id="uprank" name="uprank" />
                    </td>
                </tr>
                <tr>
                    <td align="center">
