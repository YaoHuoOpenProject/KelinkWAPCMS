<%@ Page Language="C#" AutoEventWireup="true" Codebehind="userlist.aspx.cs" Inherits="KeLin.WebSite.novel.userlist" %>
...
<link href="/NetCSS/style.css" rel="stylesheet" type="text/css">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function DoEdit() {
            ...
            window.open('/novel/admin_WAPadd.aspx?action=go&id=' + edtHangBiaoShis + '&siteid=<%=base.SiteId %>&classid=' + toclassid + '&page=1&sid=<%=base.SID %>');
                                                ...
                                                <table id="tblManageRanks" class="tableBorder" cellspacing="1" cellpadding="3" border="0"
                                                    ...
                                                    <tr>
                                                        <td class="column" colspan="4" align="left">
                                                            &nbsp;&nbsp;
                                                            <a style="cursor: hand" onclick="window.location.href='userlist.aspx?classid='+document.getElementById('TextBox4').value;">书本管理</a>&nbsp;&nbsp;
                                                    ...
                                                    <tr>
                                                        <td class="fh" colspan="4">
                                                           ...
                                                           书名关键字：<asp:TextBox ID="TextBox5" runat="server" Columns="20" MaxLength="8" Width="156px"></asp:TextBox>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <input id="Button3" name="" type="button" value=" 审 核 " onclick="DoCheck()" class="bt"/>                                                       
                                                            ...
                                                            <input id="Button12" name="" type="button" value="更多栏目属性设置" onclick="window.open('/novel/classconfigall.aspx?classid=<%=this.classid %>&siteid=<%=base.SiteId %>&page=1&sid=<%=base.SID %>');" class="bt"/>
                                                            <input id="Button5" name="" type="button" value="插放广告" onclick="DoAd()"class="bt" />
                                                           
                                                            <input id="Button2" name="" type="button" value="添加书本" onclick="window.open('/novel/admin_WAPadd.aspx?num=2&action=go&classid=<%=this.classid %>&siteid=<%=base.SiteId %>&page=1&sid=<%=base.SID %>');" class="bt"/>
                                            ...
                                            <td colspan="4" valign="top" align="left">
                                                <asp:DataGrid ID="DataGrid1" runat="server" DataKeyField="id" AllowSorting="True"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateColumn HeaderText="WAP" HeaderStyle-CssClass="column" ItemStyle-Width="80px">
                                                            <ItemTemplate>
                                                                <a href="/novel/book_listsect.aspx?siteid=<%#DataBinder.Eval(Container.DataItem,"siteid") %>&classid=<%#DataBinder.Eval(Container.DataItem,"book_classid") %>&bookid=<%#DataBinder.Eval(Container.DataItem,"id") %>&sid=-2-0-0-0-480"
                                                                    target="_blank" title="查看小说书本及回复">
                                                                    查看(ID<%#DataBinder.Eval(Container.DataItem,"id") %>)
                                                                </a>
                                                            </ItemTemplate>
                                                        </asp:TemplateColumn>
                                                         <asp:TemplateColumn HeaderText="书名" HeaderStyle-CssClass="column"  ItemStyle-Width="200px">
                                                            <ItemTemplate>
                                                                <a href="/novel/book_listsect.aspx?siteid=<%#DataBinder.Eval(Container.DataItem,"siteid") %>&classid=<%#DataBinder.Eval(Container.DataItem,"book_classid") %>&bookid=<%#DataBinder.Eval(Container.DataItem,"id") %>&sid=-2-0-0-0-480"
                                                                    target="_blank" title="查看小说书本及回复">
                                                        ...
                                                        <asp:TemplateColumn HeaderText="分卷" SortExpression="VolumeNum" HeaderStyle-CssClass="column">
                                                            <ItemTemplate>
                                                               分卷(<%#DataBinder.Eval(Container.DataItem, "VolumeNum")%>) <a href="userlist2.aspx?classid=<%#DataBinder.Eval(Container.DataItem, "book_classid")%>&bookid=<%#DataBinder.Eval(Container.DataItem, "id")%>">管理</a>
                                                            </ItemTemplate>
                                                        </asp:TemplateColumn>
                                                        <asp:TemplateColumn HeaderText="目录" SortExpression="SectionsNum" HeaderStyle-CssClass="column">
                                                            <ItemTemplate>
                                                                目录(<%#DataBinder.Eval(Container.DataItem, "SectionsNum")%>) <a href="userlist3.aspx?classid=<%#DataBinder.Eval(Container.DataItem, "book_classid")%>&bookid=<%#DataBinder.Eval(Container.DataItem, "id")%>">管理</a>
                                                            </ItemTemplate>
                                                        </asp:TemplateColumn>
                                                        <asp:TemplateColumn HeaderText="回复" SortExpression="book_re" HeaderStyle-CssClass="column">
                                                            <ItemTemplate>
                                                               回复(<%#DataBinder.Eval(Container.DataItem, "book_re")%>) <a href="userlist4.aspx?classid=<%#DataBinder.Eval(Container.DataItem, "book_classid")%>&bookid=<%#DataBinder.Eval(Container.DataItem, "id")%>">管理</a>
                                                            </ItemTemplate>
                                                        </asp:TemplateColumn>
                                                        ...
                                                        <asp:TemplateColumn HeaderText="更新时间" SortExpression="lastupdatetime" ItemStyle-Width="120px"
                                                            HeaderStyle-CssClass="column">
                                                            <ItemTemplate>
