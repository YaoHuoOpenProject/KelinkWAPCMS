<%@ Page Language="C#" AutoEventWireup="true" Codebehind="userlist00.aspx.cs" Inherits="KeLin.WebSite.novel.userlist00" %>
                                                    ...
                                                    <tr>
                                                        <td class="fh" colspan="4">
                                                            ...
                                                            <asp:DropDownList ID="DropDownList1" runat="server">
                                                                ...
                                                                Width="64px"></asp:TextBox>栏目ID：<asp:TextBox ID="TextBox4" runat="server" Columns="20" MaxLength="8"
                                                ...
                                                <asp:DataGrid ID="DataGrid1" runat="server" DataKeyField="id" AllowSorting="True"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateColumn HeaderText="分卷" SortExpression="VolumeNum" HeaderStyle-CssClass="column">
                                                            <ItemTemplate>
                                                               分卷(<%#DataBinder.Eval(Container.DataItem, "VolumeNum")%>) <a href="userlist002.aspx?classid=<%#DataBinder.Eval(Container.DataItem, "book_classid")%>&bookid=<%#DataBinder.Eval(Container.DataItem, "id")%>">管理</a>
                                                            </ItemTemplate>
                                                        </asp:TemplateColumn>
                                                        <asp:TemplateColumn HeaderText="目录" SortExpression="SectionsNum" HeaderStyle-CssClass="column">
                                                            <ItemTemplate>
                                                                目录(<%#DataBinder.Eval(Container.DataItem, "SectionsNum")%>) <a href="userlist003.aspx?classid=<%#DataBinder.Eval(Container.DataItem, "book_classid")%>&bookid=<%#DataBinder.Eval(Container.DataItem, "id")%>">管理</a>
                                                            </ItemTemplate>
                                                        </asp:TemplateColumn>
                                                        <asp:TemplateColumn HeaderText="回复" SortExpression="book_re" HeaderStyle-CssClass="column">
                                                            <ItemTemplate>
                                                               回复(<%#DataBinder.Eval(Container.DataItem, "book_re")%>) <a href="userlist004.aspx?classid=<%#DataBinder.Eval(Container.DataItem, "book_classid")%>&bookid=<%#DataBinder.Eval(Container.DataItem, "id")%>">管理</a>
                                                            </ItemTemplate>
                                                        </asp:TemplateColumn>
