<%@ Page Language="C#" AutoEventWireup="true" Codebehind="msglist00.aspx.cs" Inherits="KeLin.WebSite.WeiXin.msglist00" %><%@ Import namespace="KeLin.ClassManager.Tool" %>
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateColumn HeaderText="ID" SortExpression="id" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="40px" HeaderStyle-CssClass="column">
                                                         ...
                                                         <asp:TemplateColumn HeaderText="网站ID" SortExpression="siteid" ItemStyle-HorizontalAlign="Center"
                                                            ...
                                                            <ItemTemplate>
                                                                <%#DataBinder.Eval(Container.DataItem, "siteid").ToString()%>
                                                        ...
                                                        <asp:TemplateColumn HeaderText="请求次数" SortExpression="sendtimes" ItemStyle-Width="60px" ItemStyle-HorizontalAlign="Center" HeaderStyle-CssClass="column">
                                                            <ItemTemplate>
