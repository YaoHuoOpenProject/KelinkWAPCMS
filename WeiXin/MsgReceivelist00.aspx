                                            ...
                                            <td colspan="4">
                                                <table id="tblManageRanks" class="tableBorder" cellspacing="1" cellpadding="3" border="0"
                                                    ...
                                                    <tr>
                                                        ...
                                                        网站ID：<asp:TextBox ID="tositeid" runat="server" Columns="20" MaxLength="8" Width="80px"></asp:TextBox>
                                                ...
                                                <asp:DataGrid ID="DataGrid1" runat="server" DataKeyField="id" AllowSorting="True"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateColumn HeaderText="消息内容"   ItemStyle-Width="320px" ItemStyle-HorizontalAlign="Center"
                                                         ...
                                                         <asp:TemplateColumn HeaderText="发送时间"  SortExpression="addtime" HeaderStyle-CssClass="column" ItemStyle-Width="120px" ItemStyle-HorizontalAlign="left">
                                                            <ItemTemplate>                                                                
