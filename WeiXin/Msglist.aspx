<%@ Page Language="C#" AutoEventWireup="true" Codebehind="msglist.aspx.cs" Inherits="KeLin.WebSite.WeiXin.msglist" %><%@ Import namespace="KeLin.ClassManager.Tool" %>
...
<link href="/NetCSS/style.css" rel="stylesheet" type="text/css">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function DoCheck2() {
            ...
            document.getElementById("hidHangBiaoShis").value = locHangBiaoShis;
            document.getElementById("CommandType").value = "Check2";
            document.getElementById("form1").submit();
        }
        function DoUnCheck() {
            var SelectNo = checkSelectNo('chkAll');
                                                    ...
                                                    <tr>
                                                        <td class="fh" colspan="4">
                                                            ...
                                                            <asp:DropDownList ID="DropDownList2" runat="server">
                                                                <asp:ListItem Value="">所有</asp:ListItem>                                                               
                                                                <asp:ListItem Value="1">加关注时回消息</asp:ListItem>     
                                                                <asp:ListItem Value="2">无法匹配时回消息</asp:ListItem>                                                              
                                                            </asp:DropDownList>
                                                            
                                                            标题内容：<asp:TextBox ID="title" runat="server" Columns="20" MaxLength="8"
                                                                Width="64px"></asp:TextBox>
                                                            关键字：<asp:TextBox ID="keyword" runat="server" Columns="20" MaxLength="8" Width="80px"></asp:TextBox>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <%if (typename == "")
                                                          { %>
                                                            ...
                                                            <input id="Button5" name="" type="button" value=" 设为加关注时回的消息 " onclick="DoCheck()" class="bt"/>                                                       
                                                            <input id="Button2" name="" type="button" value=" 设为无匹配时回的消息 " onclick="DoCheck2()" class="bt"/>                                                       
                                                            
                                                            <input id="Button7" name="" type="button" value="添加文本消息" onclick="DoNew(0)" class="bt"/>
                                                         
                                                            <input id="Button1" name="" type="button" value="添加图文消息" onclick="DoNew(1)" class="bt"/>
                                                           ...
                                                           <font color="red"><b>请在看中消息记录ID下面，点击【导入】</b></font>
                                                             <%}%>
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateColumn HeaderText="ID" SortExpression="id" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="40px" HeaderStyle-CssClass="column">
                                                            <ItemTemplate>
                                                               ...
                                                               <%if (typename != "")
                                                                 { %>
                                                                 <input id="Button1" name="" type="button" value="【导入】" onclick="eval (window.opener.document.form1.<%=typename %>.value ='<%#DataBinder.Eval(Container.DataItem, "id")%>')" class="bt"/>
                                                        ...
                                                        <asp:TemplateColumn HeaderText="消息类型" SortExpression="msgtype" ItemStyle-HorizontalAlign="Center"
                                                            ...
                                                            <ItemTemplate>
                                                                <%#GetDefault(DataBinder.Eval(Container.DataItem, "defaultType").ToString())%>
                                                                
                                                                <img src="images/txt<%#DataBinder.Eval(Container.DataItem, "msgType")%>.gif" alt="消息类别" />
                                                            </ItemTemplate>
                                                        </asp:TemplateColumn>
                                                        <asp:TemplateColumn HeaderText="关键字"  ItemStyle-Width="150px" ItemStyle-HorizontalAlign="Center"
                                                            HeaderStyle-CssClass="column">
                                                            <ItemTemplate>
                                                               <textarea rows="9" name="S1" cols="18"><%#DataBinder.Eval(Container.DataItem, "keyword")%></textarea>
                                                        ...
                                                        <asp:TemplateColumn HeaderText="消息内容"   ItemStyle-Width="320px" ItemStyle-HorizontalAlign="Center"
                                                            HeaderStyle-CssClass="column">
                                                            <ItemTemplate>
                                                            <%#GetLayout(DataBinder.Eval(Container.DataItem, "msgType").ToString(), DataBinder.Eval(Container.DataItem, "title").ToString(), DataBinder.Eval(Container.DataItem, "description").ToString(), DataBinder.Eval(Container.DataItem, "picurl").ToString(), DataBinder.Eval(Container.DataItem, "url").ToString())%>
                                                                                                                           
                                                            </ItemTemplate>
                                                        </asp:TemplateColumn>
                                                       
                                                        <asp:TemplateColumn HeaderText="发送次数" SortExpression="sendtimes" ItemStyle-Width="60px" ItemStyle-HorizontalAlign="Center" HeaderStyle-CssClass="column">
                                                            <ItemTemplate>
                                                                <%#(DataBinder.Eval(Container.DataItem, "sendtimes").ToString())%>
                                                            </ItemTemplate>
                                                        </asp:TemplateColumn>
                                                         <asp:TemplateColumn HeaderText="创建时间"  SortExpression="addtime" HeaderStyle-CssClass="column" ItemStyle-Width="120px" ItemStyle-HorizontalAlign="left">
                                                            <ItemTemplate>
                                                                
                                                                    创建人ID:<br /><%#DataBinder.Eval(Container.DataItem, "makeid")%>
                                                                    <br /><br />
                                                                     创建时间:<br /><%#DataBinder.Eval(Container.DataItem, "addtime")%>
                                                                </a>
                                                            </ItemTemplate>
                                                        </asp:TemplateColumn>
                                                        ...
                                                        <asp:TemplateColumn HeaderText="操作"  ItemStyle-Width="180px"  ItemStyle-HorizontalAlign="left"
                                                            ...
                                                            <ItemTemplate>
                                                               ...
                                                               【<a href="javascript:alert('由于权限限制，只能登录微信官方后台：【功能】→【群发功能】');">群发本条消息</a>】
                                                                <br /> <br />
                                                                上次群发时间：<br /><%#DataBinder.Eval(Container.DataItem, "sendMassTime")%>
                                                                <br /> <br />
                                                                【<a href="javascript:Edit(<%#DataBinder.Eval(Container.DataItem, "id")%>,<%#DataBinder.Eval(Container.DataItem, "msgType")%>);">修改本条消息</a>】
