<%@ Page Language="C#" AutoEventWireup="true" Codebehind="viewUser.aspx.cs" Inherits="KeLin.WebSite.download.viewUser" %>
                                ...
                                <tbody>
                                    <tr>
                                        <td colspan="4" >
                                                ...
                                                <ItemTemplate>
                                                        ...
                                                        <tr>
                                                            <td class="f" colspan="2">
                                                                ...
                                                                </b>&nbsp;&nbsp;&nbsp; 发表时间:<b><%# DataBinder.Eval(Container.DataItem,"book_date")%></b>&nbsp;&nbsp;&nbsp;
                                                                    回复数: <b>
                                                        ...
                                                        <tr>
                                                            <td class="fh3a">
                                                                &nbsp;<a href="<%#DataBinder.Eval(Container.DataItem,"book_file") %>" target="_blank"
                                                                    title="下载附件"><%#DataBinder.Eval(Container.DataItem, "book_title")%>(<%#DataBinder.Eval(Container.DataItem, "book_ext")%>/<%#DataBinder.Eval(Container.DataItem, "book_size")%>/已下载:<%#DataBinder.Eval(Container.DataItem, "book_click")%>)</a>
                                                            </td>
                                                            <td>
                                                                &nbsp;</td>
                                                        </tr>
                                            ...
                                            <!-- Repeater End-->
                                            <!--快捷编辑 by Saufu
                                            <table id="Table10" cellspacing="0" cellpadding="0" width="934" border="0" style="width: 100%;
                                                height: 225px">
                                                <tbody>
                                                    <tr>
                                                        <td valign="top" align="center" width="100%">
