<%@ Page Language="C#" AutoEventWireup="true" Codebehind="guestlist.aspx.cs" Inherits="KeLin.WebSite.download.guestlist" %>
                                            ...
                                            <table id="tblManageRanks" class="tableBorder" cellspacing="1" cellpadding="3" border="0"
                                                ...
                                                <tr>
                                                    ...
                                                    审核状态：
                                                        ...
                                                        下载ID：<asp:TextBox ID="TextBox4" runat="server" Width="64px"></asp:TextBox>标题/内容关键字：<asp:TextBox
                                        ...
                                        <td colspan="4" valign="top" align="left">
                                            <asp:DataGrid ID="DataGrid1" runat="server" DataKeyField="id" AllowSorting="True"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateColumn HeaderText="下载ID" SortExpression="bookid" ItemStyle-Width="50px" HeaderStyle-CssClass="column">
                                                        <ItemTemplate>
