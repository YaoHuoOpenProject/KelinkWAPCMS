<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" Codebehind="systemindex.aspx.cs" Inherits="KeLin.WebSite.gongqiu.systemindex" %>
                     ...
                     <div class="txt4">
                                            <font face="宋体">
                                                <table id="Table1" width="100%" class="TABLE6">
                                                    <tbody>                                                        
                                                        <tr>
                                                            <td style="word-wrap: break-word; width: 119px" valign="top" align="left">
                                                                <!--开始左边文章分类列表-->
                                                                    ...
                                                                    <tbody>
                                                                        ...
                                                                        <tr>
                                                                            <td class="f" align="center">
                                                                                <a href="systemmodel.aspx" target="_self">供求资源分类管理</a></td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td class="f">
                                                                                <asp:TreeView ID="TreeView1" runat="server" Width="100%" ImageSet="Arrows" NodeIndent="10">
                                                            ...
                                                            <table id="tblManageRanks" class="tableBorder" cellspacing="1" cellpadding="3" border="0"
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="column" colspan="2" align="center">
                                                                            查询条件</td>
                                                                        <td class="column" nowrap style="width: 82px">
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td class="fh" style="width: 270px" align="center">
                                                                            ...
                                                                            &nbsp;&nbsp;
                                                                            <input name="" type="button" value=" 修 改 " onclick="DoEdit()" id="Button1" runat="server" />&nbsp;&nbsp;&nbsp;
                                                                            <input name="" type="button" value=" 删 除 " onclick="DoDelete()" id="Button2" runat="server" /></td>
                                                                        <td class="fh" colspan="2">
                                                                            <asp:TextBox runat="server" ID="txtKeyword" Width="291px"></asp:TextBox>&nbsp;</td>
                                                                    ...
                                                                    <tr>
                                                                        <td class="fh" align="left" colspan="4">
                                                                            <asp:DropDownList ID="DropDownList1" runat="server">
                                                                            </asp:DropDownList>
                                                                            <input name="" type="button" value="导入我的栏目" onclick="DoMyItem()" id="Button5" runat="server" />                                                                        
                                                                            <asp:DropDownList ID="DropDownList2" runat="server">
                                                                            </asp:DropDownList>
                                                                            <input name="" type="button" value="转移联盟内容" onclick="DoTranfer()" id="Button3" runat="server" />                                                                        
                                                                        </td>
                                                                    </tr>
                                                                <tr>
                                                                <td colspan="4" >
                                                                <asp:DataGrid ID="DataGrid1" runat="server" DataKeyField="id" AllowSorting="True"
                                                                    ...
                                                                    <Columns>
                                                                        ...
                                                                        <asp:TemplateColumn HeaderText="标题" SortExpression="book_title" HeaderStyle-CssClass="column">
                                                                            <ItemTemplate>
                                                                                <a href="systemdetails.aspx?artid=<%#DataBinder.Eval(Container.DataItem,"id") %>"
                                                                                    target="_self" title="查看文章">
                                                                                    <%#DataBinder.Eval(Container.DataItem, "book_title")%>
                                                                                </a>
                                                                            </ItemTemplate>
                                                                        </asp:TemplateColumn>
                                                                        <asp:TemplateColumn HeaderText="作者" SortExpression="book_author" ItemStyle-Width="80px" HeaderStyle-CssClass="column">
                                                                            <ItemTemplate>
                                                                                <%#DataBinder.Eval(Container.DataItem, "book_author")%>
                                                                            </ItemTemplate>
                                                                        </asp:TemplateColumn>
                                                                        <asp:TemplateColumn HeaderText="出处" SortExpression="book_pub" ItemStyle-Width="80px" HeaderStyle-CssClass="column">
                                                                            <ItemTemplate>
                                                                                <%#DataBinder.Eval(Container.DataItem, "book_pub")%>
                                                                            </ItemTemplate>
                                                                        </asp:TemplateColumn>
                                                                        <asp:TemplateColumn HeaderText="录入人" SortExpression="username" ItemStyle-Width="120px" HeaderStyle-CssClass="column">
                                                                            <ItemTemplate>
                                                                                <%#DataBinder.Eval(Container.DataItem, "username")%>
                                                                            </ItemTemplate>
                                                                        </asp:TemplateColumn>
                                                                        <asp:TemplateColumn HeaderText="录入时间" SortExpression="book_date" ItemStyle-Width="120px" HeaderStyle-CssClass="column">
                                                                            <ItemTemplate>
